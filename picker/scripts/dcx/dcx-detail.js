...
(() => {
  ...
  const DETAIL_META = {
    product: {
      "Purpose": ["Why the product exists and what success looks like."],
      "Positioning": ["The strategic space this product should occupy."],
      "Primary conversion": ["The single action the experience should make inevitable."],
      "What must be clear first": ["The facts people need before anything else."],
      "Product principles": ["The rules that keep every product decision aligned."],
      "Operating context": ["Where and how the product must work."],
      "Surfaces": ["The chosen experiences and the job each one performs."],
    },
    brand: {
      "Personality": ["The character every expression should carry."],
      "Voice": ["How the brand sounds—and what it deliberately avoids."],
      "Principles": ["The rules that turn character into consistent choices."],
      "Commitments": ["The promises the brand must keep."],
    ...
    color: {
      ...
      "Palette": ["The core color relationships for the experience."],
      "Strategy per surface": ["How the palette changes emphasis across contexts."],
    },
    typography: {
      "The pair": ["Two typefaces with distinct, complementary jobs."],
      "Type scale": ["The hierarchy that gives content pace and proportion."],
    ...
    material: {
      ...
      "Layout structure": ["The spatial system that organizes the page."],
      "Boundaries per surface": ["Where separation is visible—and where space does the work."],
      "Corners per surface": ["How edge character changes with context."],
      "Depth per surface": ["How hierarchy is expressed without decorative elevation."],
