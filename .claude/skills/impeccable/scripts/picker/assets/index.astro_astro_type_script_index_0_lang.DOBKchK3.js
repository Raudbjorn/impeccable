(()=>{if(window.__dcxSettingsInstalled)return;window.__dcxSettingsInstalled=!0;let e=window.matchMedia(`(prefers-reduced-motion: reduce)`),t=[{label:`Open`,description:`Pick up where you left off.`,command:`/impeccable design-context open`},{label:`Edit`,description:`Make a few changes to this design context.`,command:`/impeccable design-context edit`},{label:`Export`,description:`Save a copy to share or keep elsewhere.`,command:`/impeccable design-context export`},{label:`Import`,description:`Bring a saved design context into this project.`,command:`/impeccable design-context import`}],n=e=>{let t=e?.querySelector?.(`.dcx-topbar`),n=t?.querySelector(`.dcx-close`);if(!t||!n||t.querySelector(`[data-dcx-settings-open]`))return;let r=document.createElement(`div`);r.className=`dcx-topbar-actions`;let i=document.createElement(`button`);i.className=`dcx-settings-trigger`,i.type=`button`,i.dataset.dcxSettingsOpen=``,i.setAttribute(`aria-label`,`Design context settings`),i.setAttribute(`aria-haspopup`,`dialog`),i.setAttribute(`aria-controls`,`dcx-context-settings`),i.setAttribute(`aria-expanded`,`false`),i.innerHTML=`
    ...
    </svg>`,n.before(r),r.append(i,n)};n(document.querySelector(`#dcx-shell-template`)?.content),document.querySelectorAll(`.dcx-expander`).forEach(n);let r=document.querySelector(`#dcx-context-settings`);r||(r=document.createElement(`dialog`),r.id=`dcx-context-settings`,r.className=`picker-modal dcx-settings-modal`,r.setAttribute(`aria-labelledby`,`dcx-context-settings-title`),r.setAttribute(`aria-describedby`,`dcx-context-settings-lede`),r.innerHTML=`
          ...
          <div class="dcx-component-canvas dcx-component-canvas--fields">
            <div class="dcx-component-demo-grid dcx-component-demo-grid--three dcx-component-demo-grid--baseline">
              ...
              <div class="dcx-demo-field">
                ...
                <span class="dcx-demo-input">${re()}</span>
              </div>
          ...
          <div class="dcx-component-canvas dcx-component-canvas--fields">
            <div class="dcx-component-demo-grid dcx-component-demo-grid--three">
              ...
              <div class="dcx-demo-field">
                ...
                <span class="dcx-demo-input dcx-demo-input--affix dcx-demo-input--suffix">${ie()}<span>.com</span></span>
              </div>
            </div>
          </div>
        </figure>
          ...
          <div class="dcx-component-canvas dcx-component-canvas--cards">
            <div class="dcx-component-demo-grid dcx-component-demo-grid--two">
              <article class="dcx-showcase-card dcx-showcase-card--media">
                ${ae(`The visual cue this palette was picked from`)}
                <div class="dcx-showcase-card-body">
              ...
              <article class="dcx-showcase-card dcx-showcase-card--media dcx-showcase-card--media-close">
                ${ae(`The chosen visual cue, cropped close`)}
                <div class="dcx-showcase-card-body">
        ...
        <figure class="dcx-component-example">
          ...
          <div class="dcx-component-canvas dcx-component-canvas--cards dcx-component-canvas--single-card">
            <article class="dcx-showcase-card dcx-showcase-card--horizontal">
              ${ae(`The chosen visual cue as a wide feature image`)}
              <div class="dcx-showcase-card-body">
    ...
    `);e.append(t,n,r)},se=e=>{let n=document.createDocumentFragment(),r=document.createElement(`h1`);r.className=`dcx-document-title`,r.textContent=`Design context`,n.appendChild(r),t.forEach(e=>{let t=document.querySelector(`#dcx-detail-${m(e)}`).content.cloneNode(!0).querySelector(`.dcx-article`);if(t){if(e===`components`){oe(t);let e=t.querySelector(`:scope > header > .dcx-title`),n=t.querySelector(`:scope > header > .dcx-lede`);e&&(e.textContent=`Components`),n&&(n.textContent=`A compact visual inventory of reusable interface patterns.`)}if(e===`brand`&&te(t),e===`material`){let e=b(`Accessibility`,`
          <dl class="dcx-defs">
            <div class="dcx-def">
          ...
          <form class="dcx-hooks-custom-form" id="dcx-hooks-custom-form" data-hooks-form hidden>
            <label>
              ...
              <select name="kind" data-hooks-kind>
                ${Object.entries(o).map(([e,t])=>`<option value="${e}">${x(t.label)}</option>`).join(``)}
              </select>
            </label>
            <p class="dcx-hooks-kind-hint" data-hooks-kind-hint>${x(o.value.hint)}</p>
            <label data-hooks-field="rule">
              <span>Rule</span>
              <select name="rule">
                ${[...t].sort((e,t)=>e.name.localeCompare(t.name)).map(e=>`<option value="${x(e.id)}">${x(e.name)}</option>`).join(``)}
              </select>
            </label>
  ...
  `,ae=()=>{let e=document.querySelector(`.dcx-tile[data-category="interface"]`);if(e){e.dataset.category=`hooks`,e.dataset.name=`Hooks`,e.setAttribute(`aria-label`,`Open Hooks`);let t=e.querySelector(`.dcx-tile-title`);t&&(t.textContent=`Hooks`)}let t=document.querySelector(`#dcx-shell-template`)?.content.querySelector(`li[data-category="interface"]`),n=t?.querySelector(`.dcx-nav-link`);t&&n&&(t.dataset.category=`hooks`,n.href=`#hooks`,n.dataset.dcxNav=`hooks`,n.textContent=`Hooks`)},oe=()=>{if(document.querySelector(`#dcx-detail-hooks`))return;let e=document.createElement(`template`);e.id=`dcx-detail-hooks`,e.innerHTML=ie(),document.querySelector(`#dcx-detail-interface`)?.after(e)},se=e=>t.filter(t=>t.group===e),S=e=>!(u&&u.ignoreRules.includes(e)),C=()=>!!(l&&u&&!f),ce=e=>{if(!n.matches)return;let t=e.querySelector(`[data-hooks-family][aria-selected="true"]`);if(!t)return;let i=e.getBoundingClientRect(),a=t.getBoundingClientRect(),o=0;a.left<i.left+3?o=a.left-i.left-3:a.right>i.right-3&&(o=a.right-i.right+3),!(Math.abs(o)<1)&&e.scrollTo({left:Math.max(0,e.scrollLeft+o),behavior:r.matches?`auto`:`smooth`})},le=new WeakMap,w=new WeakMap,ue=0,de=(e,t)=>{let n=e.querySelector(`:scope > .dcx-hooks-disclosure`),i=n?.querySelector(`:scope > .dcx-hooks-disclosure-inner`);if(!n||!i){e.open=t;return}let a=le.get(e),o=n.getBoundingClientRect().height,s=Number.parseFloat(getComputedStyle(n).opacity)||0;if(a?.cancel(),r.matches){le.delete(e),e.classList.remove(`is-closing`),e.open=t,n.style.removeProperty(`height`),n.style.removeProperty(`opacity`);return}e.open=!0,e.classList.toggle(`is-closing`,!t);let c=a?o:t?0:o,l=a?s:+!t,u=t?i.scrollHeight:0,d=+!!t,f=n.animate([{height:`${c}px`,opacity:l},{height:`${u}px`,opacity:d}],{duration:360,easing:`cubic-bezier(0.22, 1, 0.36, 1)`,fill:`both`});le.set(e,f),f.finished.then(()=>{le.get(e)===f&&(le.delete(e),e.classList.remove(`is-closing`),e.open=t,f.cancel(),n.style.removeProperty(`height`),n.style.removeProperty(`opacity`))}).catch(()=>{})},fe=(e,t)=>{let n=w.get(e),i=e.hidden?0:e.getBoundingClientRect().height,a=e.hidden?0:Number.parseFloat(getComputedStyle(e).opacity)||1;if(n?.cancel(),r.matches){w.delete(e),e.hidden=!t;return}t&&(e.hidden=!1);let o=t?e.scrollHeight:0;e.style.overflow=`clip`;let s=e.animate([{height:`${i}px`,opacity:a},{height:`${o}px`,opacity:+!!t}],{duration:320,easing:`cubic-bezier(0.22, 1, 0.36, 1)`,fill:`both`});w.set(e,s),s.finished.then(()=>{w.get(e)===s&&(w.delete(e),e.hidden=!t,s.cancel(),e.style.removeProperty(`height`),e.style.removeProperty(`opacity`),e.style.removeProperty(`overflow`))}).catch(()=>{})},T=(e,t)=>{let n=t.parentElement,r=!n.open||n.classList.contains(`is-closing`),i=e.querySelector(`[data-hooks-search]`)?.value.trim();r&&!i&&n.parentElement?.querySelectorAll(`:scope > .dcx-hooks-discipline[open]`).forEach(e=>{e!==n&&de(e,!1)}),de(n,r)},pe=e=>{let t=e.querySelector(`[data-hooks-families]`);t&&(t.innerHTML=Object.entries(i).map(([e,t])=>{let n=se(e),r=n.filter(e=>S(e.id)).length,i=s.activeFamily===e;return`
        <button
          ...
          tabindex="${i?`0`:`-1`}"
          aria-selected="${i}"
          aria-label="${x(t.label)}, ${r} of ${n.length} selected"
          aria-controls="dcx-hooks-rule-panel"
          data-hooks-family="${e}"
        >
          <span class="dcx-hooks-family-name">${x(t.label)}</span>
          <span class="dcx-hooks-family-count">${r}/${n.length}</span>
        </button>
      `}).join(``),e.querySelector(`#dcx-hooks-rule-panel`)?.setAttribute(`aria-labelledby`,`dcx-hooks-family-${s.activeFamily}`),requestAnimationFrame(()=>ce(t)))},E=e=>{let t=e.querySelector(`[data-hooks-rule-groups]`),n=e.querySelector(`[data-hooks-summary]`),r=e.querySelector(`[data-hooks-search]`);if(!t||!n)return;let i=(r?.value||``).trim().toLowerCase(),o=se(s.activeFamily),c=o.filter(e=>!i||`${e.id} ${e.name} ${e.description} ${e.discipline}`.toLowerCase().includes(i)),l=o.filter(e=>S(e.id)).length;n.textContent=i?`${c.length} matching ${c.length===1?`rule`:`rules`}`:`${l} of ${o.length} selected`;let u=new Map;c.forEach(e=>{u.has(e.discipline)||u.set(e.discipline,[]),u.get(e.discipline).push(e)});let d=[...u.entries()].sort(([e],[t])=>{let n=a.indexOf(e),r=a.indexOf(t);return(n===-1?99:n)-(r===-1?99:r)||e.localeCompare(t)});if(!d.length){t.innerHTML=`<p class="dcx-hooks-empty">No rules match this search.</p>`;return}let f=C()?``:`disabled`;t.innerHTML=d.map(([e,t],n)=>{let r=`dcx-hooks-${s.activeFamily}-${te(e)}`,a=`${r}-summary`;return`
        ...
        <div class="dcx-hooks-disclosure" id="${r}" role="region" aria-labelledby="${a}">
          <div class="dcx-hooks-disclosure-inner">
            <ul class="dcx-hooks-rules">
              ${t.map(e=>`
                <li class="dcx-hooks-rule" data-rule-id="${x(e.id)}">
                  <div class="dcx-hooks-rule-copy">
                    <strong>${x(e.name)}</strong>
                    <p>${x(ne(e.description))}</p>
                  </div>
                  <label class="dcx-hooks-switch">
                    <input
                      type="checkbox"
                      role="switch"
                      data-hooks-rule="${x(e.id)}"
                      aria-label="Enable ${x(e.name)}"
                      ${S(e.id)?`checked`:``}
                      ${f}
                    >
                    <span aria-hidden="true"></span>
    ...
    `}).join(``)},me=e=>{let t=e.querySelector(`[data-hooks-custom-list]`),n=e.querySelector(`[data-hooks-custom-count]`),r=e.querySelector(`[data-hooks-live-note]`),i=e.querySelector(`[data-hooks-add]`);if(!t)return;let a=u?u.ignoreValues:[],o=u?u.ignoreFiles:[],s=a.length+o.length;n&&(n.textContent=s?`${s} ${s===1?`exception`:`exceptions`}`:`No exceptions.`),i&&(i.disabled=!C()),r&&(r.textContent=C()||f?`Exceptions apply to the design hook and to npx impeccable detect in this project.`:`The editing session has ended. /impeccable design-context reopens it.`),t.innerHTML=``,a.forEach((e,n)=>{let r=document.createElement(`article`);r.className=`dcx-hooks-custom-rule`;let i=document.createElement(`div`);i.className=`dcx-hooks-rule-copy`;let a=document.createElement(`span`);a.className=`dcx-hooks-custom-discipline`,a.textContent=e.value===`*`?`Rule, in files`:`Value`;let o=document.createElement(`strong`);o.textContent=e.value===`*`?re(e.rule):`${re(e.rule)}: ${e.value}`;let s=document.createElement(`p`);if(s.textContent=e.files?.length?`In ${e.files.join(`, `)}`:`Everywhere in this project.`,i.append(a,o,s),e.reason){let t=document.createElement(`p`);t.className=`dcx-hooks-custom-reason`,t.textContent=e.reason,i.append(t)}let c=document.createElement(`div`);c.className=`dcx-hooks-custom-controls`;let l=document.createElement(`button`);l.className=`dcx-hooks-remove`,l.type=`button`,l.dataset.hooksRemoveValue=String(n),l.setAttribute(`aria-label`,`Remove exception for ${re(e.rule)}`),l.textContent=`Remove`,l.disabled=!C(),c.append(l),r.append(i,c),t.appendChild(r)}),o.forEach((e,n)=>{let r=document.createElement(`article`);r.className=`dcx-hooks-custom-rule`;let i=document.createElement(`div`);i.className=`dcx-hooks-rule-copy`;let a=document.createElement(`span`);a.className=`dcx-hooks-custom-discipline`,a.textContent=`Skipped files`;let o=document.createElement(`strong`);o.textContent=e;let s=document.createElement(`p`);s.textContent=`Every rule skips matching files.`,i.append(a,o,s);let c=document.createElement(`div`);c.className=`dcx-hooks-custom-controls`;let l=document.createElement(`button`);l.className=`dcx-hooks-remove`,l.type=`button`,l.dataset.hooksRemoveFile=String(n),l.setAttribute(`aria-label`,`Stop skipping ${e}`),l.textContent=`Remove`,l.disabled=!C(),c.append(l),r.append(i,c),t.appendChild(r)})},D=e=>{let t=e.querySelector(`[data-hooks-master]`),n=e.querySelector(`[data-hooks-status]`),r=e.querySelector(`[data-hooks-master-copy]`),i=e.querySelector(`[data-hooks-master-detail]`),a=e.querySelector(`[data-hooks-master-state]`);if(!t||!n||!r||!i||!a)return;let o=!u||u.enabled;t.checked=o,t.disabled=!C(),n.classList.toggle(`is-paused`,!o),r.textContent=`Enable hooks`,i.textContent=u?`Runs in this project; changes land in .impeccable/config.json when you press Apply.`:d||(g()?`Reading this project’s settings…`:`The editing session has ended. /impeccable design-context reopens it.`),a.textContent=o?`On`:`Off`},he=e=>{let t=e.querySelector(`[data-hooks-applybar]`),n=e.querySelector(`[data-hooks-applybar-copy]`),r=e.querySelector(`[data-hooks-apply]`),i=e.querySelector(`[data-hooks-discard]`);if(!t||!n||!r||!i)return;let a=b(),o=!!(l&&u)&&(a>0||f||p);t.hidden=!o,o&&(r.disabled=f||a===0,i.disabled=f||a===0,n.textContent=f?`Applying…`:a>0?`${a} ${a===1?`change`:`changes`} not applied yet.`:`Applied to .impeccable/config.json.`)},ge=e=>{D(e),pe(e),E(e),me(e),he(e)},_e=()=>[...document.querySelectorAll(`.dcx-article[data-dcx-category="hooks"]`)],O=()=>_e().forEach(ge),ve=async()=>{let e=_();if(!(!e||h)){h=!0;try{let t=await fetch(e),n=await t.json().catch(()=>null);if(!t.ok||!n?.ok||!n.state)throw Error(n?.error||`The doc session answered ${t.status}.`);l=n.state,u=v(l),d=``}catch{d=`Could not read this project’s hook settings; the controls stay read-only.`,h=!1}O()}},k=async e=>{let t=_(),n=g();if(!(!t||!n||!u||f)){f=!0,p=!1,m&&=(window.clearTimeout(m),0),O();try{let e=await fetch(`${n.base}/doc/hooks`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({token:n.token,state:{...u,baseline:l}})}),t=await e.json().catch(()=>null);if(!e.ok||!t?.ok||!t.state)throw Error(t?.error||`The doc session answered ${e.status}.`);l=t.state,u=v(l),p=!0,m=window.setTimeout(()=>{m=0,p=!1,O()},2600)}catch(n){let r=String(n.message||n);if(f=!1,r.includes(`hook config changed on disk`)&&l&&u){let n=l,r=u;try{let i=await fetch(t),a=await i.json().catch(()=>null);if(i.ok&&a?.ok&&a.state){l=a.state,u=ee(n,r,l),O();let t=e.querySelector(`[data-hooks-applybar-copy]`);t&&(t.textContent=`Another run changed this project's hook settings while you edited. Your changes were re-applied on top; review and press Apply again.`);return}}catch{}}he(e);let i=e.querySelector(`[data-hooks-applybar-copy]`);i&&(i.textContent=`Not applied: ${r}`);return}f=!1,O()}},ye=()=>{ue=0,_e().forEach(e=>{e.dataset.dcxHooksReady!==`true`&&(e.dataset.dcxHooksReady=`true`,ge(e))}),l===null&&ve()},be=()=>{ue||=requestAnimationFrame(ye)},A=e=>{let t=e.querySelector(`[data-hooks-kind]`)?.value||`value`,n=e.querySelector(`[data-hooks-kind-hint]`);n&&(n.textContent=o[t]?.hint||``),e.querySelector(`[data-hooks-field="rule"]`)?.toggleAttribute(`hidden`,t===`file`),e.querySelector(`[data-hooks-field="value"]`)?.toggleAttribute(`hidden`,t!==`value`),e.querySelector(`[data-hooks-field="files"]`)?.toggleAttribute(`hidden`,t===`value`),e.querySelector(`[data-hooks-field="reason"]`)?.toggleAttribute(`hidden`,t===`file`)},xe=e=>[...new Set(String(e).split(/[\n,]/).map(e=>e.trim()).filter(Boolean))];document.addEventListener(`click`,e=>{let t=e.target.closest(`.dcx-article[data-dcx-category="hooks"]`);if(!t)return;let n=e.target.closest(`.dcx-hooks-discipline > summary`);if(n){e.preventDefault(),T(t,n);return}let r=e.target.closest(`[data-hooks-family]`);if(r){let e=r===document.activeElement;s.activeFamily=r.dataset.hooksFamily,c(),pe(t),E(t),e&&t.querySelector(`[data-hooks-family="${s.activeFamily}"]`)?.focus({preventScroll:!0});return}let i=e.target.closest(`[data-hooks-add]`);if(i&&C()){let e=t.querySelector(`[data-hooks-form]`);if(!e)return;A(e),fe(e,!0),i.setAttribute(`aria-expanded`,`true`),e.querySelector(`[data-hooks-kind]`)?.focus();return}if(e.target.closest(`[data-hooks-cancel]`)){let e=t.querySelector(`[data-hooks-form]`);e?.reset(),e&&fe(e,!1);let n=t.querySelector(`[data-hooks-add]`);n?.setAttribute(`aria-expanded`,`false`),n?.focus({preventScroll:!0});return}let a=e.target.closest(`[data-hooks-remove-value]`);if(a&&C()){u.ignoreValues.splice(Number(a.dataset.hooksRemoveValue),1),O(),(t.querySelector(`.dcx-hooks-remove`)||t.querySelector(`[data-hooks-add]`))?.focus({preventScroll:!0});return}let o=e.target.closest(`[data-hooks-remove-file]`);if(o&&C()){u.ignoreFiles.splice(Number(o.dataset.hooksRemoveFile),1),O(),(t.querySelector(`.dcx-hooks-remove`)||t.querySelector(`[data-hooks-add]`))?.focus({preventScroll:!0});return}if(e.target.closest(`[data-hooks-discard]`)&&l){u=v(l),O();return}e.target.closest(`[data-hooks-apply]`)&&k(t)}),document.addEventListener(`input`,e=>{if(!e.target.matches(`[data-hooks-search]`))return;let t=e.target.closest(`.dcx-article[data-dcx-category="hooks"]`);t&&E(t)}),document.addEventListener(`keydown`,e=>{let t=e.target.closest(`.dcx-hooks-discipline > summary`);if(t&&[`Enter`,` `].includes(e.key)){if(e.preventDefault(),!e.repeat){let e=t.closest(`.dcx-article[data-dcx-category="hooks"]`);e&&T(e,t)}return}let n=e.target.closest(`[data-hooks-family]`);if(!n||![`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`].includes(e.key))return;let r=n.closest(`.dcx-article[data-dcx-category="hooks"]`),i=[...r.querySelectorAll(`[data-hooks-family]`)],a=i.indexOf(n);if(a<0)return;e.preventDefault();let o=[`ArrowRight`,`ArrowDown`].includes(e.key)?1:-1;i[e.key===`Home`?0:e.key===`End`?i.length-1:(a+o+i.length)%i.length].click(),r.querySelector(`[data-hooks-family="${s.activeFamily}"]`)?.focus()}),document.addEventListener(`change`,e=>{let t=e.target.closest(`.dcx-article[data-dcx-category="hooks"]`);if(t){if(e.target.matches(`[data-hooks-kind]`)){let t=e.target.closest(`[data-hooks-form]`);t&&A(t);return}if(C()){if(e.target.matches(`[data-hooks-master]`)){u.enabled=e.target.checked,D(t),he(t);return}if(e.target.matches(`[data-hooks-rule]`)){let n=e.target.dataset.hooksRule;e.target.checked?u.ignoreRules=u.ignoreRules.filter(e=>e!==n):u.ignoreRules.includes(n)||u.ignoreRules.push(n),pe(t),he(t);let r=t.querySelector(`[data-hooks-search]`)?.value.trim(),i=t.querySelector(`[data-hooks-summary]`);if(!r&&i){let e=se(s.activeFamily);i.textContent=`${e.filter(e=>S(e.id)).length} of ${e.length} selected`}}}}}),document.addEventListener(`submit`,e=>{let t=e.target.closest(`[data-hooks-form]`);if(!t)return;e.preventDefault();let n=t.closest(`.dcx-article[data-dcx-category="hooks"]`);if(!n||!C())return;let r=new FormData(t),i=String(r.get(`kind`)||`value`),a=String(r.get(`rule`)||``).trim(),o=String(r.get(`value`)||``).trim(),s=xe(r.get(`files`)||``),c=String(r.get(`reason`)||``).trim();if(i===`file`){if(!s.length)return;s.forEach(e=>{u.ignoreFiles.includes(e)||u.ignoreFiles.push(e)})}else{let e=i===`value`?{rule:a,value:o}:{rule:a,value:`*`,files:s};if(!e.rule||i===`value`&&!e.value||i===`rule-in-files`&&!s.length)return;c&&(e.reason=c),new Set(u.ignoreValues.map(y)).has(y(e))||u.ignoreValues.push(e)}t.reset(),A(t),fe(t,!1);let l=n.querySelector(`[data-hooks-add]`);l?.setAttribute(`aria-expanded`,`false`),O(),l?.focus({preventScroll:!0})}),ae(),oe(),new MutationObserver(be).observe(document.body,{childList:!0,subtree:!0}),window.addEventListener(`pageshow`,be),be()})(),(()=>{let t={product:{Purpose:[`Why the product exists and what success looks like.`],Positioning:[`The strategic space this product should occupy.`],"Primary conversion":[`The single action the experience should make inevitable.`],"What must be clear first":[`The facts people need before anything else.`],"Product principles":[`The rules that keep every product decision aligned.`],"Operating context":[`Where and how the product must work.`],Surfaces:[`The chosen experiences and the job each one performs.`]},brand:{Personality:[`The character every expression should carry.`],Voice:[`How the brand sounds—and what it deliberately avoids.`],Principles:[`The rules that turn character into consistent choices.`],Commitments:[`The promises the brand must keep.`],"Named references":[`Useful signals to borrow without becoming an imitation.`],"Anti-reference":[`The direction the brand must deliberately avoid.`],Marks:[`The identity assets already available to the system.`],"Boards and references":[`Visual evidence that should inform the work.`],"Assets provided":[`The source material available for production.`],"Brand assets":[`Logos, moodboards, and visual references available to the system.`]},color:{"The cue":[``],"Also generated":[`Adjacent directions retained as useful context.`],Palette:[`The core color relationships for the experience.`],"Strategy per surface":[`How the palette changes emphasis across contexts.`]},typography:{"The pair":[`Two typefaces with distinct, complementary jobs.`],"Type scale":[`The hierarchy that gives content pace and proportion.`],"In running text":[`How the pair behaves when the content gets real.`]},components:{Buttons:[`Variants, sizes, icons, and loading states.`],"Input fields":[`States, sizes, affixes, and multiline input.`],Cards:[`Content, media, horizontal, and action compositions.`]},material:{"The page, as chosen":[`The page anatomy each surface committed, and what it represents.`],"Motion per surface":[`How movement supports each context without becoming spectacle.`],Motion:[`How movement should support the experience.`],Accessibility:[`The rules that keep the material system readable and operable.`],"Layout structure":[`The spatial system that organizes the page.`],"Boundaries per surface":[`Where separation is visible—and where space does the work.`],"Corners per surface":[`How edge character changes with context.`],"Depth per surface":[`How hierarchy is expressed without decorative elevation.`],Iconography:[`The chosen icon library, its character, grid, stroke, and license.`]},hooks:{"How it runs":[``],"Built-in rules":[`Choose what the detector watches.`],"Custom rules":[``]}},n=0,r=e=>e.toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-|-$/g,``),i=(e,t)=>{e.querySelectorAll(`:scope .dcx-principles > li`).forEach(n=>{let r=n.querySelector(`:scope > .dcx-detail-principle-copy`);if(!r){for(r=document.createElement(`div`),r.className=`dcx-detail-principle-copy`;n.firstChild;)r.appendChild(n.firstChild);n.appendChild(r)}if(t===`product`&&e.dataset.label===`Product principles`){let e=r.querySelector(`:scope > strong:first-child`)?.nextSibling;e?.nodeType===Node.TEXT_NODE&&(e.textContent=e.textContent.replace(/^\s*[—–-]+\s*/,` `))}})},a=e=>{e.querySelectorAll(`h3`).forEach(e=>{let t=document.createElement(`h4`);for([...e.attributes].forEach(e=>{t.setAttribute(e.name,e.value)});e.firstChild;)t.appendChild(e.firstChild);e.replaceWith(t)})},o=(e,t)=>{if(t!==`product`||e.dataset.label!==`Purpose`)return;let n=e.querySelector(`:scope .dcx-purpose .dcx-callout`),r=n?.querySelector(`:scope > .dcx-callout-name`),i=e.querySelector(`:scope .dcx-purpose > .dcx-platform-pill`);!n||!r||!i||(i.classList.remove(`dcx-chip`),r.after(i))},s=e=>{e.querySelectorAll(`:scope .dcx-fan-note`).forEach(e=>e.remove())},c=e=>{if(![...e.querySelectorAll(`.dcx-default-mark`)].some(e=>e.textContent.trim()==="default")||e.querySelector(`:scope > .dcx-default-note`))return;let t=document.createElement(`p`);t.className=`dcx-default-note`,t.textContent=`Entries marked default kept their surface's preset; this run never set them. Run /impeccable design-context edit to answer them.`,e.appendChild(t)},l=e=>{if(e.dataset.dcxColorCompacted===`true`)return;let t=new Map([...e.querySelectorAll(`:scope > .dcx-block[data-label]`)].map(e=>[e.dataset.label,e])),n=t.get(`The cue`),r=t.get(`Palette`),i=t.get(`Strategy per surface`),a=n?.querySelector(`:scope > .dcx-cue`),o=r?.querySelector(`:scope > .dcx-fan`);if(n?.querySelector(`:scope > .dcx-fan-note`)?.remove(),i?.querySelector(`:scope > .dcx-fan-note`)?.remove(),t.get(`Roles and values`)?.remove(),t.get(`Interview direction`)?.remove(),a&&o){let e=a.querySelector(`:scope > .dcx-cue-card`),t=[...o.querySelectorAll(`:scope > .dcx-fan-panel`)];if(e&&t.length){e.querySelector(`:scope > .dcx-cue-tag`)?.remove(),e.querySelector(`:scope > .dcx-cue-name`)?.remove();let n=document.createElement(`ul`);n.className=`dcx-cue-bands`,n.setAttribute(`aria-label`,`Committed palette`),t.forEach(e=>{let t=e.querySelector(`:scope .dcx-fan-name`)?.textContent.trim()||`Color`,r=e.querySelector(`:scope .dcx-fan-value`)?.textContent.trim()||``,i=e.style.getPropertyValue(`--panel-swatch`),a=e.style.getPropertyValue(`--panel-ink`),o=document.createElement(`li`);o.className=`dcx-cue-band-item`;let s=document.createElement(`div`);s.className=`dcx-cue-band`,s.style.setProperty(`--band-color`,i),s.style.setProperty(`--band-ink`,a);let c=document.createElement(`code`);c.className=`dcx-cue-band-value`,c.textContent=r,s.appendChild(c);let l=document.createElement(`span`);l.className=`dcx-cue-band-label`,l.textContent=t,o.append(s,l),n.appendChild(o)}),e.querySelectorAll(`:scope > .dcx-cue-role`).forEach(e=>e.remove()),e.appendChild(n),r.remove()}}let s=e.querySelector(`:scope > header > .dcx-lede`);s&&(s.textContent=`Committed palette and per-surface strategy.`),e.dataset.dcxColorCompacted=`true`},u=e=>{let t=e.querySelector(`:scope > .dcx-block[data-label="The page, as chosen"]`)?.querySelector(`:scope > .dcx-surfaces`);if(!t)return;let n=Array.isArray(window.dcxSurfaceDefs)?window.dcxSurfaceDefs:[];if(!n.length)return;let r=document.createElement(`dl`);r.className=`dcx-defs`,n.forEach(({label:e,description:t})=>{let n=document.createElement(`div`);n.className=`dcx-def`;let i=document.createElement(`dt`);i.textContent=e;let a=document.createElement(`dd`);a.textContent=t,n.append(i,a),r.appendChild(n)}),t.after(r)},d=(n,l,u)=>{let d=n.dataset.label||`Section`,[f,p]=t[l]?.[d]||[`The decisions that define this part of the system.`],m=`${l}-${r(d)}`;n.querySelector(`:scope > .dcx-block-label`)?.remove();let h=document.createElement(`div`);for(h.className=`dcx-detail-section-body`;n.firstChild;)h.appendChild(n.firstChild);let g=document.createElement(`div`);g.className=`dcx-detail-section-heading`;let _=document.createElement(`h3`);if(_.className=`dcx-detail-section-title`,_.id=`dcx-${m}-title`,_.textContent=d,g.appendChild(_),f){let e=document.createElement(`p`);e.className=`dcx-detail-section-lede`,e.textContent=f,g.appendChild(e)}let v=document.createElement(`header`);if(v.className=`dcx-detail-section-head`,v.appendChild(g),p){v.classList.add(`dcx-detail-section-head--with-icon`);let t=document.createElement(`figure`);t.className=`dcx-detail-section-icon`,t.setAttribute(`aria-hidden`,`true`),t.setAttribute(`data-dcx-hide-on-error`,``);let r=document.createElement(`img`);r.src=e(p),r.alt=``,r.width=256,r.height=256,r.decoding=`async`,(n.closest(`.dcx-article`)?.dataset.dcxCategory||u>0)&&(r.loading=`lazy`),t.appendChild(r),v.appendChild(t)}n.classList.add(`dcx-detail-section`,`dcx-detail-section--${r(d)}`),n.id=`dcx-${m}`,n.closest(`.dcx-article`)?.dataset.dcxCategory||(n.setAttribute(`role`,`region`),n.setAttribute(`aria-labelledby`,_.id)),n.append(v,h),a(h),h.querySelector(`:scope > .dcx-list`)?.classList.add(`dcx-detail-list`),h.querySelector(`:scope > .dcx-defs`)?.classList.add(`dcx-detail-defs`),i(n,l),o(n,l),s(n),c(h)},f=(e,n)=>{if(e.dataset.dcxDetailEnhanced===n)return;n===`color`&&l(e),n===`typography`&&(e.querySelectorAll(`:scope .dcx-pair-why`).forEach(e=>e.remove()),e.querySelector(`:scope > .dcx-block[data-label="Interview direction"]`)?.remove()),n===`iconography`&&e.querySelector(`:scope > .dcx-block[data-label="The hand"]`)?.remove(),n===`material`&&(u(e),e.querySelectorAll(`:scope > .dcx-block[data-label] > .dcx-fan-note`).forEach(e=>e.remove())),e.classList.add(`dcx-detail-article`,`dcx-detail-article--${n}`),e.querySelector(`:scope > header`)?.classList.add(`dcx-detail-hero`);let r=0;e.querySelectorAll(`:scope > .dcx-block[data-label]`).forEach(e=>{let i=!!t[n]?.[e.dataset.label]?.[1];d(e,n,r),i&&(r+=1)}),e.dataset.dcxDetailEnhanced=n},p=()=>{n=0;let e=document.querySelector(`.dcx-expander`),r=e?.querySelectorAll(`.dcx-main > .dcx-article[data-dcx-category]`);if(r?.length){r.forEach(e=>{let n=e.dataset.dcxCategory;n!==`audience`&&t[n]&&f(e,n)});return}let i=e?.querySelector(`.dcx-nav-list > li.is-active[data-category]`),a=e?.querySelector(`.dcx-main > .dcx-article`),o=i?.dataset.category;!a||!o||o===`audience`||!t[o]||f(a,o)},m=()=>{n||=requestAnimationFrame(p)};new MutationObserver(m).observe(document.body,{childList:!0,subtree:!0}),window.addEventListener(`pageshow`,m),m()})(),(()=>{let e=(e,t,n)=>{let r=1-3*n+3*t,i=3*n-6*t,a=3*t;return((r*e+i)*e+a)*e},t=(e,t,n)=>{let r=1-3*n+3*t,i=3*n-6*t,a=3*t;return 3*r*e*e+2*i*e+a},n=n=>{let r=Math.max(0,Math.min(1,n)),i=r;for(let n=0;n<8;n+=1){let n=t(i,.4,.2);if(Math.abs(n)<1e-6)break;i-=(e(i,.4,.2)-r)/n,i=Math.max(0,Math.min(1,i))}return e(i,0,1)},r=0,i=null,a=0,o=(e,t={})=>{let n=document.createElementNS(`http://www.w3.org/2000/svg`,e);return Object.entries(t).forEach(([e,t])=>n.setAttribute(e,t)),n};class s{constructor(e){this.expander=e,this.nav=e.querySelector(`.dcx-nav`),this.main=e.querySelector(`.dcx-main`),this.desktop=window.matchMedia(`(min-width: 921px)`),this.reducedMotion=window.matchMedia(`(prefers-reduced-motion: reduce)`),this.instanceId=++r,this.currentArticle=null,this.currentCategory=``,this.currentSubnav=null,this.contentSignature=``,this.entries=[],this.segments=new Map,this.railLength=0,this.railReady=!1,this.pinnedNode=null,this.scrollFrame=0,this.rebuildFrame=0,this.rebuildTimers=[],this.categoryTransitionBeginFrame=0,this.categoryTransitionFrame=0,this.categoryTransitionHandoffFrame=0,this.categoryTransitionCleanupTimer=0,this.categoryTransitionGeneration=0,this.categoryTransitionActive=!1,this.categoryTransitionStart=0,this.categoryTransitionTarget=null,this.categoryTransitionFinalTarget=null,this.categoryTransitionNode=null,this.categoryTransitionBranchPoints=null,this.categoryTransitionBranchProgress=0,this.categoryTransitionRetractPoints=null,this.categoryTransitionRetractProgress=0,this.categoryTransitionRetractStart=0,this.categoryTransitionRenderedPoints=null,this.categoryTransitionRenderedProgress=0,this.currentPaintNode=null,!(!this.nav||!this.main)&&(this.handleScroll=this.handleScroll.bind(this),this.handleResize=this.handleResize.bind(this),this.handleMediaChange=this.handleMediaChange.bind(this),this.handleReducedMotionChange=this.handleReducedMotionChange.bind(this),this.handleRailClick=this.handleRailClick.bind(this),this.handleContinuousCategoryWillChange=this.handleContinuousCategoryWillChange.bind(this),this.handleContinuousCategoryChange=this.handleContinuousCategoryChange.bind(this),this.clearPinnedNode=this.clearPinnedNode.bind(this),this.handleKeydown=this.handleKeydown.bind(this),this.createRail(),this.nav.classList.add(`dcx-material-rail-host`),this.remeasureSubnavs(),this.main.addEventListener(`scroll`,this.handleScroll,{passive:!0}),this.main.addEventListener(`wheel`,this.clearPinnedNode,{passive:!0}),this.main.addEventListener(`touchstart`,this.clearPinnedNode,{passive:!0}),this.main.addEventListener(`pointerdown`,this.clearPinnedNode,{passive:!0}),this.nav.addEventListener(`click`,this.handleRailClick),this.expander.addEventListener(`dcx:continuouscategorywillchange`,this.handleContinuousCategoryWillChange),this.expander.addEventListener(`dcx:continuouscategorychange`,this.handleContinuousCategoryChange),window.addEventListener(`resize`,this.handleResize,{passive:!0}),window.addEventListener(`keydown`,this.handleKeydown),this.desktop.addEventListener(`change`,this.handleMediaChange),this.reducedMotion.addEventListener(`change`,this.handleReducedMotionChange),this.resizeObserver=new ResizeObserver(this.handleResize),this.resizeObserver.observe(this.nav),document.fonts?.ready.then(()=>{i===this&&(this.remeasureSubnavs(),this.scheduleRebuild(!0))}))}createRail(){let e=`dcx-material-rail-patina-${this.instanceId}`,t=`dcx-material-rail-gold-${this.instanceId}`,n=o(`svg`,{class:`dcx-material-rail`,"aria-hidden":`true`,focusable:`false`}),r=o(`defs`),i=o(`pattern`,{id:e,width:`72`,height:`48`,patternUnits:`userSpaceOnUse`}),a=o(`pattern`,{id:t,width:`72`,height:`48`,patternUnits:`userSpaceOnUse`});i.append(o(`rect`,{class:`dcx-material-rail__patina-base`,width:`72`,height:`48`})),a.append(o(`rect`,{class:`dcx-material-rail__gold-base`,width:`72`,height:`48`})),this.track=o(`path`,{class:`dcx-material-rail__track`,"data-dcx-rail-track":``}),this.active=o(`path`,{class:`dcx-material-rail__active`,"data-dcx-rail-active":``}),this.transitionTrack=o(`path`,{class:`dcx-material-rail__transition-track`}),this.transitionActive=o(`line`,{class:`dcx-material-rail__transition-active`}),this.track.style.stroke=`url("#${e}")`,this.active.style.stroke=`url("#${t}")`,this.transitionTrack.style.stroke=`url("#${e}")`,this.transitionActive.style.stroke=`url("#${t}")`,r.append(i,a),n.append(r,this.transitionTrack,this.track,this.active,this.transitionActive),this.svg=n,this.nav.prepend(n)}prepareAudienceSubnav(e,t){let n=[{label:`Overview`,targetLabels:[],overview:!0},{label:`People`,targetLabels:[`Who they are`,`Emotional journey`,`Emotional state`]},{label:`Decision factors`,targetLabels:[`Needs`,`Trust triggers`]},{label:`Inclusion`,targetLabels:[`Who must not be excluded`]}],r=new Map(t.map((e,t)=>[e.dataset.label,{block:e,index:t}])),i=n.map(e=>{if(e.overview)return e;let t=e.targetLabels.find(e=>r.has(e));return t?{...e,firstTarget:t}:null}).filter(Boolean),a=i.map(e=>e.label).join(`|`),o=[...e.querySelectorAll(`:scope > .dcx-sub-link[data-dcx-rail-summary]`)].map(e=>e.textContent.trim()).join(`|`);if(e.classList.add(`dcx-subnav--summary`),e.dataset.dcxRailSummary=`true`,o===a&&e.childElementCount===i.length)return;let s=i.map(e=>{let t=document.createElement(`button`);return t.className=`dcx-sub-link`,t.type=`button`,t.textContent=e.label,t.dataset.dcxRailSummary=``,t.dataset.dcxRailTarget=e.overview?`__overview__`:e.firstTarget,e.overview||(t.dataset.dcxSubsection=String(r.get(e.firstTarget).index)),t});e.replaceChildren(...s)}refresh(){let e=this.nav.querySelector(`.dcx-nav-list > li.is-active[data-category]`),t=e?.dataset.category||``,n=this.main.dataset.dcxContinuous===`true`,r=n?this.main.querySelector(`:scope > .dcx-article[data-dcx-category="${t}"]`):this.main.querySelector(`:scope > .dcx-article`);if(!e||!r){this.nav.removeAttribute(`data-rail-ready`);return}let a=e.querySelector(`:scope > .dcx-subnav`),o=[...r.querySelectorAll(`:scope > .dcx-block[data-label]`)];if(!a)return;n||this.nav.querySelectorAll(`.dcx-subnav`).forEach(e=>{(e!==a||t!==`audience`)&&(e.classList.remove(`dcx-subnav--summary`),delete e.dataset.dcxRailSummary)}),t===`audience`&&!n&&this.prepareAudienceSubnav(a,o);let s=`${t}::${[...a.querySelectorAll(`:scope > .dcx-sub-link`)].map(e=>e.textContent.trim()).join(`|`)}::${o.map(e=>e.dataset.label).join(`|`)}`,c=[...this.nav.querySelectorAll(`.dcx-nav-list > li > .dcx-nav-link`),...a.querySelectorAll(`:scope > .dcx-sub-link`)],l=c.length>0&&c.every(e=>e.hasAttribute(`data-dcx-rail-node`));if(this.currentArticle===r&&this.currentCategory===t&&this.currentSubnav===a&&this.contentSignature===s&&l)return;this.currentArticle=r,this.currentCategory=t,this.currentSubnav=a,this.contentSignature=s,this.pinnedNode=null,this.rebuildTimers.forEach(e=>window.clearTimeout(e)),this.rebuildTimers=[],this.nav.querySelectorAll(`[data-dcx-rail-node]`).forEach(e=>{e.removeAttribute(`data-dcx-rail-node`)}),this.nav.querySelectorAll(`.dcx-sub-link[aria-current="location"]`).forEach(e=>{e.removeAttribute(`aria-current`)});let u=[...this.nav.querySelectorAll(`.dcx-nav-list > li > .dcx-nav-link`)],d=[...a.querySelectorAll(`:scope > .dcx-sub-link`)];u.forEach(e=>e.setAttribute(`data-dcx-rail-node`,``)),d.forEach(e=>e.setAttribute(`data-dcx-rail-node`,``));let f=e.querySelector(`:scope > .dcx-nav-link`),p=e=>o[Number(e.dataset.dcxSubsection)],m=[];(n||t!==`audience`)&&f&&m.push({node:f,target:r.querySelector(`:scope > header`)||r}),d.forEach(e=>{let t=e.dataset.dcxRailTarget,n=e.dataset.dcxDocumentTarget,i=n?this.main.querySelector(`#${CSS.escape(n)}`):t===`__overview__`?r.querySelector(`:scope > header`)||r:t?o.find(e=>e.dataset.label===t):p(e);i&&m.push({node:e,target:i})}),this.entries=m,this.railReady=!1,this.rebuild(!0),this.categoryTransitionActive||[0,320,650].forEach(e=>{this.rebuildTimers.push(window.setTimeout(()=>{i===this&&this.currentArticle===r&&this.rebuild(!0)},e))})}measureRailPoints(){if(!this.desktop.matches||!this.nav.offsetHeight||!this.track||!this.active)return[];let e=this.nav.getBoundingClientRect(),t=[...this.nav.querySelectorAll(`[data-dcx-rail-node]`)].filter(e=>e.getClientRects().length>0);return t.length?t.map(t=>{let n=t.getBoundingClientRect();return{node:t,x:n.left-e.left+1,yTop:n.top-e.top,yBottom:n.bottom-e.top}}):[]}pathDataForProgress(e,t=1){if(!e.length)return``;let n=e[0].x,r=e=>n+(e-n)*t,i=``,a=null;return e.forEach((e,t)=>{let n=r(e.x);if(t===0)i=`M ${n} ${e.yTop} `;else if(Math.abs(e.x-a.x)<.5)i+=`L ${n} ${e.yTop} `;else{let t=r(a.x),o=(a.yBottom+e.yTop)/2;i+=`C ${t} ${o}, ${n} ${o}, ${n} ${e.yTop} `}i+=`L ${n} ${e.yBottom} `,a=e}),i}buildPath(){let e=this.measureRailPoints();if(!e.length)return!1;let t=``,n=null,r=new Map;return e.forEach((e,i)=>{if(i===0)t=`M ${e.x} ${e.yTop} `;else if(Math.abs(e.x-n.x)<.5)t+=`L ${e.x} ${e.yTop} `;else{let r=(n.yBottom+e.yTop)/2;t+=`C ${n.x} ${r}, ${e.x} ${r}, ${e.x} ${e.yTop} `}this.active.setAttribute(`d`,t);let a=this.active.getTotalLength();t+=`L ${e.x} ${e.yBottom} `,this.active.setAttribute(`d`,t);let o=this.active.getTotalLength();r.set(e.node,{start:a,length:Math.max(1,o-a)}),n=e}),this.track.setAttribute(`d`,t),this.active.setAttribute(`d`,t),this.segments=r,this.railLength=this.active.getTotalLength(),Number.isFinite(this.railLength)&&this.railLength>0}moveRail(e,t=!1){let n=this.segments.get(e);!n||!this.railLength||(this.currentPaintNode=e,(t||this.reducedMotion.matches)&&(this.active.setAttribute(`data-initial`,`true`),this.active.getBoundingClientRect()),this.active.style.strokeDasharray=`${n.length} ${this.railLength+1}`,this.active.style.strokeDashoffset=`${-n.start}`,requestAnimationFrame(()=>{i===this&&(this.active.setAttribute(`data-ready`,`true`),this.nav.setAttribute(`data-rail-ready`,`true`),requestAnimationFrame(()=>this.active.removeAttribute(`data-initial`)))}),this.railReady=!0)}updateCurrent(e=!1){if(!this.entries.length||!this.desktop.matches)return;let t=this.main.getBoundingClientRect().top+this.main.clientHeight*.25,n=this.entries.find(e=>e.node===this.pinnedNode)||this.entries.find(e=>e.node===this.categoryTransitionNode)||this.entries[0];!this.pinnedNode&&!this.categoryTransitionNode&&this.main.scrollTop>4&&(this.entries.forEach(e=>{e.target.getBoundingClientRect().top<=t&&(n=e)}),this.main.scrollTop+this.main.clientHeight>=this.main.scrollHeight-4&&(n=this.entries.at(-1))),this.nav.querySelectorAll(`.dcx-sub-link[aria-current="location"]`).forEach(e=>{e!==n.node&&e.removeAttribute(`aria-current`)}),n.node.matches(`.dcx-sub-link`)&&n.node.setAttribute(`aria-current`,`location`),this.moveRail(n.node,e||!this.railReady)}rebuild(e=!1){if(!this.desktop.matches){this.nav.removeAttribute(`data-rail-ready`),this.active.removeAttribute(`data-ready`);return}this.buildPath()&&this.updateCurrent(e)}scheduleRebuild(e=!1){this.rebuildFrame&&cancelAnimationFrame(this.rebuildFrame),this.rebuildFrame=requestAnimationFrame(()=>{this.rebuildFrame=0,this.rebuild(e)})}handleScroll(){this.scrollFrame||!this.desktop.matches||(this.scrollFrame=requestAnimationFrame(()=>{this.scrollFrame=0,this.main.dataset.dcxContinuous===`true`&&this.refresh(),this.updateCurrent()}))}nodeLine(e){if(!e?.getClientRects().length)return null;let t=this.nav.getBoundingClientRect(),n=e.getBoundingClientRect();return{x:n.left-t.left+1,yTop:n.top-t.top,yBottom:n.bottom-t.top}}scrollTargetNode(e,t){let n=this.main.querySelector(`:scope > .dcx-article[data-dcx-category="${CSS.escape(e)}"]`),r=this.nav.querySelector(`.dcx-nav-list > li[data-category="${CSS.escape(e)}"] > .dcx-subnav`);if(!n||!r)return t;let i=this.main.getBoundingClientRect().top+this.main.clientHeight*.25,a=null;if(n.querySelectorAll(`:scope > .dcx-block[data-label]`).forEach(e=>{e.getBoundingClientRect().top<=i&&(a=e)}),!a)return t;let o=[...r.querySelectorAll(`:scope > .dcx-sub-link[data-dcx-document-target]`)].find(e=>e.dataset.dcxDocumentTarget===a.id);if(o)return o;if(e!==`audience`)return t;let s=a.dataset.label,c=s===`Who they are`||s===`Emotional journey`||s===`Emotional state`?`People`:s===`Needs`||s===`Trust triggers`?`Decision factors`:s===`Who must not be excluded`?`Inclusion`:null;return c&&[...r.querySelectorAll(`:scope > .dcx-sub-link`)].find(e=>e.textContent.trim()===c)||t}remeasureSubnavs(){this.desktop.matches&&this.nav.querySelectorAll(`.dcx-nav-list > li[data-category] > .dcx-subnav`).forEach(e=>{let t=[...e.querySelectorAll(`:scope > .dcx-sub-link`)],n=t.map(e=>e.getBoundingClientRect().height);if(!n.some(e=>e>0))return;let r=e.classList.contains(`dcx-subnav--summary`),i=r?0:2,a=r?14:10,o=n.reduce((e,t)=>e+t,0)+Math.max(0,t.length-1)*i+a;e.style.setProperty(`--dcx-subnav-height`,`${Math.ceil(o)}px`)})}finalNodeLine(e,t){let n=[...this.nav.querySelectorAll(`.dcx-nav-list > li[data-category] > .dcx-nav-link`)],r=n.findIndex(t=>t.dataset.dcxNav===e),i=n[r];if(!t||!i||r<0||!n.length)return null;let a=this.nav.getBoundingClientRect(),o=n[0].getBoundingClientRect(),s=t.getBoundingClientRect(),c=o.top-a.top;for(let e=0;e<r;e+=1)c+=n[e].getBoundingClientRect().height;if(t===i)return{x:s.left-a.left+1,yTop:c,yBottom:c+s.height};let l=i.closest(`li[data-category]`)?.querySelector(`:scope > .dcx-subnav`),u=[...l?.querySelectorAll(`:scope > .dcx-sub-link`)||[]],d=u.indexOf(t);if(!l||d<0)return null;let f=l.classList.contains(`dcx-subnav--summary`),p=f?0:2,m=f?4:2;c+=i.getBoundingClientRect().height+m;for(let e=0;e<d;e+=1)c+=u[e].getBoundingClientRect().height+p;return{x:s.left-a.left+1,yTop:c,yBottom:c+s.height}}transitionLineGeometry(){if(!this.transitionActive.hasAttribute(`data-visible`))return null;let e=this.nav.getBoundingClientRect(),t=this.transitionActive.getBoundingClientRect();return t.height?{x:t.left-e.left+t.width/2,yTop:t.top-e.top,yBottom:t.bottom-e.top}:null}measureStraightTrack(){if(!this.desktop.matches)return!1;let e=[...this.nav.querySelectorAll(`.dcx-nav-list > li[data-category] > .dcx-nav-link`)].filter(e=>e.getClientRects().length>0);if(!e.length)return!1;let t=this.nav.getBoundingClientRect(),n=e[0].getBoundingClientRect(),r=e.at(-1).getBoundingClientRect();return{x:n.left-t.left+1,yTop:n.top-t.top,yBottom:r.bottom-t.top}}buildStraightTrack(){let e=this.measureStraightTrack();return e?(this.transitionTrack.setAttribute(`d`,`M ${e.x} ${e.yTop} L ${e.x} ${e.yBottom}`),!0):!1}fitPointsToStraightTrack(e,t){if(!e?.length||!t)return[];let n=e[0].yTop,r=e.at(-1).yBottom,i=Math.max(1,r-n),a=(t.yBottom-t.yTop)/i,o=e[0].x;return e.map(e=>({...e,x:t.x+e.x-o,yTop:t.yTop+(e.yTop-n)*a,yBottom:t.yTop+(e.yBottom-n)*a}))}moveTransitionActive(e){if(!e)return;let t=Math.max(1,Number(this.transitionActive.getAttribute(`y2`))-Number(this.transitionActive.getAttribute(`y1`))),n=Number(this.transitionActive.getAttribute(`x1`)),r=Number(this.transitionActive.getAttribute(`y1`)),i=Math.max(1,e.yBottom-e.yTop),a=e.x-n,o=e.yTop-r+(i-t)/2,s=i/t;this.transitionActive.style.transform=`translate(${a}px, ${o}px) scaleY(${s})`}clearCategoryTransitionVisuals(){window.clearTimeout(this.categoryTransitionCleanupTimer),this.categoryTransitionCleanupTimer=0,this.transitionTrack.removeAttribute(`data-visible`),this.transitionTrack.removeAttribute(`data-initial`),this.transitionTrack.removeAttribute(`data-settling`),this.transitionActive.removeAttribute(`data-visible`),this.transitionActive.removeAttribute(`data-initial`),this.transitionActive.removeAttribute(`data-settling`),this.transitionActive.removeAttribute(`data-handoff`),this.track.removeAttribute(`data-entering`),this.track.removeAttribute(`data-settling`),this.track.removeAttribute(`data-morphing`),this.active.removeAttribute(`data-entering`),this.active.removeAttribute(`data-handoff`),this.transitionActive.style.removeProperty(`transform`),this.nav.removeAttribute(`data-category-transition`)}cancelCategoryTransitionFrames(){this.categoryTransitionBeginFrame&&cancelAnimationFrame(this.categoryTransitionBeginFrame),this.categoryTransitionFrame&&cancelAnimationFrame(this.categoryTransitionFrame),this.categoryTransitionHandoffFrame&&cancelAnimationFrame(this.categoryTransitionHandoffFrame),this.categoryTransitionBeginFrame=0,this.categoryTransitionFrame=0,this.categoryTransitionHandoffFrame=0}cancelCategoryTransition(){this.categoryTransitionGeneration+=1,this.cancelCategoryTransitionFrames(),this.categoryTransitionActive=!1,this.categoryTransitionTarget=null,this.categoryTransitionFinalTarget=null,this.categoryTransitionNode=null,this.categoryTransitionBranchPoints=null,this.categoryTransitionBranchProgress=0,this.categoryTransitionRetractPoints=null,this.categoryTransitionRetractProgress=0,this.categoryTransitionRetractStart=0,this.categoryTransitionRenderedPoints=null,this.categoryTransitionRenderedProgress=0,this.clearCategoryTransitionVisuals(),this.transitionTrack.removeAttribute(`d`),this.transitionActive.removeAttribute(`x1`),this.transitionActive.removeAttribute(`x2`),this.transitionActive.removeAttribute(`y1`),this.transitionActive.removeAttribute(`y2`)}snapshotCategoryTransition(e){if(!this.desktop.matches||this.reducedMotion.matches||!this.railReady)return!1;let t=this.transitionLineGeometry()||this.nodeLine(this.currentPaintNode),n=this.nav.querySelector(`.dcx-nav-list > li[data-category="${CSS.escape(e.detail?.to||``)}"] > .dcx-nav-link`),r=e.detail?.source===`scroll`?this.scrollTargetNode(e.detail?.to,n):n,i=this.finalNodeLine(e.detail?.to,n),a=this.finalNodeLine(e.detail?.to,r);if(!t||!i||!a)return!1;let o=this.categoryTransitionBranchPoints?.length&&this.categoryTransitionBranchProgress>0?this.categoryTransitionBranchPoints:null,s=this.categoryTransitionRenderedPoints?.length&&this.categoryTransitionRenderedProgress>0?this.categoryTransitionRenderedPoints:null,c=(o||s)?.map(e=>({...e}))||null,l=o?this.categoryTransitionBranchProgress:s?this.categoryTransitionRenderedProgress:0;return this.categoryTransitionGeneration+=1,this.cancelCategoryTransitionFrames(),this.clearCategoryTransitionVisuals(),c?this.transitionTrack.setAttribute(`d`,this.pathDataForProgress(c,l)):this.buildStraightTrack(),this.transitionActive.setAttribute(`x1`,t.x),this.transitionActive.setAttribute(`x2`,t.x),this.transitionActive.setAttribute(`y1`,t.yTop),this.transitionActive.setAttribute(`y2`,t.yBottom),this.transitionActive.style.transform=`translate(0px, 0px) scaleY(1)`,this.transitionTrack.setAttribute(`data-visible`,`true`),this.transitionActive.setAttribute(`data-visible`,`true`),this.transitionTrack.setAttribute(`data-initial`,`true`),this.transitionActive.setAttribute(`data-initial`,`true`),this.track.setAttribute(`data-entering`,`true`),this.active.setAttribute(`data-entering`,`true`),this.nav.setAttribute(`data-category-transition`,`layout`),this.svg.getBoundingClientRect(),this.categoryTransitionTarget=i,this.categoryTransitionFinalTarget=a,this.categoryTransitionNode=r,this.categoryTransitionBranchPoints=null,this.categoryTransitionBranchProgress=0,this.categoryTransitionRetractPoints=c,this.categoryTransitionRetractProgress=l,this.categoryTransitionRetractStart=0,this.categoryTransitionRenderedPoints=c?.map(e=>({...e}))||null,this.categoryTransitionRenderedProgress=l,this.categoryTransitionActive=!0,!0}beginCategoryTransition(e){if(e!==this.categoryTransitionGeneration||!this.categoryTransitionActive||!this.categoryTransitionTarget||!this.categoryTransitionFinalTarget)return;this.transitionTrack.removeAttribute(`data-initial`),this.transitionActive.removeAttribute(`data-initial`),this.moveTransitionActive(this.categoryTransitionTarget);let t=performance.now();this.categoryTransitionStart=t,this.categoryTransitionRetractPoints&&(this.categoryTransitionRetractStart=t),this.categoryTransitionFrame=requestAnimationFrame(t=>{this.animateCategoryTransition(t,e)})}animateCategoryTransition(e,t){if(this.categoryTransitionFrame=0,!(t!==this.categoryTransitionGeneration||!this.categoryTransitionActive||i!==this)){if(this.categoryTransitionRetractPoints){let t=this.measureStraightTrack(),r=this.fitPointsToStraightTrack(this.categoryTransitionRetractPoints,t),i=Math.min(1,(e-this.categoryTransitionRetractStart)/140),a=this.categoryTransitionRetractProgress*(1-n(i));r.length&&(this.transitionTrack.setAttribute(`d`,this.pathDataForProgress(r,a)),this.categoryTransitionRenderedPoints=r.map(e=>({...e})),this.categoryTransitionRenderedProgress=a),(i>=1||!r.length)&&(this.categoryTransitionRetractPoints=null,this.categoryTransitionRetractProgress=0,this.categoryTransitionRetractStart=0,this.categoryTransitionRenderedPoints=null,this.categoryTransitionRenderedProgress=0,this.buildStraightTrack())}else this.buildStraightTrack();if(e-this.categoryTransitionStart<520){this.categoryTransitionFrame=requestAnimationFrame(e=>{this.animateCategoryTransition(e,t)});return}this.beginBranchTransition(t)}}beginBranchTransition(e){if(e!==this.categoryTransitionGeneration||!this.categoryTransitionActive||!this.categoryTransitionFinalTarget)return;this.categoryTransitionFrame&&cancelAnimationFrame(this.categoryTransitionFrame),this.categoryTransitionFrame=0,this.buildStraightTrack();let t=this.measureRailPoints();if(!t.length||!this.buildPath()){this.cancelCategoryTransition(),this.remeasureSubnavs(),this.scheduleRebuild(!0);return}this.updateCurrent(!1),this.categoryTransitionBranchPoints=t,this.categoryTransitionBranchProgress=0,this.categoryTransitionRetractPoints=null,this.categoryTransitionRetractProgress=0,this.categoryTransitionRetractStart=0,this.categoryTransitionRenderedPoints=t.map(e=>({...e})),this.categoryTransitionRenderedProgress=0,this.track.setAttribute(`d`,this.pathDataForProgress(t,0)),this.track.setAttribute(`data-morphing`,`true`),this.transitionTrack.setAttribute(`data-initial`,`true`),this.transitionActive.setAttribute(`data-settling`,`true`),this.nav.setAttribute(`data-category-transition`,`branch`),this.track.removeAttribute(`data-entering`),this.transitionTrack.removeAttribute(`data-visible`),this.svg.getBoundingClientRect(),this.moveTransitionActive(this.categoryTransitionFinalTarget),this.categoryTransitionStart=performance.now(),this.categoryTransitionFrame=requestAnimationFrame(t=>{this.animateBranchTransition(t,e)})}animateBranchTransition(e,t){if(this.categoryTransitionFrame=0,t!==this.categoryTransitionGeneration||!this.categoryTransitionActive||!this.categoryTransitionBranchPoints||i!==this)return;let r=Math.min(1,(e-this.categoryTransitionStart)/320),a=n(r);if(this.categoryTransitionBranchProgress=a,this.categoryTransitionRenderedPoints=this.categoryTransitionBranchPoints.map(e=>({...e})),this.categoryTransitionRenderedProgress=a,this.track.setAttribute(`d`,this.pathDataForProgress(this.categoryTransitionBranchPoints,a)),r<1){this.categoryTransitionFrame=requestAnimationFrame(e=>{this.animateBranchTransition(e,t)});return}this.completeBranchTransition(t)}completeBranchTransition(e){e!==this.categoryTransitionGeneration||!this.categoryTransitionActive||(this.categoryTransitionActive=!1,this.categoryTransitionTarget=null,this.categoryTransitionFinalTarget=null,this.categoryTransitionBranchPoints=null,this.categoryTransitionBranchProgress=0,this.categoryTransitionRetractPoints=null,this.categoryTransitionRetractProgress=0,this.categoryTransitionRetractStart=0,this.categoryTransitionRenderedPoints=null,this.categoryTransitionRenderedProgress=0,this.buildPath(),this.track.removeAttribute(`data-morphing`),this.updateCurrent(!1),this.active.setAttribute(`data-handoff`,`true`),this.transitionActive.setAttribute(`data-handoff`,`true`),this.svg.getBoundingClientRect(),this.active.removeAttribute(`data-entering`),this.transitionActive.removeAttribute(`data-visible`),this.categoryTransitionHandoffFrame=requestAnimationFrame(()=>{this.categoryTransitionHandoffFrame=0,e===this.categoryTransitionGeneration&&(this.active.removeAttribute(`data-handoff`),this.transitionActive.removeAttribute(`data-handoff`))}),this.nav.removeAttribute(`data-category-transition`),this.categoryTransitionCleanupTimer=window.setTimeout(()=>{e===this.categoryTransitionGeneration&&(this.categoryTransitionCleanupTimer=0,this.transitionTrack.removeAttribute(`d`),this.transitionTrack.removeAttribute(`data-initial`),this.transitionTrack.removeAttribute(`data-settling`),this.transitionActive.removeAttribute(`data-settling`),this.track.removeAttribute(`data-settling`),this.transitionActive.style.removeProperty(`transform`),this.transitionActive.removeAttribute(`x1`),this.transitionActive.removeAttribute(`x2`),this.transitionActive.removeAttribute(`y1`),this.transitionActive.removeAttribute(`y2`),this.categoryTransitionNode=null,this.updateCurrent(!1))},220))}handleContinuousCategoryWillChange(e){this.snapshotCategoryTransition(e)}handleContinuousCategoryChange(){if(this.refresh(),this.categoryTransitionActive){let e=this.categoryTransitionGeneration;this.categoryTransitionBeginFrame&&cancelAnimationFrame(this.categoryTransitionBeginFrame),this.categoryTransitionBeginFrame=requestAnimationFrame(()=>{this.categoryTransitionBeginFrame=0,this.beginCategoryTransition(e)})}else this.scheduleRebuild(!0)}handleResize(){this.categoryTransitionActive||(this.remeasureSubnavs(),this.scheduleRebuild(!0))}handleMediaChange(){this.cancelCategoryTransition(),this.remeasureSubnavs(),this.scheduleRebuild(!0)}handleReducedMotionChange(){this.cancelCategoryTransition(),this.remeasureSubnavs(),this.scheduleRebuild(!0)}handleRailClick(e){let t=e.target.closest(`.dcx-sub-link[data-dcx-rail-node]`);t&&this.nav.contains(t)&&(this.pinnedNode=t,this.updateCurrent());let n=e.target.closest(`.dcx-sub-link[data-dcx-rail-summary]`);if(!n||!this.nav.contains(n)||this.main.dataset.dcxContinuous===`true`)return;let r=n.dataset.dcxRailTarget,i=r===`__overview__`?this.currentArticle?.querySelector(`:scope > header`)||this.currentArticle:[...this.main.querySelectorAll(`.dcx-block[data-label]`)].find(e=>e.dataset.label===r);if(!i)return;e.preventDefault(),e.stopPropagation();let a=this.main.getBoundingClientRect(),o=r===`__overview__`?0:i.getBoundingClientRect().top-a.top+this.main.scrollTop-18;this.main.scrollTo({top:Math.max(0,o),behavior:this.reducedMotion.matches?`auto`:`smooth`})}clearPinnedNode(){this.pinnedNode&&=null}handleKeydown(e){[`ArrowDown`,`ArrowUp`,`PageDown`,`PageUp`,`Home`,`End`,` `].includes(e.key)&&this.clearPinnedNode()}destroy(){this.cancelCategoryTransition(),this.main?.removeEventListener(`scroll`,this.handleScroll),this.main?.removeEventListener(`wheel`,this.clearPinnedNode),this.main?.removeEventListener(`touchstart`,this.clearPinnedNode),this.main?.removeEventListener(`pointerdown`,this.clearPinnedNode),this.nav?.removeEventListener(`click`,this.handleRailClick),this.expander?.removeEventListener(`dcx:continuouscategorywillchange`,this.handleContinuousCategoryWillChange),this.expander?.removeEventListener(`dcx:continuouscategorychange`,this.handleContinuousCategoryChange),window.removeEventListener(`resize`,this.handleResize),window.removeEventListener(`keydown`,this.handleKeydown),this.desktop?.removeEventListener(`change`,this.handleMediaChange),this.reducedMotion?.removeEventListener(`change`,this.handleReducedMotionChange),this.resizeObserver?.disconnect(),this.rebuildTimers.forEach(e=>window.clearTimeout(e)),this.scrollFrame&&cancelAnimationFrame(this.scrollFrame),this.rebuildFrame&&cancelAnimationFrame(this.rebuildFrame),this.svg?.remove(),this.nav?.classList.remove(`dcx-material-rail-host`),this.nav?.removeAttribute(`data-rail-ready`)}}let c=()=>{a=0;let e=document.querySelector(`.dcx-expander`);if(!e){i?.destroy(),i=null;return}(!i||i.expander!==e)&&(i?.destroy(),i=new s(e)),i.refresh()},l=()=>{a||=requestAnimationFrame(c)};new MutationObserver(l).observe(document.body,{childList:!0,subtree:!0}),window.addEventListener(`pageshow`,l),l()})();var n=e=>Math.min(1,Math.max(0,e)),r=e=>e<=.04045?e/12.92:((e+.055)/1.055)**2.4,i=e=>e<=.0031308?12.92*e:1.055*e**(1/2.4)-.055,a=e=>e.match(/[\da-f]{2}/gi).map(e=>Number.parseInt(e,16)/255);function o([e,t,n]){let r=n*Math.PI/180,i=t*Math.cos(r),a=t*Math.sin(r),o=(e+.3963377774*i+.2158037573*a)**3,s=(e-.1055613458*i-.0638541728*a)**3,c=(e-.0894841775*i-1.291485548*a)**3;return[4.0767416621*o-3.3077115913*s+.2309699292*c,-1.2684380046*o+2.6097574011*s-.3413193965*c,-.0041960863*o-.7034186147*s+1.707614701*c]}function s([e,t,r]){let a=n(e),s=Math.max(0,t),c=o([a,s,r]);for(;s>0&&c.some(e=>e<0||e>1);)s=Math.max(0,s-.005),c=o([a,s,r]);return`#${c.map(e=>Math.round(n(i(e))*255).toString(16).padStart(2,`0`)).join(``).toUpperCase()}`}function c(e){let[t,n,i]=a(e).map(r),o=Math.cbrt(.4122214708*t+.5363325363*n+.0514459929*i),s=Math.cbrt(.2119034982*t+.6806995451*n+.1073969566*i),c=Math.cbrt(.0883024619*t+.2817188376*n+.6299787005*i),l=.2104542553*o+.793617785*s-.0040720468*c,u=1.9779984951*o-2.428592205*s+.4505937099*c,d=.0259040371*o+.7827717662*s-.808675766*c,f=Math.hypot(u,d);return[l,f,f<1e-5?0:(Math.atan2(d,u)*180/Math.PI+360)%360]}function l(e){let[t,n,r]=c(e);return`oklch(${(t*100).toFixed(1)}% ${n.toFixed(3)} ${r.toFixed(1)})`}function u(e){let[t,n,r]=e.oklch;return{primary:s([t,n,r]),secondary:s([t<.5?t+.18:t-.18,n*.6,r]),tertiary:s([.62,Math.min(.23,Math.max(n,.15)),(r+60)%360]),neutral:s([t<.55?.96:.2,.01,r])}}var d=.0027,f=.9716;function p(e){let t=_(e),n=e=>v(e,t);return n(d)>=n(f)?`var(--pk-ink-dark)`:`var(--pk-ink-light)`}function m(e){return p(e).includes(`light`)?s([.99,.008,95]):s([.14,.018,95])}function h(e){return typeof e==`string`&&/^#[0-9A-F]{6}$/i.test(e)}function g(e,t=[`http:`,`https:`]){try{let n=new URL(e);return t.includes(n.protocol)?n.href:``}catch{return``}}function _(e){let[t,n,i]=a(e).map(r);return .2126*t+.7152*n+.0722*i}function v(e,t){let[n,r]=e>t?[e,t]:[t,e];return(n+.05)/(r+.05)}function y(e,t,n=4.5){let r=_(t);if(v(_(e),r)>=n)return e;let[i,a,o]=c(e),l=v(d,r)>=v(f,r),u=l?-.015:.015;for(let e=i+u;e>.03&&e<1;e+=u){let t=s([e,a,o]);if(v(_(t),r)>=n)return t}return l?`#000000`:`#FFFFFF`}var b=7,ee=3;function x({neutral:e,primary:t}){let n=_(e),r=Math.max(v(d,n),v(f,n)),i=[];return r<b&&i.push(`This background is too close to a middle gray, so text on it will be hard to read. Try a much lighter or much darker color.`),v(_(t),n)<ee&&i.push(`Your main color and this background are too similar, so buttons and cards will blend in. Try more difference between them.`),i}var te=null;function ne(){return te??=fetch(`/boot.json`).then(e=>e.ok?e.json():null).catch(()=>null).then(e=>({mode:e?.mode===`doc`?`doc`:`questionnaire`,prior:e?.prior&&typeof e.prior==`object`&&!Array.isArray(e.prior)?e.prior:null,priorSource:e?.priorSource||null,doc:e?.doc||null})),te}var re,ie=new Promise(e=>{re=e});function ae(e){document.body.dataset.hydrated=e||`none`,re(e||null)}var oe=[`primary`,`secondary`,`tertiary`,`neutral`],se=[`color-strategy`,`motion-energy`,`layout-structure`,`boundary-style`,`corner-style`,`depth-style`,`type-scale`,`icon-pack`],S=e=>typeof e==`string`?e:``;function C(e,t){if(!t)return!1;let n=document.querySelector(`input[name="${e}"][value="${CSS.escape(t)}"]`);return!n||n.disabled?!1:(n.click(),!0)}function ce(){return[...document.querySelectorAll(`input[type="hidden"][data-surface-field]`)]}function le(e,t){if(e){w(e,t);for(let t of se)t in e&&C(t,S(e[t]));ue(e),de(e,t),fe(e,t),T(e),pe(e,t)}}function w(e,t){let n=e[`surface-modes`],r=new Set(Array.isArray(n)?n:S(n)?[n]:[]);if(r.size&&t.modeInputs.some(e=>r.has(e.value))){for(let e of t.modeInputs)e.checked=r.has(e.value);t.syncModes()}}function ue(e){for(let t of ce()){let n=t.dataset.surfaceField;if(t.disabled||!(n in e))continue;let r=S(e[n]);r&&(t.value=r)}}function de(e,t){let n=S(e[`palette-source`]),r={};for(let t of oe){let n=S(e[`palette-${t}`]);n&&(r[t]=n)}if(!n&&!Object.keys(r).length)return;let i=document.querySelector(`[name="palette-source"]`);i&&n&&(i.value=n);for(let e of oe){let t=document.querySelector(`[name="palette-${e}"]`);t&&r[e]&&(t.value=r[e])}if(!t.cards.length)return;let a=t.cards.findIndex(e=>e.id===n),o=a===-1?0:a,s=t.states.get(t.cards[o]?.id);s?.colors&&Object.assign(s.colors,r),t.setCurrent(o),t.render(),t.syncDeckScroll()}function fe(e,t){let n=S(e[`font-pair`]),r=S(e[`font-heading`]),i=S(e[`font-body`]),a=t.fontManifest();if(n&&n!==`custom`&&a.pairs.some(({id:e})=>e===n)&&C(`font-pair`,n)||!r||!i)return;let o={id:`custom`,name:`Custom`,heading:{family:r,weight:600,source:S(e[`font-heading-source`])},body:{family:i,weight:400,source:S(e[`font-body-source`])},why:`From your last run`};a.pairs=[o,...a.pairs.filter(({id:e})=>e!==`custom`)];for(let e of t.pairNodes())e.querySelector(`input`)?.value===`custom`&&t.removePairCard(e);t.addPairCard(o,{checked:!0,first:!0}),t.loadCustomFace(o),t.syncFontPair(o),t.applyHoist({force:!0})}function T(e){for(let t of[`icon-pack-name`,`icon-pack-license`,`icon-pack-url`]){let n=document.querySelector(`[name="${t}"]`),r=S(e[t]);n&&!n.value&&r&&(n.value=r)}}function pe(e,t){let n=null;try{let t=JSON.parse(S(e._chosen)||`null`);Array.isArray(t)&&(n=new Set(t))}catch{}for(let t of ce()){let r=t.dataset.surfaceField;t.disabled||((n?n.has(r):r in e)?t.dataset.chosen=`yes`:delete t.dataset.chosen)}t.syncChosenField()}var E=[`primary`,`secondary`,`tertiary`,`neutral`],me=document.querySelector(`[data-screen="02"]`),D=(e,t=me)=>t.querySelector(e),he=(e,t=me)=>t.querySelectorAll(e),ge=D(`[data-deck-scroll]`),_e=D(`[data-deck-points]`),O=D(`[data-deck-cards]`),ve=D(`[data-deck-count]`),k=D(`.picker-palette-panel`),ye=D(`[data-palette-hint]`),be=D(`[data-ring-guide]`),A=D(`[data-loupe]`),xe=D(`.picker-preview`),Se=document.querySelector(`[data-type-stage]`),Ce=[...document.querySelectorAll(`[data-type-preview]`)],j=document.querySelector(`[data-font-options]`),we=document.querySelector(`[data-pair-card]`),Te=document.querySelector(`[data-scale-options]`),Ee=document.querySelector(`[data-scale-sheet]`),De=document.querySelector(`[data-scale-specimen]`),M=new Map,Oe=new WeakMap,N=[],P=0,ke,Ae,je={sentence:`Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.`,paragraph:`Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo.`,passages:[`Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur sint occaecat cupidatat.`,`Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione.`],note:`Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque.`,items:[`Excepteur sint occaecat`,`Non proident, sunt in culpa`]},Me={brand:`Lo`,nav:[`Lorem`,`Ipsum`,`Dolor`,`Amet`],navAction:`Consectetur`,menuAction:`Ipsum`,ctaPrimary:`Lorem ipsum`,ctaSecondary:`Dolor sit`,proof:[`Lorem ipsum dolor`,`Sit amet elit dolor`,`Sed do eiusmod`,`Tempor incididunt`],sectionTitle:`Lorem ipsum dolor`,sectionLink:`Consectetur adipiscing`,gallery:[{title:`Lorem ipsum dolor`,meta:`sit amet consectetur`},{title:`Dolor sit amet`,meta:`consectetur elit`},{title:`Eiusmod tempor`,meta:`sed do eiusmod`}],footerLinks:[`Lorem`,`Ipsum`,`Dolor`,`Amet`],footerMark:`© Lorem ipsum`},Ne={headline:`Lorem ipsum dolor sit amet`},Pe={rail:[`Lorem`,`Ipsum`,`Dolor`],columns:[`Lorem`,`Ipsum`,`Dolor`],figures:[`1,284`,`98.2%`,`41`],amounts:[`$12,400`,`$3,860`,`$9,215`],panel:[`Lorem ipsum`,`Dolor sit amet`],switches:[`Lorem ipsum`,`Dolor sit`],chartTitle:`Lorem ipsum dolor`,lanes:[`Lorem`,`Ipsum`,`Dolor`,`Amet`,`Elit`]},Fe={rail:[`Lorem ipsum`,`Dolor`,`Consectetur`,`Adipiscing elit`],crumb:`Lorem / Ipsum dolor`,note:`Nota`},Ie={stops:[`Lorem`,`Ipsum`,`Dolor`,`Amet`],caption:`Lorem ipsum dolor sit amet,
consectetur adipiscing elit sed do eiusmod tempor.`},Le=3,Re={version:1,specimen:{headline:`Built for the work at hand`},preview:{brand:`Ab`,nav:[`Product`,`Pricing`,`Docs`,`About`],navAction:`Sign in`,menuAction:`Menu`,ctaPrimary:`Get started`,ctaSecondary:`Learn more`,proof:[`Fast to set up`,`Works anywhere`,`No lock-in`,`Free to try`],sectionTitle:`Everything in one place`,sectionLink:`Read the guide`,gallery:[{title:`Overview`,meta:`Start here`},{title:`Library`,meta:`Browse all`},{title:`Reports`,meta:`See results`}],footerLinks:[`Product`,`Company`,`Support`,`Legal`],footerMark:`© Your product`},pairs:[{id:`source-editorial`,name:`Source editorial`,heading:{family:`Source Serif 4`,weight:600},body:{family:`Source Sans 3`,weight:400},why:`Considered and editorial`},{id:`literary-clarity`,name:`Literary clarity`,heading:{family:`Libre Baskerville`,weight:700},body:{family:`Libre Franklin`,weight:400},why:`Bookish and plain-spoken`},{id:`warm-structure`,name:`Warm structure`,heading:{family:`Bitter`,weight:600},body:{family:`Cabin`,weight:400},why:`Sturdy slab warmth`},{id:`bold-utility`,name:`Bold utility`,heading:{family:`Archivo Black`,weight:400},body:{family:`Archivo`,weight:400},why:`Headlines that shout`},{id:`technical-signal`,name:`Technical signal`,heading:{family:`Azeret Mono`,weight:600},body:{family:`Noto Sans`,weight:400},why:`Machined and precise`},{id:`classical-poise`,name:`Classical poise`,heading:{family:`Marcellus`,weight:400},body:{family:`Karla`,weight:400},why:`Inscriptional and formal`}]},ze=e=>Object.fromEntries(E.map(t=>[t,e(t)])),F=()=>N[P],I=()=>M.get(F().id),Be=()=>be.setAttribute(`aria-hidden`,`true`),Ve=/serif|mincho|baskerville|bitter|marcellus|slab|antiqua|garamond|didot|bodoni/i,He=e=>`"${e.replaceAll(`"`,`\\"`)}", ${Ve.test(e)?`serif`:`sans-serif`}`;function Ue(e){return{colors:e.type===`cue`?ze(t=>(e.palette[t].snapped||e.palette[t].hex).toUpperCase()):u(e),detached:ze(()=>!1),rings:ze(()=>[50,50])}}function We(e){let t=Oe.get(e);return t||(t=document.createElement(`canvas`),t.width=e.naturalWidth,t.height=e.naturalHeight,t.getContext(`2d`,{willReadFrequently:!0}).drawImage(e,0,0),Oe.set(e,t),t)}function Ge(e,t,n,r,i){let a=D(`.picker-ring-axis--x[data-role="${t}"]`,e),o=D(`.picker-ring-axis--y[data-role="${t}"]`,e);a&&(a.setAttribute(`aria-valuenow`,String(Math.round(n))),a.setAttribute(`aria-valuetext`,`${i}, horizontal ${Math.round(n)}%`)),o&&(o.setAttribute(`aria-valuenow`,String(Math.round(r))),o.setAttribute(`aria-valuetext`,`${i}, vertical ${Math.round(r)}%`))}function Ke(e){if(e.type!==`cue`)return;let t=M.get(e.id);he(`.picker-ring`,e.node).forEach(n=>{let r=n.dataset.role,[i,a]=t.rings[r];n.style.setProperty(`--x`,`${i}%`),n.style.setProperty(`--y`,`${a}%`),n.style.setProperty(`--marker-color`,t.colors[r]),n.toggleAttribute(`data-detached`,t.detached[r]),Ge(e.node,r,i,a,t.colors[r])})}function qe(e,t,n){let[r,i]=M.get(t.id).rings[e.dataset.role],a=We(n),o=D(`canvas`,A).getContext(`2d`),s=r/100*(a.width-1),c=i/100*(a.height-1),l=Math.max(8,Math.min(a.width,a.height)/128);o.clearRect(0,0,80,80),o.imageSmoothingEnabled=!1,o.drawImage(a,s-l/2,c-l/2,l,l,0,0,80,80);let u=A.parentElement.getBoundingClientRect(),d=e.getBoundingClientRect();A.style.left=`${d.left-u.left+d.width/2}px`,A.style.top=`${d.top-u.top}px`,A.dataset.visible=``}function Je(e){let t=I().colors[e],n=D(`[data-band="${e}"]`,k);n.style.setProperty(`--band-color`,t),n.style.setProperty(`--band-ink`,p(t)),D(`output`,n).textContent=t,D(`input`,n).value=t,Ye()}function Ye(){if(N.length){for(let e of E)xe.style.setProperty(`--pv-${e}`,I().colors[e]);xe.style.setProperty(`--pv-n-ink`,p(I().colors.neutral)),On()}}function Xe(e,t=`pv`){let n=ze(e=>D(`[name="palette-${e}"]`).value);if(!e||Object.values(n).some(e=>!e))return;let r=(n,r)=>e.style.setProperty(`--${t}-${n}`,r);for(let e of E)r(e,n[e]);r(`n-ink`,p(n.neutral)),r(`p-ink`,p(n.primary)),r(`t-ink`,p(n.tertiary)),r(`p-on-n`,y(n.primary,n.neutral)),r(`t-on-n`,y(n.tertiary,n.neutral)),r(`t-on-p`,y(n.tertiary,n.primary)),r(`p-on-p`,y(n.primary,n.primary)),r(`t-on-t`,y(n.tertiary,n.tertiary)),r(`p-on-i`,y(n.primary,m(n.primary)))}function Ze(e){return!e||typeof e!=`object`?!1:[`brand`,`navAction`,`menuAction`,`ctaPrimary`,`ctaSecondary`,`sectionTitle`,`sectionLink`,`footerMark`].every(t=>e[t]===void 0||typeof e[t]==`string`)&&Object.entries({nav:4,proof:4,footerLinks:4}).every(([t,n])=>e[t]===void 0||Array.isArray(e[t])&&e[t].length===n&&e[t].every(e=>typeof e==`string`))&&(e.gallery===void 0||Array.isArray(e.gallery)&&e.gallery.length===Le&&e.gallery.every(e=>typeof e?.title==`string`&&typeof e?.meta==`string`))}function Qe(e){return{...e,preview:{...Re.preview,...e.preview}}}function $e(e){return e?.version===1&&typeof e.specimen?.headline==`string`&&(!e.preview||Ze(e.preview))&&e.pairs?.length===6&&e.pairs.every(e=>typeof e.id==`string`&&typeof e.name==`string`&&typeof e.heading?.family==`string`&&Number.isFinite(e.heading?.weight)&&typeof e.body?.family==`string`&&Number.isFinite(e.body?.weight)&&typeof e.why==`string`&&(!e.preview||Ze(e.preview)))}function et(e){let t=new Map,n=(e,n)=>{t.has(e)||t.set(e,new Set),t.get(e).add(n)};for(let t of e)n(t.heading.family,t.heading.weight),n(t.body.family,t.body.weight),n(t.body.family,700);let r=[...t].map(([e,t])=>`family=${encodeURIComponent(e).replaceAll(`%20`,`+`)}:wght@${[...t].sort((e,t)=>e-t).join(`;`)}`).join(`&`),i=document.createElement(`link`);i.rel=`stylesheet`,i.href=`https://fonts.googleapis.com/css2?${r}&display=swap`,i.dataset.pickerFonts=``,document.head.append(i)}function L(e,t,n){e&&e.querySelectorAll(t).forEach((e,t)=>{e.textContent=n[t]??``})}function tt(e){let t=Me,n=Ne,r=e.querySelector(`.ps-desktop`),i=e.querySelector(`.ps-phone-body`),a=e.dataset.surface===`read`?Fe.rail:Pe.rail,o=(t,n)=>{for(let r of e.querySelectorAll(t))r.textContent=n};o(`[data-type-brand]`,t.brand),o(`[data-type-nav-action]`,t.navAction),o(`[data-type-menu-action]`,t.menuAction),o(`[data-type-headline]`,n.headline),o(`[data-type-body]`,je.sentence),o(`[data-type-cta-primary]`,t.ctaPrimary),o(`[data-type-cta-secondary]`,t.ctaSecondary),o(`[data-type-section-title]`,t.sectionTitle),o(`[data-type-section-body]`,`${je.paragraph} Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.`),o(`[data-type-section-link]`,t.sectionLink),o(`[data-type-footer-mark]`,t.footerMark),o(`[data-type-note-label]`,Fe.note),o(`[data-type-note-body]`,je.note),o(`[data-type-crumb]`,Fe.crumb),o(`[data-type-caption]`,Ie.caption),o(`[data-type-chart-title]`,Pe.chartTitle);let s=(e,t)=>{e&&e.querySelectorAll(`.ps-gallery-item [data-type-gallery-caption]`).forEach((e,n)=>{let r=t[n];r&&(e.textContent=`${r.title} ${r.meta}`)})};for(let e of[r,i])L(e,`[data-type-nav]`,t.nav),L(e,`[data-type-proof]`,t.proof),L(e,`[data-type-gallery-title]`,t.gallery.map(({title:e})=>e)),L(e,`[data-type-gallery-meta]`,t.gallery.map(({meta:e})=>e)),L(e,`[data-type-passage]`,je.passages),L(e,`[data-type-item]`,je.items),L(e,`[data-type-stop]`,Ie.stops),L(e,`[data-type-rail]`,a),L(e,`[data-type-lane]`,Pe.lanes),L(e,`[data-type-column]`,Pe.columns),L(e,`[data-type-figure]`,Pe.figures),L(e,`[data-type-amount]`,Pe.amounts),L(e,`[data-type-panel]`,Pe.panel),L(e,`[data-type-switch]`,Pe.switches),s(e,t.gallery);L(r?.querySelector(`.ps-footer`),`[data-type-footer-link]`,t.footerLinks),nt(e)}function nt(e){let t=e.dataset.surface;if(t===`persuade`){e.querySelectorAll(`.ps-editorial-copy > em[data-type-section-link]`).forEach(e=>e.remove());let t=`Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.`;e.querySelectorAll(`[data-type-section-body]`).forEach(e=>{if(e.hasAttribute(`data-type-section-body-2`)){e.remove();return}let n=e.nextElementSibling;if(n?.hasAttribute(`data-type-section-body-2`)){e.textContent=t,n.remove();return}e.textContent=t});let n=[`Lorem ipsum dolor sit amet consectetur`,`Dolor sit amet consectetur elit`,`Eiusmod tempor sed do eiusmod`];e.querySelectorAll(`.ps-gallery-item`).forEach((e,t)=>{let r=n[t];if(!r)return;let i=e.querySelector(`[data-type-gallery-caption]`);if(i){i.textContent=r;return}let a=e.querySelector(`[data-type-gallery-title]`),o=e.querySelector(`[data-type-gallery-meta]`);a&&(a.removeAttribute(`data-type-gallery-title`),a.setAttribute(`data-type-gallery-caption`,``),a.textContent=r,o?.remove())})}t===`read`&&e.querySelectorAll(`[data-type-section-title]`).forEach(e=>{e.textContent.trim()===`Lorem ipsum dolor sit`&&(e.textContent=`Lorem ipsum dolor`)}),t===`experience`&&(e.querySelectorAll(`[data-type-caption]`).forEach(e=>{e.textContent=`Lorem ipsum dolor sit amet,
consectetur adipiscing elit sed do eiusmod tempor.`}),e.querySelectorAll(`.ps-desktop .ps-index-cap`).forEach(e=>{if(e.querySelector(`.ps-index-avatar`))return;let t=document.createElement(`i`);t.className=`ps-index-avatar`,t.setAttribute(`aria-hidden`,`true`),e.insertBefore(t,e.firstChild)}))}function rt(e){for(let t of[Se,Ee,De])t.style.setProperty(`--pt-heading`,He(e.heading.family)),t.style.setProperty(`--pt-body`,He(e.body.family)),t.style.setProperty(`--pt-heading-weight`,e.heading.weight);for(let e of Ce)tt(e);document.querySelector(`[name="font-heading"]`).value=e.heading.family,document.querySelector(`[name="font-body"]`).value=e.body.family,document.querySelector(`[name="font-heading-source"]`).value=e.heading.source||``,document.querySelector(`[name="font-body-source"]`).value=e.body.source||``}var it=[];function at(e,{checked:t=!1,first:n=!1}={}){let r=we.content.firstElementChild.cloneNode(!0),i=r.querySelector(`input`);return i.value=e.id,i.checked=t,i.setAttribute(`aria-label`,`${e.heading.family} for headings with ${e.body.family} for body text. ${e.why}`),r.style.setProperty(`--pair-heading`,He(e.heading.family)),r.style.setProperty(`--pair-body`,He(e.body.family)),r.style.setProperty(`--pair-heading-weight`,e.heading.weight),r.style.setProperty(`--pair-body-weight`,e.body.weight),r.querySelector(`[data-pair-heading]`).textContent=e.heading.family,r.querySelector(`[data-pair-body]`).textContent=e.body.family,r.querySelector(`[data-pair-why]`).textContent=e.why,n?it.unshift(r):it.push(r),j.append(r),r}function ot(e){let t=it.indexOf(e);t!==-1&&it.splice(t,1),e.remove()}function st(e,t){Ae=Qe(e),j.toggleAttribute(`data-fallback`,t),e.pairs.forEach((e,t)=>at(e,{checked:t===0})),et(e.pairs),rt(e.pairs[0]),Mr(),pt()}j.onchange=({target:e})=>{if(!e.matches(`input[name="font-pair"]`))return;let t=Ae.pairs.find(({id:t})=>t===e.value);t&&rt(t)};function ct(e){let t=[...e.closest(`.picker-type-rail, .picker-scale-column`).querySelectorAll(`[data-list-scroll]`)],n=()=>{let n=e.scrollHeight-e.clientHeight;for(let r of t){let t=r.dataset.listScroll===`1`?e.scrollTop>=n-1:e.scrollTop<=1;r.disabled=n<2||t}};for(let n of t)n.onclick=()=>{let t=e.querySelector(`.picker-strategy-option`)?.offsetHeight||Math.round(e.clientHeight*.82);e.scrollBy({top:t*Number(n.dataset.listScroll),behavior:`smooth`})};return e.addEventListener(`scroll`,n,{passive:!0}),new ResizeObserver(n).observe(e),n}var lt=ct(j);ct(Te);function ut(e,t){let n;return()=>{cancelAnimationFrame(n),n=requestAnimationFrame(()=>{e.matches(`:hover`)||t(e.contains(document.activeElement)?document.activeElement:null)})}}var dt;function ft(e){clearTimeout(dt);for(let e of it)e.removeAttribute(`data-hoisted`);e.offsetWidth,e.dataset.hoisted=``,dt=setTimeout(()=>e.removeAttribute(`data-hoisted`),700)}function pt({force:e=!1}={}){let t=j.querySelector(`input[name="font-pair"]:checked`)?.closest(`.picker-type-option`);if(!t)return;let n=[t,...it.filter(e=>e!==t)],r=[...j.querySelectorAll(`.picker-type-option`)],i=n.some((e,t)=>e!==r[t]);if(i){let e=document.activeElement;for(let e of n)j.append(e);j.contains(e)&&document.activeElement!==e&&e.focus({preventScroll:!0})}!i&&!e||(j.scrollTo({top:0}),lt(),i&&ft(t))}var mt=16,ht=13,gt=.5,_t=[...Ee.querySelectorAll(`[data-scale-row]`)],vt=document.querySelector(`[name="type-scale-ratio"]`),yt=()=>Te.querySelector(`input[name="type-scale"]:checked`),bt=e=>e?.closest(`.picker-strategy-option`)?.querySelector(`input`),xt=e=>e.replace(/\.0+$/,``).replace(/(\.\d*[1-9])0+$/,`$1`);function St(){if(Ee.style.setProperty(`--ts-fit`,`1`),!Ee.clientHeight)return;let e=1;for(let t of _t){let n=t.querySelector(`[data-scale-sample]`);e=Math.max(e,n.scrollWidth/Math.max(n.clientWidth,1),n.scrollHeight/Math.max(t.clientHeight,1))}e>1.001&&Ee.style.setProperty(`--ts-fit`,(1/e).toFixed(4))}function Ct(e){let t=Number(e.dataset.ratio),n=e.dataset.scaleName;for(let e of _t){let r=Number(e.dataset.scaleRow),i=mt*t**r,a=(ht*t**(r*gt)).toFixed(3);e.style.setProperty(`--ts-size`,a),De.style.setProperty(`--ts-step-${r}`,a),e.querySelector(`[data-scale-sample]`).textContent=n,e.querySelector(`[data-scale-px]`).textContent=`${Math.round(i)}px`,e.querySelector(`[data-scale-rem]`).textContent=`${xt((i/mt).toFixed(2))}rem`}St()}function wt(e){Ct(e),vt.value=Number(e.dataset.ratio).toFixed(3)}Te.addEventListener(`pointerover`,e=>{let t=bt(e.target);t&&Ct(t)}),Te.addEventListener(`focusin`,e=>{let t=bt(e.target);t&&Ct(t)});var Tt=ut(Te,e=>{Ct(bt(e)??yt())});Te.addEventListener(`pointerleave`,Tt),Te.addEventListener(`focusout`,Tt),Te.onchange=({target:e})=>{e.matches(`input[name="type-scale"]`)&&wt(e)};var Et=ct(De);new ResizeObserver(St).observe(Ee),document.fonts?.addEventListener(`loadingdone`,St),wt(yt());var Dt=document.querySelector(`[data-icon-options]`),Ot=document.querySelector(`[data-icon-sheet]`),kt=Ot.querySelector(`[data-icon-field]`),At=Ot.querySelector(`[data-icon-strip]`),jt=[`name`,`license`,`url`].map(e=>[e,document.querySelector(`[name="icon-pack-${e}"]`)]),Mt,Nt,Pt;ct(Dt);var Ft=()=>Dt.querySelector(`input[name="icon-pack"]:checked`),It=e=>e?.closest(`.picker-icon-row`)?.querySelector(`input`);function Lt(e,t){let n=Object.entries(e.attrs).map(([e,t])=>`${e}="${t}"`).join(` `);return`<svg viewBox="${e.viewBox}" ${n} aria-hidden="true">${t.body}</svg>`}function Rt(e){let t=Mt?.get(e);!t||Pt===e||(Pt=e,delete kt.dataset.empty,kt.innerHTML=t.glyphs.map(e=>`<span class="picker-icon-cell">${Lt(t,e)}</span>`).join(``),At.innerHTML=t.glyphs.map(e=>Lt(t,e)).join(``))}function zt(e){for(let[t,n]of jt)n.value=e.dataset[`pack${t[0].toUpperCase()}${t.slice(1)}`];Rt(e.value)}function Bt(){return Nt??=fetch(`/icon-packs.json`).then(e=>e.ok?e.json():Promise.reject()).then(e=>{Mt=new Map(e.packs.map(e=>[e.id,e])),Rt(Ft().value)}).catch(()=>{kt.dataset.empty=``,kt.textContent=`Icon sets could not be loaded.`}),Nt}Dt.addEventListener(`pointerover`,e=>{let t=It(e.target);t&&Rt(t.value)}),Dt.addEventListener(`focusin`,e=>{let t=It(e.target);t&&Rt(t.value)});var Vt=ut(Dt,e=>{Rt(It(e)?.value??Ft().value)});Dt.addEventListener(`pointerleave`,Vt),Dt.addEventListener(`focusout`,Vt),Dt.onchange=({target:e})=>{e.matches(`input[name="icon-pack"]`)&&zt(e)},zt(Ft());var Ht=document.querySelector(`[data-question="motion"] .picker-strategy-choices`),Ut=`<div class="ps-phone"><div class="ps-phone-top"><div class="ps-nav-lede"><div class="ps-brand-block"></div><i class="ps-brand-word"></i></div><div class="ps-nav-tail"><div class="ps-nav-action"></div><i class="ps-menu"></i></div></div><div class="ps-phone-body"><div class="ps-layout-grid" aria-hidden="true"></div><div class="ps-image"></div><div class="ps-headline"><i></i><i></i></div><div class="ps-copy"><i></i><i></i></div><div class="ps-actions"><i></i><i></i></div><div class="ps-proof"><div class="ps-proof-item"><i></i><span class="ps-proof-lines"><b></b><b></b></span></div><i class="ps-proof-divider" aria-hidden="true"></i><div class="ps-proof-item"><i></i><span class="ps-proof-lines"><b></b><b></b></span></div></div><div class="ps-editorial-copy"><strong></strong><span><i></i><i></i></span></div><div class="ps-gallery"><div class="ps-gallery-item"><i></i><span><b></b><b></b></span></div><div class="ps-gallery-item"><i></i><span><b></b><b></b></span></div></div></div><div class="ps-phone-footer"><i></i><i></i><i></i></div></div>`,Wt=`<span class="picker-preview picker-preview--gallery picker-preview-motion picker-preview-motion--index" aria-hidden="true" data-surface="experience" hidden><span class="pv-desktop"><span class="pv-nav"><span class="pv-logo"></span><span class="pv-nav-bars"><i></i><i></i><i></i></span><span class="pv-pill"></span></span><span class="pg-body"><span class="pg-row"><span class="pv-image"></span><span class="pg-cap"><i class="pg-cap-title" style="--w:33.61%"></i><i></i><i style="--w:65.3%"></i></span></span><span class="pg-row pg-row--flip"><span class="pg-cap"><i class="pg-cap-title" style="--w:36.64%"></i><i></i><i style="--w:66.07%"></i></span><span class="pv-image"></span></span><span class="pg-rail"><i class="pg-arrow"></i><span class="pg-track"><i class="pg-track-on" style="--w: 20.31"></i><i style="--w: 9.14"></i><i style="--w: 8.98"></i><i style="--w: 12.44"></i></span><i class="pg-arrow pg-arrow--next"></i></span></span><i class="ps-cursor" data-cursor aria-hidden="true"></i></span><span class="pv-phone"><span class="pv-phone-top"><span class="pv-logo"></span><span class="pv-avatar"></span></span><span class="pg-phone-body"><span class="pv-image"></span><span class="pg-cap"><i class="pg-cap-title" style="--w:30.18%"></i><i style="--w:79.68%"></i><i style="--w:55.6%"></i></span><span class="pv-image"></span><span class="pg-cap"><i class="pg-cap-title" style="--w:30.18%"></i><i style="--w:79.68%"></i><i style="--w:55.6%"></i></span></span><span class="pv-tabbar"><i></i><i></i><i></i></span></span></span>`;function Gt(){for(let e of document.querySelectorAll(`.picker-preview-motion[data-motion-cell]`)){if(e.dataset.surface===`persuade`){let t=e.querySelector(`.ps-desktop`);if(!t)continue;e.classList.remove(`picker-artboard--solo`),e.classList.add(`picker-strategy-preview`,`picker-preview-layout`),e.setAttribute(`data-carry`,``),t.querySelector(`:scope > .ps-layout-grid`)||t.insertAdjacentHTML(`afterbegin`,`<div class="ps-layout-grid" aria-hidden="true"></div>`),e.querySelector(`:scope > .ps-phone`)||e.insertAdjacentHTML(`beforeend`,Ut),t.querySelector(`:scope > [data-layout-editorial-spacer]`)?.remove();continue}if(e.dataset.surface!==`experience`)continue;let t=document.createElement(`template`);t.innerHTML=Wt;let n=t.content.firstElementChild;if(n){for(let t of e.attributes)t.name!==`class`&&n.setAttribute(t.name,t.value);e.replaceWith(n)}}}Gt();var Kt=[...document.querySelectorAll(`.picker-preview-motion`)],qt=()=>Ht.querySelector(`input:checked`).value,Jt;function Yt(e){if(e!==Jt){Jt=e;for(let e of Kt){for(let t of e.getAnimations({subtree:!0}))t.cancel(),t.play();e.__replayMotion?.()}}}var Xt={"--mtr-nav1":`.ps-nav-bars i:nth-child(1), .pv-nav-bars i:nth-child(1)`,"--mtr-nav2":`.ps-nav-bars i:nth-child(2), .pv-nav-bars i:nth-child(2)`,"--mtr-cta1":`.ps-actions i:first-child`,"--mtr-cta2":`.ps-actions i:last-child`,"--mtr-card1":`.ps-gallery-item:nth-child(1) > i`,"--mxi-work1":`.ps-index-row:nth-of-type(1) > .ps-image, .pg-row:nth-of-type(1) > .pv-image`,"--mxi-work2":`.ps-index-row:nth-of-type(2) > .ps-image, .pg-row:nth-of-type(2) > .pv-image`,"--mxi-rail":`.ps-index-arrow--next, .pg-arrow--next`};function Zt(e=null){for(let t of e?[e]:Kt){let e=t.querySelector(`.ps-desktop, .pv-desktop`);if(!e?.clientWidth)continue;let n=t=>{let n=t.offsetWidth/2,r=t.offsetHeight/2;for(let i=t;i&&i!==e;i=i.offsetParent)n+=i.offsetLeft,r+=i.offsetTop;return{x:n/e.clientWidth*100,y:r/e.clientHeight*100}};for(let[r,i]of Object.entries(Xt)){let a=e.querySelector(i);if(!a)continue;let o=n(a);t.style.setProperty(r,`${o.x.toFixed(2)}cqw ${o.y.toFixed(2)}cqh`)}let r=e.querySelector(`.ps-nav-bars i:nth-child(1), .pv-nav-bars i:nth-child(1)`);r&&t.style.setProperty(`--mtr-entry`,`${n(r).x.toFixed(2)}cqw -8cqh`)}}for(let e of Kt)new ResizeObserver(()=>Zt(e)).observe(e.querySelector(`.ps-desktop, .pv-desktop`));var Qt=e=>e?.closest(`.picker-strategy-option`)?.querySelector(`input`).value;Ht.addEventListener(`pointerover`,e=>{let t=Qt(e.target);t&&Yt(t)}),Ht.addEventListener(`focusin`,e=>{let t=Qt(e.target);t&&Yt(t)});var $t=ut(Ht,e=>{Yt(Qt(e)??qt())});Ht.addEventListener(`pointerleave`,$t),Ht.addEventListener(`focusout`,$t),Ht.addEventListener(`change`,({target:e})=>{e.matches(`input[name="motion-energy"]`)&&Yt(e.value)});function en(e){return{head:document.head,documentElement:document.documentElement,createElement:e=>document.createElement(e),getElementById:e=>document.getElementById(e),querySelector:t=>e.matches(t)?e:e.querySelector(t),querySelectorAll:t=>e.matches(t)?[e]:e.querySelectorAll(t)}}function tn(){let e=[];for(let t of document.querySelectorAll(`.picker-preview-motion[data-motion-cell]`)){let n=en(t),r=window,i=t.dataset.motionCell;e.push({cell:i,board:t,installPerfectCursorLoop:()=>{if(!n?.head||t.hasAttribute(`data-premium-restrained-landing-perfect-loop`))return;t.setAttribute(`data-premium-restrained-landing-perfect-loop`,``);let e=n.createElement(`style`);e.id=`restrained-landing-perfect-loop`,e.textContent=`
...
.imp-paint-nudge-`+u+` { --imp-nudge: `+u+`; }`,u<3&&r.setTimeout(d,700*u))};r.requestAnimationFrame(()=>r.requestAnimationFrame(d))},installEmailCapture:()=>{if(!n?.head||t.hasAttribute(`data-premium-landing-email-capture`))return;t.setAttribute(`data-premium-landing-email-capture`,``);let e=n.createElement(`style`);e.id=`landing-email-capture`,e.textContent=`
        ...
        `,n.getElementById(e.id)||n.head.appendChild(e);let i=n.querySelector(`.picker-preview-motion--index`),a=i?.querySelector(`.pv-desktop .pg-body`),o=i?.querySelector(`.pv-phone .pg-phone-body`);a?.querySelectorAll(`:scope > .pg-rail`).forEach(e=>e.remove()),a&&!a.querySelector(`.pg-row--scroll-one`)&&a.insertAdjacentHTML(`beforeend`,`<span class="pg-row pg-row--more pg-row--scroll-one"><span class="pv-image"></span><span class="pg-cap"><i class="pg-cap-title" style="--w:31.4%"></i><i></i><i style="--w:61.8%"></i></span></span><span class="pg-row pg-row--flip pg-row--more pg-row--scroll-two"><span class="pg-cap"><i class="pg-cap-title" style="--w:38.2%"></i><i></i><i style="--w:59.4%"></i></span><span class="pv-image"></span></span>`),o&&!o.querySelector(`.pg-phone-more-start`)&&o.insertAdjacentHTML(`beforeend`,`<span class="pv-image pg-phone-more pg-phone-more-start"></span><span class="pg-cap pg-phone-more pg-phone-more-copy-one"><i class="pg-cap-title" style="--w:34.2%"></i><i style="--w:74.6%"></i><i style="--w:51.8%"></i></span><span class="pv-image pg-phone-more pg-phone-more-image-two"></span><span class="pg-cap pg-phone-more pg-phone-more-copy-two"><i class="pg-cap-title" style="--w:28.8%"></i><i style="--w:82.4%"></i><i style="--w:58.2%"></i></span>`);let s=[[`.pv-desktop .pg-row:first-child > .pv-image`,`.pv-desktop .pg-row:first-child > .pg-cap`,`.pv-desktop .pg-row:nth-child(2) > .pv-image`,`.pv-desktop .pg-row:nth-child(2) > .pg-cap`],[`.pg-phone-body > .pv-image:nth-child(1)`,`.pg-phone-body > .pg-cap:nth-child(2)`,`.pg-phone-body > .pv-image:nth-child(3)`,`.pg-phone-body > .pg-cap:nth-child(4)`,`.pv-tabbar`]],c=()=>{let e=Math.sqrt(120),t=20/(2*Math.sqrt(120)),n=e*Math.sqrt(1-t**2);return Array.from({length:73},(r,i)=>{let a=i/72,o=1050*a/1e3,s=i===72?0:Math.exp(-t*e*o)*(Math.cos(n*o)+t*e/n*Math.sin(n*o)),c=Math.max(0,Math.min(1,1-s));return{offset:a,opacity:Number(c.toFixed(4)),filter:`blur(${(4*(1-c)).toFixed(3)}px)`,transform:`translateY(${(40*s).toFixed(3)}px)`}})},l={imageFromLeft:[{opacity:.12,filter:`blur(9px)`,clipPath:`inset(0 100% 0 0)`,transform:`translateX(-72px) scale(1.025)`},{opacity:1,filter:`blur(0px)`,clipPath:`inset(0)`,transform:`translateX(0px) scale(1)`}],copyFromRight:[{opacity:0,filter:`blur(5px)`,clipPath:`inset(0 0 0 100%)`,transform:`translateX(44px)`},{opacity:1,filter:`blur(0px)`,clipPath:`inset(0)`,transform:`translateX(0px)`}],imageFromRight:[{opacity:.12,filter:`blur(9px)`,clipPath:`inset(0 0 0 100%)`,transform:`translateX(72px) scale(1.025)`},{opacity:1,filter:`blur(0px)`,clipPath:`inset(0)`,transform:`translateX(0px) scale(1)`}],copyFromLeft:[{opacity:0,filter:`blur(5px)`,clipPath:`inset(0 100% 0 0)`,transform:`translateX(-44px)`},{opacity:1,filter:`blur(0px)`,clipPath:`inset(0)`,transform:`translateX(0px)`}]},u=r.matchMedia(`(prefers-reduced-motion: reduce)`);if(i&&r.Element?.prototype.animate&&!u.matches){let e=[],n=c();for(let t of s)t.map(e=>i.querySelector(e)).filter(Boolean).forEach((t,r)=>{e.push(t.animate(n,{duration:1050,delay:r*100,easing:`linear`,fill:`both`}))});let d=7200,f=e=>e/d,p=(t,n,r)=>{if(!t||!n||!r)return;let i=r.offsetTop-n.offsetTop;i>0&&e.push(t.animate([{offset:0,transform:`translateY(0px)`},{offset:f(1750),transform:`translateY(0px)`,easing:`cubic-bezier(.65, 0, .35, 1)`},{offset:f(2850),transform:`translateY(${-i}px)`},{offset:f(5400),transform:`translateY(${-i}px)`,easing:`cubic-bezier(.65, 0, .35, 1)`},{offset:f(6500),transform:`translateY(0px)`},{offset:1,transform:`translateY(0px)`}],{duration:d,easing:`linear`,fill:`both`}))};p(a,a?.querySelector(`:scope > .pg-row:first-child`),a?.querySelector(`:scope > .pg-row--scroll-one`)),p(o,o?.querySelector(`:scope > .pv-image:first-child`),o?.querySelector(`:scope > .pg-phone-more-start`));for(let[t,n,r]of[[`.pv-desktop .pg-row--scroll-one > .pv-image`,`imageFromLeft`,2020],[`.pv-desktop .pg-row--scroll-one > .pg-cap`,`copyFromRight`,2160],[`.pv-desktop .pg-row--scroll-two > .pv-image`,`imageFromRight`,2400],[`.pv-desktop .pg-row--scroll-two > .pg-cap`,`copyFromLeft`,2540],[`.pv-phone .pg-phone-more-start`,`imageFromLeft`,2020],[`.pv-phone .pg-phone-more-copy-one`,`copyFromRight`,2160],[`.pv-phone .pg-phone-more-image-two`,`imageFromRight`,2400],[`.pv-phone .pg-phone-more-copy-two`,`copyFromLeft`,2540]]){let a=i.querySelector(t);a&&e.push(a.animate(l[n],{duration:n.startsWith(`image`)?720:620,delay:r,easing:`cubic-bezier(.16, 1, .3, 1)`,fill:`both`}))}let m=()=>{if(u.matches){e.forEach(e=>e.cancel());return}e.forEach(e=>{e.pause(),e.currentTime=0,e.play()})};t.__replayMotion=m,u.addEventListener(`change`,({matches:t})=>{t?e.forEach(e=>e.cancel()):m()}),r.addEventListener(`pagehide`,()=>{e.forEach(e=>e.cancel())})}}let a=()=>{for(let e of n.querySelectorAll(`.picker-preview-motion--index`)){let t=e.querySelector(`.pv-desktop`),n=e.querySelector(`.ps-cursor`);if(!t?.clientWidth||!t.clientHeight||!n)continue;let a=t.getBoundingClientRect(),o=r.getComputedStyle(t),s=parseFloat(o.borderLeftWidth)||0,c=parseFloat(o.borderRightWidth)||0,l=parseFloat(o.borderTopWidth)||0,u=parseFloat(o.borderBottomWidth)||0,d=a.width-s-c,f=a.height-l-u,p=r.getComputedStyle(n),m=parseFloat(p.width)||n.offsetWidth,h=parseFloat(p.height)||n.offsetHeight,g=Math.min(m/14,h/20),_=[`restrained`,`responsive`].includes(i.slice(i.indexOf(`-`)+1)),v=g*(_?1:2.2),y=g*(_?1:3.9),b=(n,r)=>{let i=t.querySelector(r);if(!i)return;let o=i.getBoundingClientRect(),c=(o.left+o.width/2-a.left-s-v)/d*100,u=(o.top+o.height/2-a.top-l-y)/f*100;e.style.setProperty(n,c.toFixed(2)+`cqw `+u.toFixed(2)+`cqh`)};b(`--mxi-nav1-tip`,`.pv-nav-bars i:nth-child(1)`),b(`--mxi-work1-tip`,`.pg-row:nth-of-type(1) > .pv-image`),b(`--mxi-work2-tip`,`.pg-row:nth-of-type(2) > .pv-image`),b(`--mxi-rail-tip`,`.pg-arrow--next`),b(`--mxr-modal-close-tip`,`.mxr-modal-close`),b(`--mxv-modal-close-tip`,`.mxv-modal-close`)}};r.requestAnimationFrame(()=>{a(),r.requestAnimationFrame(a)});let o=n.querySelector(`.pv-desktop`);if(o&&r.ResizeObserver){let e=new r.ResizeObserver(a);e.observe(o),t.__portfolioTipObserver=e}}})}let t=t=>{let n=e.map(({board:e})=>[e,e.getAttribute(`style`)]);for(let{board:n}of e)n.style.setProperty(`display`,n===t?`grid`:`none`,`important`);return()=>{for(let[e,t]of n)t===null?e.removeAttribute(`style`):e.setAttribute(`style`,t)}},n=(e,n)=>{let r=t(e.board);try{n()}finally{r()}};for(let t of e)t.cell===`persuade-restrained`&&n(t,t.installPerfectCursorLoop);for(let t of e)t.cell===`persuade-responsive`&&n(t,t.installResponsiveLandingCorrections);for(let t of e)t.cell===`persuade-choreographed`&&n(t,t.installChoreographedPremium);for(let t of e)t.cell.startsWith(`persuade-`)&&n(t,t.installEmailCapture);for(let t of e)t.cell.startsWith(`experience-`)&&n(t,t.installPortfolioFixes)}var nn=!1;function rn(){if(nn)return;let e=document.querySelector(`.picker-screen[data-screen="06"] .picker-board-stage`),t=e?[...e.querySelectorAll(`.picker-preview-motion[data-motion-cell]`)]:[];!t.length||!t.some(e=>e.getBoundingClientRect().width>0)||(nn=!0,tn())}var R=document.querySelector(`[data-font-modal]`),an=R.querySelector(`[data-custom-status]`),on=e=>R.querySelector(`[data-custom-file="${e}"]`),sn=e=>R.querySelector(`[data-custom-url="${e}"]`),cn=R.querySelector(`[data-font-custom-save]`),ln=R.querySelector(`[data-custom-hint]`),un=`
`,dn=new Set([`.woff2`,`.woff`,`.ttf`,`.otf`]),z={heading:[],body:[]};function fn(e){let t=e.lastIndexOf(`.`);return t===-1?``:e.slice(t).toLowerCase()}function pn(e){return dn.has(fn(e.name))}function mn(e,t){let n=new DataTransfer;for(let e of t)n.items.add(e);e.files=n.files}function hn(e,t){return e.name===t.name&&e.size===t.size&&e.lastModified===t.lastModified}function gn(e,t){let n=[...e];for(let e of t)n.some(t=>hn(t,e))||n.push(e);return n}function _n(e){let t=R.querySelector(`[data-custom-file-list="${e}"]`),n=z[e];t.replaceChildren(),t.hidden=n.length===0;for(let r of n){let n=document.createElement(`li`);n.className=`picker-modal-file-item`;let i=document.createElement(`span`);i.textContent=r.name;let a=document.createElement(`button`);a.type=`button`,a.className=`picker-modal-file-remove`,a.setAttribute(`aria-label`,`Remove ${r.name}`),a.textContent=`×`,a.onclick=()=>{z[e]=z[e].filter(e=>!hn(e,r)),mn(on(e),z[e]),_n(e),yn(),an.textContent=``},n.append(i,a),t.append(n)}}var vn=e=>z[e].length>0||sn(e).value.trim()!==``;function yn(){let e=[`heading`,`body`].filter(e=>!vn(e));cn.disabled=e.length>0,ln.textContent=e.length===2?`Heading and body each need a URL or a file.`:e.length===1?`${e[0]===`heading`?`Heading`:`Body`} still needs a URL or a file.`:``}function bn(e){return e?e.includes(un)?e.split(un).filter(Boolean):[e]:[]}document.querySelector(`[data-font-custom-open]`).onclick=()=>{an.textContent=``;for(let e of[`heading`,`body`])z[e]=[],on(e).value=``,mn(on(e),[]),sn(e).value=``,_n(e);yn(),R.showModal()},document.querySelector(`[data-font-custom-close]`).onclick=()=>R.close();for(let e of[`heading`,`body`])on(e).onchange=({target:t})=>{let n=[...t.files].filter(pn);an.textContent=n.length===t.files.length?``:`Only .woff2, .woff, .ttf, and .otf files are accepted.`,z[e]=gn(z[e],n),mn(t,z[e]),t.value=``,_n(e),yn()},sn(e).oninput=yn;async function xn(e){let t=await fetch(`/font-upload`,{method:`POST`,headers:{"X-Font-Filename":e.name,"Content-Type":`application/octet-stream`},body:e}),n=await t.json();if(!t.ok)throw Error(n.error||`Upload failed`);return n.path}async function Sn(e){let t=z[e].filter(pn);if(t.length){let e=await Promise.all(t.map(e=>xn(e)));return{family:t[0].name.replace(/\.[^.]+$/,``),source:e.join(un)}}let n=sn(e).value.trim();return n?{family:n.split(`/`).pop().replace(/\.[^.]+$/,``)||`Custom`,source:n}:null}cn.onclick=async()=>{an.textContent=`Saving…`;let e,t;try{[e,t]=await Promise.all([Sn(`heading`),Sn(`body`)])}catch(e){an.textContent=e.message;return}if(!e||!t){an.textContent=`Add a URL or a file for both the heading and the body.`;return}let n={id:`custom`,name:`Custom`,heading:e,body:t,why:`Your own faces`};Ae.pairs=[n,...Ae.pairs.filter(({id:e})=>e!==`custom`)];for(let e of[...it])e.querySelector(`input`).value===`custom`&&ot(e);at(n,{checked:!0,first:!0}),Cn(n),rt(n),pt({force:!0}),R.close()};function Cn({heading:e,body:t}){for(let n of[e,t])if(n?.source){if(/\.(css)(\?|$)/i.test(n.source)||!n.source.includes(un)&&!/\.(woff2?|ttf|otf)(\?|$)/i.test(n.source)){let e=document.createElement(`link`);e.rel=`stylesheet`,e.href=n.source,document.head.append(e);continue}for(let e of bn(n.source)){let t=e.startsWith(`http`)?e:`/fonts/${e.split(`/`).pop()}`;document.fonts.add(new FontFace(n.family,`url(${t})`))}document.fonts.load(`16px "${n.family}"`)}}function wn(e){ye.textContent!==ye.dataset[e]&&(ye.classList.add(`is-changing`),setTimeout(()=>{ye.textContent=ye.dataset[e],ye.classList.remove(`is-changing`)},90))}var Tn=D(`[data-contrast-alert]`,k),En=D(`[data-contrast-tip]`,k);function Dn(e,t,n){e.hidden=n.length===0,t.replaceChildren(...n.map(e=>{let t=document.createElement(`span`);return t.textContent=e,t}))}function On(){Dn(Tn,En,N.length?x(I().colors):[])}function kn(e,t,n=!0){let r=I();r.colors[e]=t.toUpperCase(),r.detached[e]=n,Je(e),Ke(F()),wn(e)}function An(e,t,n,r,i){let a=M.get(t.id),o=We(n),s=e.dataset.role;r=Math.min(100,Math.max(0,r)),i=Math.min(100,Math.max(0,i));let c=o.getContext(`2d`).getImageData(Math.round(r/100*(o.width-1)),Math.round(i/100*(o.height-1)),1,1).data,l=`#${[c[0],c[1],c[2]].map(e=>e.toString(16).padStart(2,`0`)).join(``).toUpperCase()}`;a.rings[s]=[r,i],a.colors[s]=l,a.detached[s]=!1,Ke(t),t===F()&&Je(s),wn(s),qe(e,t,n)}function jn(e,t,n){let r=r=>{let i=n.getBoundingClientRect();An(e,t,n,(r.clientX-i.left)/i.width*100,(r.clientY-i.top)/i.height*100)};e.onpointerdown=t=>{t.button===0&&(e.focus(),e.setPointerCapture(t.pointerId),e.dataset.dragging=``,r(t))},e.onpointermove=t=>{e.hasPointerCapture(t.pointerId)&&(Be(),r(t))},e.onpointerup=t=>{r(t),e.releasePointerCapture(t.pointerId),delete e.dataset.dragging,document.activeElement!==e&&delete A.dataset.visible},e.onfocus=()=>n.complete&&qe(e,t,n),e.onblur=()=>{`dragging`in e.dataset||delete A.dataset.visible},e.onkeydown=r=>{let i={ArrowLeft:[-1,0],ArrowRight:[1,0],ArrowUp:[0,-1],ArrowDown:[0,1]};if(!i[r.key])return;r.preventDefault(),Be();let a=r.shiftKey?5:1,[o,s]=M.get(t.id).rings[e.dataset.role];An(e,t,n,o+i[r.key][0]*a,s+i[r.key][1]*a)};let i=(r,i)=>{let a=e.parentElement.querySelector(`.picker-ring-axis--${r}[data-role="${e.dataset.role}"]`);a&&(a.onfocus=()=>n.complete&&qe(e,t,n),a.onblur=()=>delete A.dataset.visible,a.onkeydown=a=>{if(!(a.key in i))return;a.preventDefault(),Be();let o=a.shiftKey?5:1,[s,c]=M.get(t.id).rings[e.dataset.role],l=i[a.key]*o;An(e,t,n,r===`x`?s+l:s,r===`y`?c+l:c)})};i(`x`,{ArrowLeft:-1,ArrowRight:1}),i(`y`,{ArrowUp:-1,ArrowDown:1})}function Mn(e){let t=D(`[data-${e.type}-card]`).content.firstElementChild.cloneNode(!0);t.dataset.id=e.id;let n=D(`.picker-card-face`,t);if(e.type===`seed`)he(`span`,n).forEach((t,n)=>{t.style.setProperty(`--seed-color`,M.get(e.id).colors[E[n]])});else{let t=D(`img`,n);t.alt=`Visual cue ${e.id}`,t.src=`/cues/${encodeURIComponent(e.id)}.png`,he(`.picker-ring`,n).forEach(r=>{let i=r.dataset.role,[a,o]=M.get(e.id).rings[i];Ge(n,i,a,o,M.get(e.id).colors[i]),jn(r,e,t)}),t.addEventListener(`load`,()=>{e.defaultRings=ze(n=>{let[r,i]=e.palette[n].at;return[r/t.naturalWidth*100,i/t.naturalHeight*100]}),M.get(e.id).rings=structuredClone(e.defaultRings),Ke(e),e===F()&&We(t)})}return e.node=t,t}function Nn(){if(!ke)return;let e=ke,t=D(`[data-band-item="${e}"]`,k),n=D(`[data-tints]`,t),r=n.contains(document.activeElement);delete t.dataset.tintOpen,n.hidden=!0,ke=null;let i=D(`[data-edit-tints="${e}"]`,k);i.setAttribute(`aria-expanded`,`false`),i.dataset.tip=`Edit tints`,r&&i.focus()}function Pn(){let e=F();N.forEach(({node:e},t)=>{let n=t-P;e.dataset.pos=Math.max(-2,Math.min(2,n)),e.classList.toggle(`is-far`,Math.abs(n)>2),e.setAttribute(`aria-hidden`,n!==0)}),D(`[data-deck-prev]`).disabled=P===0,D(`[data-deck-next]`).disabled=P===N.length-1,ve.textContent=`${P+1} / ${N.length}`;for(let e of E)Je(e);if(Ke(e),e.type===`cue`){let t=D(`img`,e.node);t.complete&&t.naturalWidth&&We(t)}Nn()}function Fn(e){let t=Math.min(N.length-1,Math.max(0,e)),n=matchMedia(`(prefers-reduced-motion: reduce)`).matches?`auto`:`smooth`;_e.children[t].scrollIntoView({behavior:n,block:`start`})}function In(e){if(e.key===`Escape`&&ke){e.preventDefault(),Nn();return}let t={ArrowLeft:-1,ArrowRight:1}[e.key];t&&(e.target instanceof Element&&e.target.closest(`.picker-ring, [role="slider"], input`)||B?.keyboard||(e.preventDefault(),Fn(P+t)))}var Ln=e=>document[e?`addEventListener`:`removeEventListener`](`keydown`,In,!0);function Rn(e){Nn(),ke=e,wn(e);let t=D(`[data-band-item="${e}"]`,k),n=D(`[data-tints]`,t),r=I().colors[e],[i,a,o]=c(r);he(`[data-tint]`,n).forEach((e,t)=>{let n=t-3,c=n<0?i+(.96-i)*(-n/3):i-(i-.16)*(n/3),l=n===0?r:s([c,a*(1-Math.abs(n)/3*.3),o]);e.dataset.tint=l,e.style.setProperty(`--tint-color`,l),e.setAttribute(`aria-label`,l),e.toggleAttribute(`data-current`,n===0)}),n.hidden=!1,t.dataset.tintOpen=``;let l=D(`[data-edit-tints="${e}"]`,k);l.setAttribute(`aria-expanded`,`true`),l.dataset.tip=`Close tints`,D(`button`,n)?.focus()}var zn=220,Bn=1.02,Vn=getComputedStyle(document.documentElement).getPropertyValue(`--ks-ease`).trim()||`ease`,Hn=new Set([` `,`Enter`,`ArrowLeft`,`ArrowRight`,`Home`,`End`,`Escape`]),Un=new WeakMap,Wn=D(`.picker-bands`,k),Gn=document.querySelector(`[data-band-scope="strategy"]`),Kn=document.querySelector(`.picker-screen[data-screen="03"] .picker-strategy-grid`),qn=()=>matchMedia(`(prefers-reduced-motion: reduce)`).matches,Jn=e=>E.map(t=>D(`[data-band="${t}"]`,e)),Yn=e=>E.map(t=>D(`[data-grip="${t}"]`,e)),Xn=(e,t)=>D(`[data-band-item="${E[e]}"] .picker-band-foot h2`,t).textContent,Zn=(e,t)=>{let n=D(`[data-reorder-status]`,e.closest(`.picker-screen`)??e);n&&(n.textContent=t)},B=null,Qn=null;function $n(e,t){let n=E.map((e,t)=>t);return n.splice(t,0,...n.splice(e,1)),n}function er(e,t,n,r){e.style.transform=n?`translateX(${n}px)`:``,Un.get(e)?.cancel(),r&&Un.set(e,e.animate([{transform:`translateX(${t}px)`},{transform:`translateX(${n}px)`}],{duration:zn,easing:Vn}))}function tr(e,t){let n=B.nodes[B.from],r=B.offsets[B.from],i=e=>`translateX(${e}px) scale(${Bn})`;B.offsets[B.from]=e,n.style.transform=i(e),Un.get(n)?.cancel(),t&&Un.set(n,n.animate([{transform:i(r)},{transform:i(e)}],{duration:zn,easing:Vn}))}function nr(e,t){$n(B.from,e).forEach((e,n)=>{if(e===B.from)return;let r=B.homes[n].left-B.homes[e].left;r!==B.offsets[e]&&(er(B.nodes[e],B.offsets[e],r,t),B.offsets[e]=r)}),B.to=e}function rr(e){let{homes:t,from:n}=B,r=t[n].left+t[n].width/2+e,i=e=>Math.abs(t[e].left+t[e].width/2-r);return t.reduce((e,t,n)=>i(n)<i(e)?n:e,0)}function ir(e,t,n){let r=I(),i={},a={},o={};$n(e,t).forEach((e,t)=>{let n=E[t],s=E[e];i[n]=r.colors[s],a[n]=r.detached[s],o[n]=r.rings[s]}),Object.assign(r,{colors:i,detached:a,rings:o}),Pn(),n!==Wn&&ar()}function ar(){if(D(`[name="palette-source"]`).value){for(let e of E)D(`[name="palette-${e}"]`).value=I().colors[e];cr(),Nr();for(let e of document.querySelectorAll(`.picker-screen[data-active] [data-artboard]`))Xe(e)}}var or=D(`[data-contrast-alert]`,Gn),sr=D(`[data-contrast-tip]`,Gn);function cr(){let e=ze(e=>D(`[name="palette-${e}"]`).value);if(!Object.values(e).some(e=>!e)){for(let t of E){let n=D(`[data-band="${t}"]`,Gn);n.style.setProperty(`--band-color`,e[t]),n.style.setProperty(`--band-ink`,p(e[t])),D(`output`,n).textContent=e[t]}Dn(or,sr,x(e))}}function lr(){let e=Kn?.parentElement;if(!e||!e.offsetParent)return;let t=`${Math.ceil(e.getBoundingClientRect().height-Kn.getBoundingClientRect().height)}px`;e.style.getPropertyValue(`--pk-chrome`)!==t&&e.style.setProperty(`--pk-chrome`,t)}Kn&&new ResizeObserver(lr).observe(Kn.parentElement);function ur(e,t){let{colors:n}=I();return $n(e,t).map((e,t)=>`${E[t]} ${n[E[e]]}`).join(`, `)}function dr(e,t,n){B&&fr(!0),Qn?.(),Nn();let r=Jn(n);for(let e of r)Un.get(e)?.cancel(),e.style.transform=``;B={from:e,to:e,keyboard:t,scope:n,nodes:r,grips:Yn(n),homes:r.map(e=>e.getBoundingClientRect()),offsets:E.map(()=>0),id:F().id,pointerId:null,startX:0},r[e].dataset.dragging=``,B.grips[e].dataset.dragging=``,tr(0,!1)}function fr(e,t){let{nodes:n,grips:r,from:i,to:a,homes:o,id:s,scope:c}=B,l=e?0:o[a].left-o[i].left;if(e&&nr(i,!qn()),B=null,delete n[i].dataset.dragging,delete r[i].dataset.dragging,Qn=()=>{Qn=null,!e&&a!==i&&F().id===s&&ir(i,a,c);for(let e of n)Un.get(e)?.cancel(),e.style.transform=``;t?.()},qn()){Qn();return}let u=n[i],d=u.style.transform,f=`translateX(${l}px) scale(1)`;u.style.transform=f;let p=u.animate([{transform:d},{transform:f}],{duration:zn,easing:Vn});Un.set(u,p),p.finished.then(()=>Qn?.(),()=>{})}function pr(e){let{from:t,to:n,scope:r}=B;if(n===t){fr(!0);return}let i=`Palette reordered. ${ur(t,n)}`;fr(!1,e?()=>Yn(r)[n].focus():null),Zn(r,i)}var mr=e=>e instanceof Element?e.closest(`[data-grip]`):null,hr=e=>e.closest(`.picker-bands`);function gr(e){e.addEventListener(`pointerdown`,e=>{let t=mr(e.target);!t||e.button!==0||!N.length||(e.preventDefault(),dr(E.indexOf(t.dataset.grip),!1,hr(t)),B.pointerId=e.pointerId,B.startX=e.clientX,t.setPointerCapture(e.pointerId))}),e.addEventListener(`pointermove`,e=>{if(!B||B.keyboard||e.pointerId!==B.pointerId)return;let{homes:t,from:n}=B,r=Math.min(t.at(-1).left-t[n].left,Math.max(t[0].left-t[n].left,e.clientX-B.startX));tr(r,!1);let i=rr(r);i!==B.to&&nr(i,!qn())}),e.addEventListener(`pointerup`,e=>{!B||B.keyboard||e.pointerId!==B.pointerId||pr(!1)}),e.addEventListener(`pointercancel`,e=>{!B||B.keyboard||e.pointerId!==B.pointerId||fr(!0)}),e.addEventListener(`keydown`,e=>{let t=mr(e.target);if(!t||!Hn.has(e.key)||!N.length)return;let n=hr(t),r=!!B?.keyboard,i=e.key===` `||e.key===`Enter`;if(!r&&(B||!i))return;if(e.preventDefault(),!r){dr(E.indexOf(t.dataset.grip),!0,n),Zn(n,`${Xn(B.from,n)} color lifted, position ${B.from+1} of ${E.length}. Arrow keys move it, space drops it, escape puts it back.`);return}if(i){pr(!0);return}if(e.key===`Escape`){fr(!0),Zn(n,`Reorder cancelled.`);return}let a={ArrowLeft:-1,ArrowRight:1,Home:-E.length,End:E.length}[e.key],o=Math.min(E.length-1,Math.max(0,B.to+a));o!==B.to&&(nr(o,!qn()),tr(B.homes[o].left-B.homes[B.from].left,!qn()),Zn(n,`Position ${o+1} of ${E.length}.`))}),e.addEventListener(`focusout`,e=>{if(!B?.keyboard||e.target!==B.grips[B.from])return;let t=B.scope;fr(!0),Zn(t,`Reorder cancelled.`)})}gr(k),gr(Gn),k.onpointerover=k.onfocusin=({target:e})=>{let t=e.closest(`[data-band]`);t&&wn(t.dataset.band)},k.oninput=({target:e})=>{e.matches(`[data-color-input]`)&&kn(e.dataset.colorInput,e.value)},k.onclick=async e=>{let t=e.target.closest(`button`)?.dataset;if(t){if(t.copyColor){let e=I().colors[t.copyColor];await navigator.clipboard.writeText(`${e}\n${l(e)}`);let n=t.tip;t.tip=`Copied`,setTimeout(()=>t.tip=n,1200)}else if(t.editTints)ke===t.editTints?Nn():Rn(t.editTints);else if(t.customColor)D(`[data-color-input="${t.customColor}"]`,k).click();else if(t.tint)kn(ke,t.tint);else if(`closeTints`in t)Nn();else if(`reset`in t){let e=F(),t=Ue(e);e.type===`cue`&&e.defaultRings&&(t.rings=structuredClone(e.defaultRings)),M.set(e.id,t),Pn()}else if(`selectPalette`in t){let e=F();D(`[name="palette-source"]`).value=e.id;for(let e of E)D(`[name="palette-${e}"]`).value=I().colors[e];cr(),Nr()}}},D(`[data-select-palette]`).addEventListener(`click`,k.onclick),D(`[data-deck-prev]`).onclick=()=>Fn(P-1),D(`[data-deck-next]`).onclick=()=>Fn(P+1);function _r(){let e=_e.firstElementChild?.offsetHeight||0;if(!e)return!1;let t=P*e;return Math.abs(ge.scrollTop-t)>1&&(ge.scrollTop=t),!0}ge.addEventListener(`scroll`,()=>{let e=_e.firstElementChild?.offsetHeight||1,t=Math.min(N.length-1,Math.round(ge.scrollTop/e));if(t!==P){let e=F().node;e.dataset.exit=t>P?`left`:`right`,setTimeout(()=>delete e.dataset.exit,280),P=t,delete F().node.dataset.exit,Pn()}},{passive:!0}),document.addEventListener(`picker:screenchange`,e=>{Ln(e.detail.screen===`02`),e.detail.screen===`02`&&_r(),e.detail.screen===`04b`&&Jr();let t=document.querySelector(`.picker-screen[data-screen="${e.detail.screen}"]`);for(let e of t?.querySelectorAll(`[data-artboard]`)??[])Xe(e);e.detail.screen===`03`&&(cr(),lr());let n=Ar.find(t=>t.screen===e.detail.screen);if(n?.paint(),jr(n),e.detail.screen===`04`&&pt({force:!0}),e.detail.screen===`06`&&requestAnimationFrame(()=>{rn(),Zt(),Jt=null,Yt(qt())}),e.detail.screen===`05`){St();let e=yt();requestAnimationFrame(()=>{e?.parentElement.scrollIntoView({block:`center`}),e?.focus({preventScroll:!0}),e&&Ct(e),Et()})}e.detail.screen===`11`&&(Bt(),requestAnimationFrame(()=>{Ft()?.parentElement.scrollIntoView({block:`center`})}))});var V=[...document.querySelectorAll(`input[name="surface-modes"]`)],vr=document.querySelector(`[data-modes-next]`),yr=()=>{vr&&(vr.disabled=!V.some(e=>e.checked))},br=V.map(e=>e.closest(`.picker-mode-tile`)),xr=br.map(e=>e?.querySelector(`.picker-preview`)),Sr=xe.cloneNode(!0),Cr;function wr(){Mr();let e=V.findIndex(e=>e.checked);br.forEach((t,n)=>{t?.toggleAttribute(`data-lead`,n===e&&!!xr[n])});let t=(e===-1?null:xr[e])??Sr;if(t===Cr)return;Cr=t;let n=t.cloneNode(!0);n.setAttribute(`aria-hidden`,`true`);for(let e of[n,...n.querySelectorAll(`[id]`)])e.removeAttribute(`id`);xe.replaceWith(n),xe=n,Ye()}var Tr=()=>V.filter(e=>e.checked),Er=e=>V.find(t=>t.value===e),Dr=document.querySelector(`input[name="_chosen"]`);function Or(){if(!Dr)return;let e=[...document.querySelectorAll(`input[type="hidden"][data-surface-field][data-chosen="yes"]`)].filter(e=>!e.disabled).map(e=>e.dataset.surfaceField);Dr.value=JSON.stringify(e)}function kr(e){let t=e.dataset.surfaceTabs,n=e.parentElement,r=e.closest(`.picker-screen`)?.dataset.screen,i=`surfaceStage`in n.dataset,a=`surfaceFlat`in e.dataset,o=`surfaceProperName`in e.dataset,s=()=>[...document.querySelectorAll(`input[name="${t}"]`)],c=e=>s().find(t=>t.value===e)?.closest(`.picker-strategy-option`),l=e=>{let n=Er(e)?.getAttribute(`data-allow-${t}`);return n==null?null:new Set(n.split(` `).filter(Boolean))},u=e=>Er(e)?.getAttribute(`data-default-${t}`)||s()[0]?.value,d=e=>document.querySelector(`input[type="hidden"][data-surface-field="${t}-${e}"]`),f=e=>c(e)?.querySelector(`.picker-strategy-title`)?.textContent??e,p=e=>!!d(e),m=()=>Tr().filter(e=>p(e.value)),h=V.some(e=>!p(e.value)),g=e.closest(`.picker-screen`),_=null;function v(e){for(let e of n.querySelectorAll(`[data-surface]:not([data-artboard])`))e.remove();for(let t of e){if(n.querySelector(`[data-artboard][data-surface="${t.value}"]`))continue;let e=xr[V.indexOf(t)];if(!e)continue;let r=e.cloneNode(!0);r.setAttribute(`aria-hidden`,`true`);for(let e of[r,...r.querySelectorAll(`[id]`)])e.removeAttribute(`id`);r.dataset.surface=t.value,n.append(r)}y()}function y(){i&&Xe(n,`pkc`)}function b(){let e=m();if(h){g?.toggleAttribute(`data-skip`,e.length===0);for(let t of s())t.disabled=e.length===0}i&&v(e);for(let e of V){let t=d(e.value);t&&(t.disabled=!e.checked,e.checked?t.value||=u(e.value)??``:(t.value=``,delete t.dataset.chosen))}ee(e),te(e.some(e=>e.value===_)?_:e[0]?.value)}function ee(t){e.hidden=t.length<2,e.replaceChildren(...t.map(e=>{let t=document.createElement(`button`);return t.type=`button`,t.className=`picker-surface-tab`,t.dataset.surfaceTab=e.value,t.innerHTML=`<span class="picker-surface-dot"></span>`,t.append(e.dataset.surfaceLabel??e.value),t.onclick=()=>ne(e.value),t})),x()}function x(){for(let t of e.children){let n=t.dataset.surfaceTab,r=d(n),i=!!r?.dataset.chosen,a=n===_,s=r.value?f(r.value):``,c=t.textContent;t.dataset.set=i?`yes`:`no`,t.setAttribute(`aria-pressed`,a?`true`:`false`),t.tabIndex=a?0:-1;let l=s&&e.dataset.surfaceAnswered.replace(`{}`,o?s:s.toLowerCase());t.setAttribute(`aria-label`,s?`${c}, ${l}${i?``:` by default`}`:`${c}, ${e.dataset.surfaceUnanswered}`)}}function te(e){if(!e)return;_=e;for(let t of n.querySelectorAll(`[data-surface]`))t.hidden=t.dataset.surface!==e;re();let t=d(e)?.value||u(e),r=s().find(e=>e.value===t);r&&(r.checked=!0),x()}function ne(e){te(e),jr(ae)}function re(){let e=l(_);for(let t of s()){let n=t.closest(`.picker-strategy-option`);if(!n)continue;let r=!e||e.has(t.value),i=n.querySelector(`.picker-strategy-desc`);i.dataset.copy??=i.textContent,i.textContent=r?i.dataset.copy:n.dataset.blockedReason??i.dataset.copy,n.classList.toggle(`is-blocked`,!r),t.disabled=!r}}document.addEventListener(`change`,({target:e})=>{e?.name!==t||!e.checked||ie(e.value)});function ie(e){let t=a?m().map(e=>e.value):[_];for(let n of t){let t=d(n),r=l(n);!t||r&&!r.has(e)||(t.value=e,t.dataset.chosen=`yes`)}x(),Or()}e.addEventListener(`keydown`,t=>{let n={ArrowLeft:-1,ArrowRight:1}[t.key];if(!n)return;let r=[...e.children],i=r[(r.findIndex(e=>e.dataset.surfaceTab===_)+n+r.length)%r.length];t.preventDefault(),ne(i.dataset.surfaceTab),i.focus()});let ae={screen:r,sync:b,paint:y,park:e=>te(p(e)?e:m()[0]?.value),active:()=>_};return ae}var Ar=[...document.querySelectorAll(`[data-surface-tabs]`)].map(kr);function jr(e){for(let t of Ar)t!==e&&t.park(e?.active())}var Mr=()=>{for(let e of Ar)e.sync();Or()},Nr=()=>{for(let e of Ar)e.paint()},Pr=document.querySelector(`.picker-screen[data-screen="04b"]`),Fr={"06":`motion-energy`,"08":`boundary-style`,"09":`corner-style`,10:`depth-style`,11:`icon-pack`},Ir=e=>V.find(t=>t.value===e)?.dataset.surfaceLabel??e;function Lr(e,t){let n=document.querySelector(`input[name="${e}"][value="${t}"]`);return n?n.dataset.scaleName?`${n.dataset.scaleName} · ${n.dataset.ratio}`:n.dataset.packName?n.dataset.packName:n.closest(`.picker-strategy-option`)?.querySelector(`.picker-strategy-title`)?.textContent.trim()??t:t}function Rr(e){return[...document.querySelectorAll(`input[type="hidden"][data-surface-field^="${e}-"]`)].filter(e=>!e.disabled&&e.value).map(t=>({mode:t.dataset.surfaceField.slice(e.length+1),value:t.value,chosen:t.dataset.chosen===`yes`}))}function zr(e){let t=document.createElement(`span`);return t.className=`picker-hub-line`,t.append(e),t}function Br(e,t){let n=document.querySelector(`input[name="${e}"][value="${t}"]`)?.closest(`.picker-strategy-option`)?.querySelector(`.picker-strategy-desc`);return n?(n.dataset.copy??n.textContent).trim():``}var Vr={strategy:`color-strategy`,boundary:`boundary-style`,corner:`corner-style`,depth:`depth-style`,layout:`layout-structure`};function Hr(e){let t={surface:e};for(let[n,r]of Object.entries(Vr))t[n]=document.querySelector(`input[type="hidden"][data-surface-field="${r}-${e}"]`)?.value||document.querySelector(`input[name="${r}"]:checked`)?.value||``;return t}function Ur(e,t=null){let n=document.createElement(`span`);if(n.className=`picker-hub-proof`,t){n.classList.add(`dcx-proof--board`);for(let[e,r]of Object.entries(t))r&&n.setAttribute(`data-dcx-${e}`,r);Xe(n,`pkc`)}let r=e.cloneNode(!0);r.hidden=!1,r.removeAttribute(`data-surface`);for(let e of[r,...r.querySelectorAll(`[id]`)])e.removeAttribute(`id`);for(let e of[r,...r.querySelectorAll(`[data-icon-field], [data-icon-strip]`)])e.removeAttribute(`data-icon-sheet`),e.removeAttribute(`data-icon-field`),e.removeAttribute(`data-icon-strip`);return n.append(r),n}var Wr=(e,t)=>{let n=[...document.querySelectorAll(`.picker-screen[data-screen="${e}"] .picker-board-stage > :is(.picker-artboard, .picker-preview)[data-surface="${t}"]`)];if(n.length<2)return n[0]??null;let r=document.querySelector(`.picker-screen[data-screen="${e}"] [data-surface-tabs]`)?.dataset.surfaceTabs,i=r&&document.querySelector(`input[type="hidden"][data-surface-field="${r}-${t}"]`)?.value;return n.find(e=>e.dataset.motionCell===`${t}-${i}`)??n[0]};function Gr(e){let t=e.querySelector(`[data-hub-preview]`);if(!t||t.classList.contains(`picker-hub-preview--icons`))return;let n=t.firstElementChild,r=n?.querySelector(`.ps-desktop, .pv-desktop`)??n?.firstElementChild,i=t.clientWidth,a=t.clientHeight;if(!i||!a||!r?.offsetWidth||!r.offsetHeight)return;let o=Math.min(i/r.offsetWidth,a/r.offsetHeight);e.style.setProperty(`--pk-hub-scale`,o),e.style.setProperty(`--pk-hub-x`,`${(i-r.offsetWidth*o)/2}px`),e.style.setProperty(`--pk-hub-y`,`${(a-r.offsetHeight*o)/2}px`)}function Kr(e,t,n,r){let i=e.querySelector(`[data-hub-preview]`);if(i.classList.toggle(`picker-hub-preview--icons`,n===`icon-pack`),n===`icon-pack`){i.replaceChildren(Ur(At)),!kt.querySelector(`.picker-icon-cell`)&&!(`empty`in kt.dataset)&&Bt().then(Jr);return}let a=r?Wr(t,r):null;if(!a){i.replaceChildren();return}if(n===`motion-energy`){Ar.find(e=>e.screen===t)?.park(r);let n=Ur(a);Xe(n.firstChild),i.replaceChildren(n),requestAnimationFrame(()=>{Zt(n.firstChild),Gr(e)})}else i.replaceChildren(Ur(a,Hr(r)));Gr(e)}function qr(e){let t=e.querySelector(`[data-hub-target]`),n=t?.dataset.hubTarget,r=Fr[n];if(!r)return;let i=e.querySelector(`[data-hub-preview]`),a=e.querySelector(`[data-hub-note]`),o=e.querySelector(`[data-hub-slider]`),s=e.querySelector(`[data-hub-slider-label]`),c=!!document.querySelector(`.picker-screen[data-screen="${n}"]`)?.hasAttribute(`data-skip`);if(e.classList.toggle(`is-skipped`,c),t.disabled=c,t.setAttribute(`aria-disabled`,c?`true`:`false`),c){i.replaceChildren(),a.replaceChildren(zr(`Not asked of these surfaces`)),a.hidden=!1,o.hidden=!0;return}let l=Rr(r),u=l.map(e=>e.mode),d=u.includes(e.dataset.hubSurface)?e.dataset.hubSurface:u[0];e.dataset.hubSurface=d??``;let f=d?l.find(e=>e.mode===d)?.value:document.querySelector(`input[name="${r}"]:checked`)?.value,p=f?Br(r,f):``;a.textContent=p,a.hidden=!p;let m=document.createElement(`span`);m.className=`picker-hub-slider-value`,m.textContent=f?Lr(r,f):``,s.replaceChildren(...d?[`${Ir(d)} · `,m]:[m]),o.hidden=!1;for(let e of o.querySelectorAll(`[data-hub-step]`))e.hidden=u.length<2;Kr(e,n,r,d)}function Jr(){if(Pr)for(let e of Pr.querySelectorAll(`.picker-hub-card`))qr(e)}function Yr(e,t){let n=Fr[(e?.querySelector(`[data-hub-target]`))?.dataset.hubTarget];if(!n)return;let r=Rr(n).map(e=>e.mode);if(r.length<2)return;let i=r.indexOf(e.dataset.hubSurface);e.dataset.hubSurface=r[(i+t+r.length)%r.length],qr(e)}Pr?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-hub-step]`);if(t){Yr(t.closest(`.picker-hub-card`),Number(t.dataset.hubStep));return}let n=e.target.closest(`[data-hub-target]`);!n||n.disabled||document.dispatchEvent(new CustomEvent(`picker:goto`,{detail:{screen:n.dataset.hubTarget}}))}),Pr?.addEventListener(`keydown`,e=>{let t={ArrowLeft:-1,ArrowRight:1}[e.key];!t||!e.target.closest(`[data-hub-slider]`)||(e.preventDefault(),Yr(e.target.closest(`.picker-hub-card`),t))}),Pr&&window.ResizeObserver&&new ResizeObserver(()=>{for(let e of Pr.querySelectorAll(`.picker-hub-card`))Gr(e)}).observe(Pr);for(let e of V)e.addEventListener(`change`,()=>{yr(),wr()});yr(),wr();try{let e=e=>fetch(e).then(e=>e.ok?e.json():Promise.reject()),[t,n,r]=await Promise.all([e(`/cues.json`),e(`/palettes.json`),fetch(`/context.json`).then(e=>e.ok?e.json():null).catch(()=>null)]),i=Array.isArray(r?.modes)?r.modes:t.modes;if(Array.isArray(i)){let e=new Set(i);if(V.some(t=>e.has(t.value))){for(let t of V)t.checked=e.has(t.value);yr(),wr()}}N=[...t.cues.map(e=>({id:e,type:`cue`,palette:t.palette[e]})),...n.seeds.map(e=>({...e,type:`seed`}))];for(let e of N)M.set(e.id,Ue(e));O.append(...N.map(Mn)),_e.innerHTML=`<div class="picker-snap-point"></div>`.repeat(N.length),D(`[data-select-palette]`).disabled=!1,Pn(),Ln(me.hasAttribute(`data-active`))}catch{ve.textContent=`Palette sources could not be loaded.`}var Xr=Re,Zr=!0;try{let e=await fetch(`/fonts.json`),t=e.ok?await e.json():null;$e(t)&&(Xr=Qe(t),Zr=!1)}catch{}st(Xr,Zr);var Qr=await ne();try{le(Qr.prior,{modeInputs:V,syncModes:()=>{yr(),wr()},states:M,cards:N,setCurrent:e=>{P=e},render:Pn,syncDeckScroll:_r,fontManifest:()=>Ae,pairNodes:()=>[...it],addPairCard:at,removePairCard:ot,loadCustomFace:Cn,syncFontPair:rt,applyHoist:pt,syncChosenField:Or})}catch{}ae(Qr.prior?Qr.priorSource:null);var H=(e,t=document)=>t.querySelector(e),$r=(e,t=document)=>[...t.querySelectorAll(e)],U=H(`#picker-form`),ei=H(`[data-dcx-shell]`),ti=null,ni=null,ri=null,ii=null,ai=e=>fetch(e).then(e=>e.ok?e.json():null).catch(()=>null),oi=ai(`/cues.json`).then(e=>(ri=e?.palette||null,ii=Array.isArray(e?.cues)?e.cues:null,e)),si=Promise.all([ai(`/context.json`),oi]).then(([e,t])=>{ti=e?.context??t?.context??null;let n=Array.isArray(e?.modes)?e.modes:t?.modes;ni=Array.isArray(n)?n:null}),ci=!1,li=e=>X?`${X.base}/cue.png?token=${encodeURIComponent(X.token)}`:ci?`/cue.png`:`/cues/${encodeURIComponent(e)}.png`,ui=(e,t)=>{let n=ri?.[e]?.[t];return n?String(n.snapped||n.hex||``).toUpperCase():``},di=[`primary`,`secondary`,`tertiary`,`neutral`],fi=[`persuade`,`operate`,`read`,`experience`],pi={persuade:`Landing page`,operate:`Tool`,read:`Docs`,experience:`Portfolio`},mi=[`color-strategy`,`boundary-style`,`corner-style`,`depth-style`,`motion-energy`],W=e=>{let t=U.elements[e];return t&&typeof t.value==`string`?t.value:``};function hi(e,t){let n=U.querySelector(`input[name="${e}"][value="${t}"]`)?.closest(`label`);if(!n)return{title:t,desc:``};let r=n.querySelector(`.picker-strategy-title, .picker-icon-title`),i=n.querySelector(`.picker-strategy-desc, .picker-icon-meta`);return{title:(r?.textContent||t).replace(/^[\d.]+\s*/,``).trim(),desc:(i?.textContent||``).trim()}}function gi(){return $r(`input[name="surface-modes"]:checked`,U).sort((e,t)=>fi.indexOf(e.value)-fi.indexOf(t.value)).map(e=>{let t=e.closest(`.picker-mode-tile`);return{mode:e.value,label:e.dataset.surfaceLabel||e.value,goal:t?.querySelector(`.picker-mode-goal`)?.textContent.trim()||``,examples:$r(`.picker-mode-pills i`,t||U).map(e=>e.textContent.trim())}})}function _i(e,t){return t.flatMap(t=>{let n=U.querySelector(`input[data-surface-field="${e}-${t.mode}"]`);if(!n)return[];let r=n.value||W(e);return[{...t,value:r,chosen:n.dataset.chosen===`yes`,...hi(e,r)}]})}function vi(e,t){let[n]=_i(e,t);return n??{value:``,title:``,desc:``}}function yi(){let e=gi(),t=di.map(e=>({role:e[0].toUpperCase()+e.slice(1),hex:W(`palette-${e}`).toUpperCase()})).filter(e=>h(e.hex)),n=U.querySelector(`input[name="type-scale"]:checked`),r=U.querySelector(`input[name="font-pair"]:checked`)?.closest(`.picker-type-option`);return{context:ti,suggestedModes:ni,cueSlugs:ii,surfaces:e,palette:t,paletteSource:W(`palette-source`),strategy:_i(`color-strategy`,e),boundaries:_i(`boundary-style`,e),corners:_i(`corner-style`,e),depth:_i(`depth-style`,e),motion:_i(`motion-energy`,e),layout:vi(`layout-structure`,e),fonts:{heading:W(`font-heading`),body:W(`font-body`),headingSource:W(`font-heading-source`),bodySource:W(`font-body-source`),why:r?.querySelector(`[data-pair-why]`)?.textContent.trim()||``},scale:{name:n?.dataset.scaleName||``,ratio:Number(W(`type-scale-ratio`)||n?.dataset.ratio||0),desc:n?hi(`type-scale`,n.value).desc:``},icons:{pack:W(`icon-pack-name`),license:W(`icon-pack-license`),url:g(W(`icon-pack-url`))}}}var bi=e=>{let t=String(e),n=t.split(/\s/)[0]||``;return!/^[a-z]/.test(t)||/[A-Z]/.test(n)?t:t[0].toUpperCase()+t.slice(1)},G=e=>String(e).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`),xi=(e,t,n,r)=>`
  <header>
    <span class="dcx-eyebrow">Design context &middot; 0${e} / 08${r?` &middot; ${G(r)}`:``}</span>
    <h2 class="dcx-title">${G(t)}</h2>
    <p class="dcx-lede">${G(n)}</p>
  </header>`,K=(e,t)=>`
  <div class="dcx-block" data-label="${G(e)}">
    <span class="dcx-block-label">${G(e)}</span>
    ${t}
  </div>`,Si=e=>`
  ...
  <div class="dcx-callout${n?` dcx-callout--accent`:``}">
    <p class="dcx-callout-name">${G(e)}</p>
    <p>${t}</p>${r}
  </div>`,Ci=e=>`
  <ul class="dcx-list">${e.map(e=>`<li>${e}</li>`).join(``)}</ul>`,wi=e=>`
  <ol class="dcx-principles">${e.map(e=>e&&typeof e==`object`&&e.title?`<li><strong>${G(e.title)}</strong>${e.detail?` &mdash; ${G(e.detail)}`:``}</li>`:`<li>${G(e)}</li>`).join(``)}</ol>`,Ti=e=>`
  <div class="dcx-chips">${e.map(e=>`<span class="dcx-chip dcx-chip--muted">${G(e)}</span>`).join(``)}</div>`,Ei=(e,t)=>`
  <div class="dcx-empty">
    <p class="dcx-empty-title">${G(e)}</p>
    <p>${t}</p>
  </div>`,J=e=>`<p class="dcx-fan-note">${e}</p>`,Di=(e,t)=>Ei(`Captured in chat`,`${e} in chat, before the browser questionnaire. ${t} is the durable copy.`),Oi=e=>X?`${X.base}/brand-assets/${encodeURIComponent(e)}?token=${encodeURIComponent(X.token)}`:`/brand-assets/${encodeURIComponent(e)}`;document.addEventListener(`load`,e=>{let t=e.target;if(!(t instanceof HTMLImageElement)||!(`dcxCueImg`in t.dataset))return;let n=t.closest(`.dcx-cue-frame`);n&&(n.style.setProperty(`--cue-w`,String(t.naturalWidth||1)),n.style.setProperty(`--cue-h`,String(t.naturalHeight||1)),n.dataset.loaded=`yes`)},!0),document.addEventListener(`error`,e=>{let t=e.target;if(!(t instanceof HTMLImageElement))return;if(t.dataset.dcxSwapSrc){let e=t.dataset.dcxSwapSrc;delete t.dataset.dcxSwapSrc,t.dataset.dcxSwapAlt&&(t.alt=t.dataset.dcxSwapAlt,delete t.dataset.dcxSwapAlt),t.src=e;return}let n=t.closest(`[data-dcx-hide-on-error]`);n&&(n.hidden=!0)},!0);function ki(e){let[t,n,r]=[1,3,5].map(t=>parseInt(e.slice(t,t+2),16)/255);return .2126*t+.7152*n+.0722*r>.55?`oklch(20% 0.01 95)`:`oklch(95% 0.005 95)`}function Ai(e){let t={};for(let e of di)t[e]=W(`palette-${e}`);if(Object.values(t).some(e=>!e))return;let n=(t,n)=>e.style.setProperty(`--pkc-${t}`,n);for(let e of di)n(e,t[e]);n(`n-ink`,p(t.neutral)),n(`p-ink`,p(t.primary)),n(`t-ink`,p(t.tertiary)),n(`s-on-n`,y(t.secondary,t.neutral)),n(`p-on-n`,y(t.primary,t.neutral)),n(`t-on-n`,y(t.tertiary,t.neutral)),n(`t-on-p`,y(t.tertiary,t.primary)),n(`p-on-p`,y(t.primary,t.primary)),n(`t-on-t`,y(t.tertiary,t.tertiary)),n(`p-on-i`,y(t.primary,m(t.primary)))}var ji={sharp:{control:`0px`,surface:`0px`},"slightly-soft":{control:`4px`,surface:`6px`},friendly:{control:`10px`,surface:`14px`},pill:{control:`999px`,surface:`18px`}},Mi={flat:{card:`none`,control:`none`,surface:`none`},"soft-lift":{card:`0 1px 1px rgb(0 0 0 / 0.15), 0 3px 7px rgb(0 0 0 / 0.14)`,control:`0 1px 2px rgb(0 0 0 / 0.24)`,surface:`0 2px 5px rgb(0 0 0 / 0.14)`},floating:{card:`0 2px 3px rgb(0 0 0 / 0.2), 0 9px 18px rgb(0 0 0 / 0.24)`,control:`0 3px 6px rgb(0 0 0 / 0.32)`,surface:`0 6px 14px rgb(0 0 0 / 0.22)`}},Ni=/serif|mincho|baskerville|bitter|marcellus|slab|antiqua|garamond|didot|bodoni/i,Pi=e=>`"${e.replaceAll(`"`,`\\"`)}", ${Ni.test(e)?`serif`:`sans-serif`}`;function Fi(e,t){let n=ji[t.corners[0]?.value],r=Mi[t.depth[0]?.value];if(!t.fonts.heading||!t.fonts.body||!n||!r)return!1;let i=(t,n)=>e.style.setProperty(`--pkc-${t}`,n);return i(`font-heading`,Pi(t.fonts.heading)),i(`font-body`,Pi(t.fonts.body)),i(`font-heading-weight`,document.querySelector(`input[name="font-pair"]:checked`)?.closest(`.picker-type-option`)?.style.getPropertyValue(`--pair-heading-weight`)||`400`),i(`radius-control`,n.control),i(`radius-surface`,n.surface),i(`shadow-card`,r.card),i(`shadow-control`,r.control),i(`shadow-surface`,r.surface),t.scale.ratio&&i(`scale-ratio`,String(t.scale.ratio)),!0}function Y(e,{strategy:t=``,kind:n=`board`,marks:r=null}={}){if(!e)return``;let i=e.cloneNode(!0);i.hidden=!1;let a=e.getAttribute(`data-surface`)||``;i.removeAttribute(`data-surface`);for(let e of[i,...i.querySelectorAll(`[id]`)])e.removeAttribute(`id`);for(let e of $r(`button, input`,i))e.setAttribute(`tabindex`,`-1`),e.setAttribute(`disabled`,``);let o=document.createElement(`div`);if(o.className=`dcx-proof dcx-proof--${n}`,o.setAttribute(`aria-hidden`,`true`),t&&(o.dataset.dcxStrategy=t),r)for(let[e,t]of Object.entries(r))t&&o.setAttribute(`data-dcx-${e}`,t);return a&&!o.hasAttribute(`data-dcx-surface`)&&o.setAttribute(`data-dcx-surface`,a),Ai(o),o.appendChild(i),o.outerHTML}var Ii=e=>H(`[data-surface-stage] [data-surface="${e}"]`),Li=e=>H(`input[name="surface-modes"][value="${e}"]`)?.closest(`.picker-mode-tile`)?.querySelector(`.picker-preview`),Ri=(e,t)=>H(`[data-question="${e}"] .picker-board-stage > :is(.picker-artboard, .picker-preview)[data-surface="${t}"]`),zi=e=>Ri(`boundaries`,e),Bi=(e,t)=>H(`[data-question="motion"] .picker-board-stage > :is(.picker-artboard, .picker-preview)[data-motion-cell="${e}-${t}"]`),Vi=(e,t)=>({surface:t,boundary:e.boundaries.find(e=>e.mode===t)?.value||``,corner:e.corners.find(e=>e.mode===t)?.value||``,depth:e.depth.find(e=>e.mode===t)?.value||``,layout:e.layout.value||``}),Hi=e=>Si(e.map(e=>({dt:G(e.label),dd:`<strong>${G(e.title)}</strong> &middot; ${G(e.desc)}${e.chosen?``:` <em>(default for this surface)</em>`}`})));function Ui(e,t){let n=e.context?.audience||{},r=[xi(1,`Audience`,`Who it is for, emotional state, needs, trust triggers.`,t)],i=[n.primary&&{dt:`Primary`,dd:G(n.primary)},n.secondary&&{dt:`Secondary`,dd:G(n.secondary)}].filter(Boolean);if(r.push(K(`Who they are`,i.length?Si(i):Di(`The primary and secondary user read was confirmed`,`<code>PRODUCT.md &middot; Users</code>`))),n.emotion||n.leaving){let e=n.emotion?q(`On arrival`,G(n.emotion),!0):``,t=n.leaving?q(`Leaving with`,G(n.leaving),!0):``;e&&t?r.push(K(`Emotional journey`,`<div class="dcx-callout-pair">${e}${t}</div>`)):r.push(K(e?`Emotional state`:`Emotional journey`,e||t))}let a=Array.isArray(n.needs)&&n.needs.length?K(`Needs`,Ci(n.needs.map(G))):``,o=Array.isArray(n.trust)&&n.trust.length?K(`Trust triggers`,Ci(n.trust.map(G))):``;return a&&o?r.push(`<div class="dcx-cols">${a}${o}</div>`):(a||o)&&r.push(a||o),Array.isArray(n.inclusion)&&n.inclusion.length&&r.push(K(`Who must not be excluded`,Ci(n.inclusion.map(G)))),r.join(``)}function Wi(e,t){return`<div class="dcx-surfaces" data-count="${e.surfaces.length}">${e.surfaces.map((e,n)=>`
    <article class="dcx-surface-card">
      ${Y(Ii(e.mode)||Li(e.mode),{kind:`board`})}
      <div class="dcx-surface-copy">
        <h3 class="dcx-surface-name">${G(e.label)}${n===0?` <span class="dcx-default-mark">leading</span>`:``}</h3>
        ${t(e)}
      </div>
    </article>`).join(``)}</div>`}function Gi(e){if(!Array.isArray(e.suggestedModes)||!e.suggestedModes.length)return``;let t=e.surfaces.map(e=>e.mode),n=new Set(e.suggestedModes),r=new Set(t),i=t=>e.surfaces.find(e=>e.mode===t)?.label||pi[t]||t,a=t.filter(e=>!n.has(e)),o=e.suggestedModes.filter(e=>!r.has(e)),s=`you kept the suggested set`;return a.length&&o.length?s=`you added ${a.map(i).join(`, `)} and dropped ${o.map(i).join(`, `)}`:a.length?s=`you added ${a.map(i).join(`, `)}`:o.length&&(s=`you dropped ${o.map(i).join(`, `)}`),J(`Suggested from <code>PRODUCT.md</code>: ${e.suggestedModes.map(i).join(`, `)}; ${s}.`)}var Ki={web:`Web`,ios:`iOS`,android:`Android`,adaptive:`Adaptive`};function qi(e,t){let n=e.context?.product||{},r=[xi(2,`Product`,`Purpose, surfaces, use cases, what must be clear first.`,t)],i=n.purpose?q(n.name||t||`This product`,G(n.purpose),!1,n.success?`\n    <p class="dcx-callout-success">${G(n.success)}</p>`:``):Di(`The purpose and success definition were confirmed`,`<code>PRODUCT.md &middot; Product Purpose</code>`),a=typeof n.platform==`string`&&n.platform.trim()?`<span class="dcx-chip dcx-platform-pill">${G(Ki[n.platform.trim()]||n.platform.trim())}</span>`:``;if(r.push(K(`Purpose`,a?`<div class="dcx-purpose"><div class="dcx-purpose-main">${i}</div>${a}</div>`:i)),n.positioning&&(n.positioning.not||n.positioning.this)){let e=[n.positioning.not&&q(`Not this`,G(n.positioning.not)),n.positioning.this&&q(`This`,G(n.positioning.this),!0)].filter(Boolean).join(``);r.push(K(`Positioning`,`<div class="dcx-callout-pair">${e}</div>`))}n.conversion&&r.push(K(`Primary conversion`,q(`The one action`,G(bi(n.conversion)),!0))),Array.isArray(n.clarities)&&n.clarities.length&&r.push(K(`What must be clear first`,Ci(n.clarities.map(G)))),Array.isArray(n.principles)&&n.principles.length&&r.push(K(`Product principles`,wi(n.principles))),n.operatingContext&&r.push(K(`Operating context`,`<p class="dcx-prose">${G(n.operatingContext)}</p>`));let o=n.surfaces&&typeof n.surfaces==`object`?n.surfaces:{};return r.push(K(`Surfaces`,Wi(e,e=>`
      <p class="dcx-surface-goal">${G((typeof o[e.mode]==`string`?o[e.mode].trim():``)||e.goal||``)}</p>
      ${e.examples.length?Ti(e.examples):``}`)+Gi(e)+J(`Chosen on the questionnaire&rsquo;s first screen, drawn in the committed palette; the leading surface owns every bare answer key in the sections that follow.`))),r.join(``)}function Ji(e,t){let n=e.context?.brand||{},r=e.context?.interview||{},i=[xi(3,`Brand`,`Identity, voice, references, taste boundaries.`,t)];i.push(K(`Personality`,n.personality?q(n.words?.join(` · `)||`Voice`,G(n.personality),!0):Array.isArray(n.words)&&n.words.length?q(n.words.join(` · `),`Three words, voice, and tone were confirmed in chat, before the browser questionnaire. <code>PRODUCT.md &middot; Brand Personality</code> is the durable copy.`,!0):Di(`Three words, voice, and tone were confirmed`,`<code>PRODUCT.md &middot; Brand Personality</code>`)));let a=(Array.isArray(n.voice)?n.voice:[]).filter(e=>e&&typeof e==`object`&&e.say&&e.not);if(a.length&&i.push(K(`Voice`,`<div class="dcx-voice">${a.map(e=>`
      <div class="dcx-voice-pair">
        <div class="dcx-voice-cell dcx-voice-cell--say"><span class="dcx-voice-tag">Say</span><p>${G(e.say)}</p></div>
        <div class="dcx-voice-cell dcx-voice-cell--not"><span class="dcx-voice-tag">Not</span><p>${G(e.not)}</p></div>
      </div>`).join(``)}</div>`+J(`Derived from Brand Personality and Brand Commitments in <code>PRODUCT.md</code>: wording to write with beside wording to refuse.`))),Array.isArray(n.principles)&&n.principles.length&&i.push(K(`Principles`,`<ol class="dcx-principles dcx-principles--cols">${n.principles.map(e=>`<li>${G(e)}</li>`).join(``)}</ol>`+J(`From <code>PRODUCT.md</code>&rsquo;s principles section; the durable copy lives there.`))),Array.isArray(n.commitments)&&n.commitments.length&&i.push(K(`Commitments`,Ci(n.commitments.map(G)))),Array.isArray(r.references)&&r.references.length){let e=r.references.filter(e=>e&&typeof e==`object`&&e.name),t=r.references.filter(e=>typeof e==`string`),n=(e.length?`<div class="dcx-ref-cards">${e.map(e=>`
      <article class="dcx-ref-card">
        <h3 class="dcx-ref-name">${G(e.name)}</h3>${e.takeaway?`
        <p class="dcx-ref-takeaway">${G(e.takeaway)}</p>`:``}
      </article>`).join(``)}</div>`:``)+(t.length?Ti(t):``);i.push(K(`Named references`,n+J(`Q4 of the seed interview: brands, products, printed objects &mdash; not adjectives.`)))}if(r.antiReference){let e=typeof r.antiReference==`object`?q(`Not this`,`<strong>${G(r.antiReference.name||``)}</strong>${r.antiReference.why?` &middot; ${G(r.antiReference.why)}`:``}`):q(`Not this`,G(r.antiReference));i.push(K(`Anti-reference`,e+J(`Q5 of the seed interview. A hard constraint on every palette and pair that followed.`)))}let o=Array.isArray(e.context?.assets)?e.context.assets:[],s=e=>!!e&&typeof e==`object`&&typeof e.file==`string`&&e.file,c=o.filter(s),l=o.filter(e=>!s(e)),u=c.filter(e=>e.kind===`logo`),d=c.filter(e=>e.kind!==`logo`),f=e=>`
      <figcaption class="dcx-asset-caption">
        <code>${G(e.file)}</code>${e.note?`
        <p>${G(e.note)}</p>`:``}
      </figcaption>`,p=t=>e.palette.find(e=>e.role===t)?.hex||``;return u.length&&i.push(K(`Marks`,`<div class="dcx-marks">${u.map(e=>`
      <figure class="dcx-mark" data-dcx-hide-on-error>
        <div class="dcx-mark-pair">
          <span class="dcx-mark-chip"${p(`Primary`)?` style="--chip-ground:${p(`Primary`)};"`:``}><img src="${Oi(e.file)}" alt="${G(e.file)} on the primary color" /></span>
          <span class="dcx-mark-chip"${p(`Neutral`)?` style="--chip-ground:${p(`Neutral`)};"`:``}><img src="${Oi(e.file)}" alt="${G(e.file)} on the neutral color" /></span>
        </div>
        ${f(e)}
      </figure>`).join(``)}</div>`+J(`Provided marks proofed on the committed primary and neutral grounds. The files are staged in <code>.impeccable/design-context/assets/</code>.`))),d.length&&i.push(K(`Boards and references`,`<div class="dcx-boards">${d.map(e=>`
      <figure class="dcx-board" data-dcx-hide-on-error>
        <span class="dcx-board-frame"><img src="${Oi(e.file)}" alt="${G(e.file)}" loading="lazy" /></span>
        ${f(e)}
      </figure>`).join(``)}</div>`+J(`Boards and reference images provided in chat, staged in <code>.impeccable/design-context/assets/</code>.`))),l.length&&i.push(K(`Assets provided`,Ci(l.map(e=>G(typeof e==`string`?e:e.note||e.file||``)))+J(`Gathered before the interview; the questions were grounded in what they showed.`))),i.join(``)}var Yi={Primary:`Your main brand color: buttons, links, the color people remember.`,Secondary:`Supports the primary: section accents, hovers, secondary buttons.`,Tertiary:`The rare accent: badges, highlights, one detail per screen.`,Neutral:`Backgrounds and large surfaces: most of every page.`};function Xi(e,t){let n=e.context?.interview||{},r=[xi(4,`Color`,`Palette, roles, per-surface strategy, copyable values.`,t)],i=Array.isArray(e.cueSlugs)?e.cueSlugs:[],a=e.paletteSource&&(ci||i.includes(e.paletteSource))?e.paletteSource:``;if(a&&e.palette.length){let t=ri?.[a]||{},n=di.map(e=>{let n=t[e];if(!n||!Array.isArray(n.at)||n.at.length!==2)return``;let r=String(n.snapped||n.hex||``);return`<span class="dcx-cue-dot" data-role="${e}" style="--at-x:${Number(n.at[0])||0}; --at-y:${Number(n.at[1])||0};${r?` --dot-fill:${G(r)};`:``}"></span>`}).join(``),o=e.palette.map(e=>`
      <div class="dcx-cue-role">
        <span class="dcx-cue-role-dot" style="--dot-fill:${e.hex};"></span>
        <span class="dcx-cue-role-name">${G(e.role)}</span>
        <code>${e.hex}</code>
        <code>${G(l(e.hex))}</code>
      </div>`).join(``);r.push(K(`The cue`,`<div class="dcx-cue" data-dcx-hide-on-error>
        <figure class="dcx-cue-frame">
          <img data-dcx-cue-img src="${li(a)}" alt="The chosen visual cue, ${G(a)}" />
          ${n}
        </figure>
        <div class="dcx-cue-card">
          <span class="dcx-cue-tag">Chosen cue</span>
          <h3 class="dcx-cue-name">${G(a)}</h3>
          ${o}
        </div>
      </div>`+J(`The image the palette was sampled from, each role&rsquo;s sample point marked in its dealt color. The values beside it are the committed ones, which move when a role is edited after sampling.`)));let s=i.filter(e=>e!==a);s.length&&r.push(K(`Also generated`,`<div class="dcx-cue-strip">${s.map(e=>`
        <figure class="dcx-cue-thumb" data-dcx-hide-on-error>
          <img src="/cues/${encodeURIComponent(e)}.png" alt="" loading="lazy" />
          <figcaption>${G(e)}</figcaption>
        </figure>`).join(``)}</div>`+J(`The directions not taken, kept on disk in <code>.impeccable/visual-cues/</code>.`)))}if(e.palette.length){let t=100/(e.palette.length+1),n=e.palette.map((e,n)=>`
      <button class="dcx-fan-panel" type="button" data-copy-color="${e.hex}" data-color-name="${G(e.role)}"
        style="--panel-left:${n*t}%; --panel-z:${n+1}; --panel-swatch:${e.hex}; --panel-ink:${ki(e.hex)};"
        aria-label="Copy ${G(e.role)} ${e.hex}">
        <span class="dcx-fan-info"><span class="dcx-fan-name">${G(e.role)}</span><span class="dcx-fan-value">${e.hex}</span></span>
      </button>`).join(``);r.push(K(`Palette`,`<div class="dcx-fan" role="group" aria-label="Chosen palette, click a panel to copy its value">${n}</div>`+J(`Committed on the palette screen${e.paletteSource?` from the <code>${G(e.paletteSource)}</code> cue`:``}, roles in the order you arranged them. Hover to fan; click to copy the hex.`)));let i=e.context?.color||{};r.push(K(`Roles and values`,`<div class="dcx-swatches">${e.palette.map(t=>{let n=m(t.hex),r=ui(e.paletteSource,t.role.toLowerCase()),i=r?r===t.hex?`as dealt`:`edited`:``;return`
      <div class="dcx-swatch" data-role="${t.role.toLowerCase()}">
        <button class="dcx-swatch-chip" type="button" data-copy-color="${t.hex}" data-color-name="${G(t.role)}"
          style="--swatch:${t.hex}; --swatch-ink:${ki(t.hex)};" aria-label="Copy ${G(t.role)} ${t.hex}">
      ...
      </div>`}).join(``)}</div>`+(Array.isArray(i.assetLocks)&&i.assetLocks.length?J(`From the assets: ${i.assetLocks.map(G).join(` &middot; `)}.`):``))),r.push(K(`Strategy per surface`,`<div class="dcx-surfaces" data-count="${e.strategy.length}">${e.strategy.map(e=>`
      <article class="dcx-surface-card">
        ${Y(Ii(e.mode)||Li(e.mode),{strategy:e.value,kind:`board`})}
        <div class="dcx-surface-copy">
          <h3 class="dcx-surface-name">${G(e.label)} &middot; <em>${G(e.title)}</em>${e.chosen?``:` <span class="dcx-default-mark">default</span>`}</h3>
          <p class="dcx-surface-goal">${G(e.desc)}</p>
        </div>
      </article>`).join(``)}</div>`+J(`How much of each surface the palette is allowed to carry, drawn the way the strategy screen previewed it. Options a surface cannot take were withheld there.`)))}else r.push(K(`Palette`,Ei(`No palette committed`,`The palette screen was not completed on this run.`))),r.push(K(`Strategy per surface`,Hi(e.strategy)));return(n.colorStrategy||n.hueAnchor)&&r.push(K(`Interview direction`,Si([n.colorStrategy&&{dt:`Strategy asked for`,dd:G(n.colorStrategy)},n.hueAnchor&&{dt:`Hue anchor`,dd:G(n.hueAnchor)}].filter(Boolean))+J(`Q1 of the seed interview. The cues were generated from this; the picks above are the decision.`))),r.join(``)}function Zi(e,t){let n=e.context?.interview||{},r=[xi(5,`Typography`,`Font families, type scale, hierarchy.`,t)];return e.fonts.heading?r.push(K(`The pair`,`<div class="dcx-pair">
        <article class="dcx-pair-card">
          <span class="dcx-pair-role">Headings</span>
          <p class="dcx-pair-name" style="font-family:'${G(e.fonts.heading)}', serif;">${G(e.fonts.heading)}</p>
          ${e.fonts.headingSource?`<code class="dcx-pair-source">${G(e.fonts.headingSource)}</code>`:``}
        </article>
        <article class="dcx-pair-card">
          <span class="dcx-pair-role">Body</span>
          <p class="dcx-pair-name" style="font-family:'${G(e.fonts.body)}', sans-serif;">${G(e.fonts.body)}</p>
          ${e.fonts.bodySource?`<code class="dcx-pair-source">${G(e.fonts.bodySource)}</code>`:``}
        </article>
      </div>
      <p class="dcx-pair-why" style="font-family:'${G(e.fonts.body)}', sans-serif;">${G(e.fonts.why||`Chosen on the font pair screen against every surface this product ships.`)}</p>`)):r.push(K(`The pair`,Ei(`No pair selected`,`The font pair screen was not completed on this run.`))),e.scale.ratio&&(r.push(K(`Type scale`,`<p class="dcx-scale-head"><strong>${G(e.scale.name)}</strong> &middot; ratio <code>${e.scale.ratio.toFixed(3)}</code> on a 16px base. ${G(e.scale.desc)}</p>`+Y(H(`[data-scale-sheet]`),{kind:`scale`})+J(`The scale screen&rsquo;s sheet, kept at rendered size in the chosen faces. Values at a 16px base.`))),r.push(K(`In running text`,Y(H(`[data-scale-specimen]`),{kind:`specimen`})+J(`The same scale on the components a page is built from &mdash; headings, ledes, lists, quotes, code.`)))),n.typeDirection&&r.push(K(`Interview direction`,q(`Direction asked for`,G(n.typeDirection))+J(`Q2 of the seed interview. All six candidate pairs were composed inside this direction.`))),r.join(``)}function Qi(e,t){let n=[xi(6,`Iconography`,`Icon library, license, where it lives.`,t)];if(e.icons.pack){let t=H(`[data-icon-sheet]`),r=t?.querySelector(`.picker-icon-cell`)?Y(t,{kind:`icons`}):``;r&&n.push(K(`The hand`,r+J(`${G(e.icons.pack)}&rsquo;s canonical set, as the icons screen previewed it. One pack, one hand: no mixed sets.`)));let i=U.querySelector(`input[name="icon-pack"]:checked`)?.closest(`label`),a=i?.querySelector(`.picker-strategy-desc`)?.textContent.trim()||``,o=i?.querySelector(`.picker-icon-meta`)?.textContent.trim()||``;n.push(K(`Library`,Si([{dt:`Pack`,dd:`<strong>${G(e.icons.pack)}</strong>${o?` &middot; ${G(o)}`:``}`},a?{dt:`Why this hand`,dd:G(a)}:null,e.icons.license?{dt:`License`,dd:G(e.icons.license)}:null,e.icons.url?{dt:`Home`,dd:`<a href="${G(e.icons.url)}" target="_blank" rel="noopener">${G(e.icons.url)}</a>`}:null].filter(Boolean))+J(`Chosen on the icons screen. The pack names the hand; stroke weight and metaphor rules resolve during implementation.`)))}else n.push(K(`Library`,Ei(`No pack selected`,`The icons screen was not completed on this run.`)));return n.join(``)}var $i=(e,t=null)=>`<div class="dcx-picks" data-count="${e.length}">${e.map(e=>`
  <article class="dcx-pick${t?` dcx-pick--proof`:``}">
    <span class="dcx-pick-surface">${G(e.label)}${e.chosen?``:` <span class="dcx-default-mark">default</span>`}</span>
    <h3 class="dcx-pick-title">${G(e.title)}</h3>
    <p class="dcx-pick-desc">${G(e.desc)}</p>${t?t(e):``}
  </article>`).join(``)}</div>`;function ea(e,t){let n=e.context?.interview||{},r=[xi(7,`Material`,`Motion, layout structure, boundaries, corners, depth.`,t)],i=e.surfaces.map(t=>{let n=zi(t.mode);return n?`
    <article class="dcx-surface-card">
      ${Y(n,{strategy:e.strategy.find(e=>e.mode===t.mode)?.value||``,kind:`board`,marks:Vi(e,t.mode)})}
      <div class="dcx-surface-copy">
        <h3 class="dcx-surface-name">${G(t.label)}</h3>
      </div>
    </article>`:``}).filter(Boolean);return i.length&&r.push(K(`The page, as chosen`,`<div class="dcx-surfaces" data-count="${i.length}">${i.join(``)}</div>`+J(`Each surface&rsquo;s page anatomy carrying every structural answer below at once, the way the question screens accumulated them: color strategy, layout, boundaries, corners, depth.`))),e.motion.length?r.push(K(`Motion per surface`,$i(e.motion,t=>Y(Bi(t.mode,t.value),{kind:`board`,marks:Vi(e,t.mode)}))+J(n.motionEnergy?`The seed interview asked for <strong>${G(n.motionEnergy)}</strong>; the motion screen answered it per surface above.`:`Asked of the landing page and the portfolio only. A tool and a document are moved through rather than watched, so their movement follows the interface rather than a house style.`))):r.push(K(`Motion`,Ei(`Not asked on this run`,`The motion screen is shown for a landing page and a portfolio. This run has neither, so no motion energy was chosen and none is recorded.`))),e.layout.value&&r.push(K(`Layout structure`,q(e.layout.title,G(e.layout.desc))+J(`Asked of the landing page and the portfolio, where the composition of the page is itself the decision. One answer is kept for the run, and every surface is drawn on it.`))),r.push(K(`Boundaries per surface`,$i(e.boundaries,t=>Y(Ri(`boundaries`,t.mode),{kind:`board`,marks:Vi(e,t.mode)}))+J(`How sections separate on each surface.`))),r.push(K(`Corners per surface`,$i(e.corners,t=>Y(Ri(`corners`,t.mode),{kind:`board`,marks:Vi(e,t.mode)}))+J(`How round shapes are on each surface.`))),r.push(K(`Depth per surface`,$i(e.depth,t=>Y(Ri(`depth`,t.mode),{kind:`board`,marks:Vi(e,t.mode)}))+J(`How far off the page things sit on each surface.`))),r.join(``)}function ta(e,t){let n=[xi(8,`Interface`,`Per-surface decisions at a glance, component status.`,t)];n.push(K(`Decisions per surface`,`<div class="dcx-surfaces" data-count="${e.surfaces.length}">${e.surfaces.map(t=>{let n=e.strategy.find(e=>e.mode===t.mode)?.value||``,r=zi(t.mode),i=[[`Color strategy`,e.strategy.find(e=>e.mode===t.mode)],[`Boundaries`,e.boundaries.find(e=>e.mode===t.mode)],[`Corners`,e.corners.find(e=>e.mode===t.mode)],[`Depth`,e.depth.find(e=>e.mode===t.mode)],[`Motion`,e.motion.find(e=>e.mode===t.mode)],[`Layout`,e.layout.value?e.layout:void 0]];return`
    <article class="dcx-surface-card">
      ${r?Y(r,{strategy:n,kind:`board`,marks:Vi(e,t.mode)}):Y(Ii(t.mode)||Li(t.mode),{strategy:n,kind:`board`})}
      <div class="dcx-surface-copy">
        <h3 class="dcx-surface-name">${G(t.label)}</h3>
        <dl class="dcx-matrix">${i.map(([e,t])=>`
          <div class="dcx-matrix-row"><dt>${G(e)}</dt><dd>${t?G(t.title):`Not asked`}${t&&!t.chosen?` <span class="dcx-default-mark">default</span>`:``}</dd></div>`).join(``)}</dl>
      </div>
    </article>`}).join(``)}</div>`+J(`Each surface&rsquo;s anatomy carrying its committed answers, with every per-surface decision beneath it.`)));let r=[e.fonts.heading?{dt:`Faces`,dd:`<strong>${G(e.fonts.heading)}</strong> for headings, <strong>${G(e.fonts.body)}</strong> for body`}:null,e.scale.ratio?{dt:`Type scale`,dd:`<strong>${G(e.scale.name)}</strong> &middot; ratio <code>${e.scale.ratio.toFixed(3)}</code> on a 16px base`}:null,e.icons.pack?{dt:`Icons`,dd:`<strong>${G(e.icons.pack)}</strong>${e.icons.license?` &middot; ${G(e.icons.license)}`:``}`}:null,e.palette.length?{dt:`Palette`,dd:e.palette.map(e=>`<code>${e.hex}</code>`).join(` &middot; `)}:null,e.layout.value?{dt:`Layout`,dd:`<strong>${G(e.layout.title)}</strong>, one answer for the run`}:null].filter(Boolean);return r.length&&n.push(K(`The kit`,Si(r)+J(`The tokens the seed DESIGN.md will carry in its frontmatter, gathered from their own pages in this document.`))),n.push(K(`Components`,Ei(`No component library seeded yet`,`Components are documented on the first scan pass, once there is code to capture actual tokens and states from. Re-run <code>/impeccable document</code> then.`))),n.join(``)}var na={audience:Ui,product:qi,brand:Ji,color:Xi,typography:Zi,iconography:Qi,material:ea,interface:ta},ra={persuade:`A public-facing page that introduces the experience and guides visitors toward its primary action.`,operate:`A working surface for completing tasks, where familiar patterns and a predictable layout come first.`,read:`A reading surface for understanding, where type, structure, and pacing carry the page.`,experience:`A project-led page for presenting selected work, its context, and its outcomes.`};function ia(){let e=yi();window.dcxSurfaceDefs=e.surfaces.map(e=>({label:e.label,description:ra[e.mode]||e.goal||``}));let t=e.context?.product?.name||``,n=Array.isArray(e.cueSlugs)?e.cueSlugs:[],r=e.paletteSource&&(ci||n.includes(e.paletteSource))?e.paletteSource:``;window.dcxCueImageSrc=r?li(r):``,window.dcxProductName=t;let i=di.every(e=>W(`palette-${e}`));document.body.classList.toggle(`dcx-palette-live`,i),i&&Ai(document.body),document.body.classList.toggle(`dcx-kit-live`,Fi(document.body,e));for(let[n,r]of Object.entries(na)){let i=document.getElementById(`dcx-detail-${n}`);i.innerHTML=`<article class="dcx-article">${r(e,t)}</article>`}t&&(document.title=`Design context — ${t}`)}var aa=e=>new Promise(t=>setTimeout(t,e));function oa(){let e={};for(let[t,n]of new FormData(U))e[t]=t in e?Array.isArray(e[t])?[...e[t],n]:[e[t],n]:n;let t=[].concat(e[`surface-modes`]||[]),n=fi.filter(e=>t.includes(e));for(let t of mi){if(!(t in e))continue;let r=n.find(n=>e[`${t}-${n}`]);r&&(e[t]=e[`${t}-${r}`])}return e}async function sa(){let e=await fetch(`/submit`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(oa())});if(!e.ok&&e.status!==409)throw Error(`Submit failed: ${e.status}`);if(e.ok){let t=await e.json().catch(()=>null);t?.doc?.base&&t?.doc?.token&&ya(t.doc)}}async function ca(){let e=H(`[data-doc-error]`),t=H(`[data-doc-loader]`);e.hidden=!0,t.removeAttribute(`data-stalled`),ia();try{await Promise.all([sa(),aa(2400)]),fa()}catch{t.setAttribute(`data-stalled`,``),e.hidden=!1}}var la=!1;document.addEventListener(`picker:screenchange`,({detail:e})=>{e.screen!==`12`||la||(la=!0,ca())}),ne().then(async e=>{e.mode===`doc`&&(ci=!0,la=!0,await Promise.all([oi,si,ie,Bt().catch(()=>{})]),e.doc?.base&&e.doc?.token&&ya(e.doc),ia(),fa())});var ua;document.addEventListener(`picker:screenchange`,()=>{la||(clearTimeout(ua),ua=setTimeout(()=>{la||fetch(`/autosave`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(oa())}).catch(()=>{})},500))}),H(`[data-doc-retry]`)?.addEventListener(`click`,ca);var da=!1;function fa(){da=!0,document.body.classList.add(`dcx-open`),ei.hidden=!1,window.scrollTo(0,0),requestAnimationFrame(()=>{requestAnimationFrame(()=>{$r(`[data-reveal]`,ei).forEach(e=>e.classList.add(`revealed`)),pa()})})}function pa(){$r(`.dcx-viz-svg`).forEach(e=>{let t=$r(`.anim-draw, .anim-draw-delay`,e);if(!t.length)return;let n=e.getBoundingClientRect();if(!n.width||!n.height)return;let r=Math.min(n.width,n.height)/40;t.forEach(e=>{let t=Math.max(100,e.getTotalLength()/.6);e.style.setProperty(`--pl`,`${(t*r).toFixed(1)}px`)})})}var ma;window.addEventListener(`resize`,()=>{window.clearTimeout(ma),ma=window.setTimeout(()=>{da&&pa()},150)});var X=null,ha=1,ga=!1,_a=[],va=H(`[data-dcx-tray]`);function ya(e){X=e,window.dcxDocSession=e,document.body.classList.add(`dcx-live`),Oa(),xa(1500)}var ba;function xa(e){window.clearTimeout(ba),ba=window.setTimeout(Sa,e)}async function Sa(){if(X)try{let e=await fetch(`${X.base}/doc/state?token=${encodeURIComponent(X.token)}`);if(!e.ok)throw Error(`state`);let t=await e.json();Ca(!0),_a=t.requests||[],Aa(),t.version!==ha&&(ha=t.version,await Da(),Oa()),xa(2e3)}catch{Ca(!1),Aa(),xa(8e3)}}function Ca(e){ga=e,document.body.classList.toggle(`dcx-live`,!!X&&e)}async function wa(){let e=await fetch(`${X.base}/doc/answers?token=${encodeURIComponent(X.token)}`);if(!e.ok)return;let{answers:t}=await e.json();for(let[e,n]of Object.entries(t||{})){if(Array.isArray(n)||typeof n!=`string`)continue;let t=U.elements[e];t&&(typeof RadioNodeList<`u`&&t instanceof RadioNodeList||`value`in t&&t.type!==`checkbox`)&&(t.value=n)}Ta(W(`font-heading`)),Ta(W(`font-body`))}function Ta(e){if(!e||document.fonts?.check?.(`16px '${e}'`))return;let t=`dcx-face-${e.replace(/\W+/g,`-`).toLowerCase()}`;if(document.getElementById(t))return;let n=document.createElement(`link`);n.id=t,n.rel=`stylesheet`,n.href=`https://fonts.googleapis.com/css2?family=${encodeURIComponent(e).replace(/%20/g,`+`)}:wght@300..800&display=swap`,document.head.appendChild(n)}async function Ea(){let e=await fetch(`${X.base}/doc/context?token=${encodeURIComponent(X.token)}`);if(!e.ok)return;let t=await e.json();t.context&&typeof t.context==`object`&&(ti=t.context),Array.isArray(t.modes)&&(ni=t.modes)}var Da=()=>Promise.all([wa(),Ea()]);function Oa(){ia(),window.dcxDocument?.remount()}var ka={pending:`Queued for the agent`,working:`The agent is on it`,done:`Applied`,error:`Could not apply`};function Aa(){if(!va)return;let e=_a.slice(-4),t=X&&!ga;va.hidden=!t&&e.length===0,va.innerHTML=[t?`<div class="dcx-tray-item" data-status="offline"><span class="dcx-tray-dot"></span><div><p class="dcx-tray-prompt">Edit session offline</p><p class="dcx-tray-note">Changes stay in this tab; reconnecting&hellip;</p></div></div>`:``,...e.map(e=>`
      <div class="dcx-tray-item" data-status="${G(e.status)}">
        <span class="dcx-tray-dot"></span>
        <div>
          <p class="dcx-tray-prompt">${G(e.prompt)}</p>
          <p class="dcx-tray-note">${G(e.message||ka[e.status]||e.status)}</p>
        </div>
      </div>`)].join(``)}var Z=(e,t=document)=>t.querySelector(e),ja=Z(`#picker-form`),Ma=Z(`[data-copy-url]`),Na=Z(`[data-copy-status]`),Q=[...ja.querySelectorAll(`.picker-screen`)],$=Q.findIndex(e=>e.hasAttribute(`data-active`)),Pa=new URL(location.href);Pa.hostname=`localhost`;var Fa=Pa.href.replace(/\/$/,``);Z(`[data-copy-url-value]`).textContent=Fa;var Ia=()=>[...Q[$].querySelectorAll(`button:not([disabled]), input:not([disabled]):not([type="hidden"]):not([tabindex="-1"]), select:not([disabled]), textarea:not([disabled]), a[href]`)],La=Z(`.picker-progress`),Ra=Z(`.picker-progress-track`),za=()=>Q.filter((e,t)=>t>0&&t<Q.length-1&&!e.hasAttribute(`data-skip`)),Ba=e=>{let t=za(),n=t.length,r=t.indexOf(e),i=r>=0?r+1:e===Q[0]?1:n;La.dataset.step=String(i),La.style.setProperty(`--pk-steps`,String(n)),[...Ra.children].forEach((e,t)=>e.toggleAttribute(`data-off`,t>=n)),Z(`[data-progress-index]`).textContent=String(i),Z(`[data-progress-total]`).textContent=String(n),Z(`[data-progress-name]`).textContent=e.dataset.step||``},Va=new Set([`01b`,`02`,`03`]),Ha=(e,t)=>typeof document.startViewTransition==`function`&&!matchMedia(`(prefers-reduced-motion: reduce)`).matches&&Va.has(e?.dataset.screen)&&Va.has(t?.dataset.screen),Ua=(e,t=1)=>{let n=e;for(;Q[n]?.hasAttribute(`data-skip`);)n+=t;let r=Q[n];if(r){if(Ha(Q[$],r)){document.startViewTransition(()=>Wa(n));return}Wa(n)}},Wa=e=>{let t=Q[e];Q.forEach((t,n)=>{let r=n===e;t.toggleAttribute(`data-active`,r),r?t.removeAttribute(`aria-hidden`):t.setAttribute(`aria-hidden`,`true`)}),$=e;let n=t.dataset.screen;ja.dataset.current=n,Ba(t),document.dispatchEvent(new CustomEvent(`picker:screenchange`,{detail:{screen:n}})),Ia()[0]?.focus()},Ga=`04b`,Ka=new Set([`06`,`08`,`09`,`10`,`11`]),qa=e=>Q.findIndex(t=>t.dataset.screen===e);ja.onclick=e=>{let t=e.target.closest(`[data-advance]`);if(!t)return;if(Ka.has(Q[$].dataset.screen)){Ua(qa(Ga));return}let n=t.dataset.advance===`prev`?-1:1;Ua($+n,n)},document.addEventListener(`picker:goto`,e=>{let t=qa(e.detail.screen);t!==-1&&Ua(t)}),document.addEventListener(`keydown`,e=>{if(e.defaultPrevented||e.target instanceof Element&&e.target.closest(`input, textarea, select, [role="slider"]`))return;if(e.key===`Enter`){if($===0&&matchMedia(`(max-width: 1199px)`).matches)return;let t=$===0?Z(`[data-advance="next"]`,Q[0]):document.activeElement;Ia().includes(t)&&(e.preventDefault(),t.click());return}let t={ArrowUp:-1,ArrowLeft:-1,ArrowDown:1,ArrowRight:1};if(!(e.key in t))return;e.preventDefault();let n=Ia(),r=n.indexOf(document.activeElement);n[r<0?0:(r+t[e.key]+n.length)%n.length]?.focus()}),ja.onsubmit=e=>e.preventDefault(),Ma.onclick=async()=>{try{await navigator.clipboard.writeText(Fa),Ma.classList.add(`is-copied`),Ma.setAttribute(`aria-label`,`Link copied`),Na.textContent=`Copied. Paste it into your browser to continue.`,setTimeout(()=>{Ma.classList.remove(`is-copied`),Ma.setAttribute(`aria-label`,`Copy link`)},1200)}catch{Na.textContent=`Copy failed. Select the link above and copy it instead.`}},ja.dataset.current=Q[$].dataset.screen,Ba(Q[$]);