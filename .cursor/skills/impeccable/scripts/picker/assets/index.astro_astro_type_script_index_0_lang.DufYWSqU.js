          ...
          <div class="dcx-component-canvas dcx-component-canvas--cards">
            <div class="dcx-component-demo-grid dcx-component-demo-grid--two">
              <article class="dcx-showcase-card dcx-showcase-card--media">
                <img ${S(`Purple flowers arranged in a black ceramic vase`,`The visual cue this palette was picked from`)} width="800" height="1200" loading="lazy" decoding="async">
                <div class="dcx-showcase-card-body">
              ...
              <article class="dcx-showcase-card dcx-showcase-card--media dcx-showcase-card--media-close">
                <img ${S(`Close crop of purple ikebana flowers`,`The chosen visual cue, cropped close`)} width="800" height="1200" loading="lazy" decoding="async">
                <div class="dcx-showcase-card-body">
        ...
        <figure class="dcx-component-example">
          ...
          <div class="dcx-component-canvas dcx-component-canvas--cards dcx-component-canvas--single-card">
            <article class="dcx-showcase-card dcx-showcase-card--horizontal">
              <img ${S(`Purple ikebana in a dark ceramic vase`,`The chosen visual cue as a wide feature image`)} width="800" height="1200" loading="lazy" decoding="async">
              <div class="dcx-showcase-card-body">
...
.imp-paint-nudge-`+u+` { --imp-nudge: `+u+`; }`,u<3&&r.setTimeout(d,700*u))};r.requestAnimationFrame(()=>r.requestAnimationFrame(d))},installEmailCapture:()=>{if(!n?.head||t.hasAttribute(`data-premium-landing-email-capture`))return;t.setAttribute(`data-premium-landing-email-capture`,``);let e=n.createElement(`style`);e.id=`landing-email-capture`,e.textContent=`
        ...
        `,n.getElementById(e.id)||n.head.appendChild(e);let i=n.querySelector(`.picker-preview-motion--index`),a=i?.querySelector(`.pv-desktop .pg-body`),o=i?.querySelector(`.pv-phone .pg-phone-body`);a?.querySelectorAll(`:scope > .pg-rail`).forEach(e=>e.remove()),a&&!a.querySelector(`.pg-row--scroll-one`)&&a.insertAdjacentHTML(`beforeend`,`<span class="pg-row pg-row--more pg-row--scroll-one"><span class="pv-image"></span><span class="pg-cap"><i class="pg-cap-title" style="--w:31.4%"></i><i></i><i style="--w:61.8%"></i></span></span><span class="pg-row pg-row--flip pg-row--more pg-row--scroll-two"><span class="pg-cap"><i class="pg-cap-title" style="--w:38.2%"></i><i></i><i style="--w:59.4%"></i></span><span class="pv-image"></span></span>`),o&&!o.querySelector(`.pg-phone-more-start`)&&o.insertAdjacentHTML(`beforeend`,`<span class="pv-image pg-phone-more pg-phone-more-start"></span><span class="pg-cap pg-phone-more pg-phone-more-copy-one"><i class="pg-cap-title" style="--w:34.2%"></i><i style="--w:74.6%"></i><i style="--w:51.8%"></i></span><span class="pv-image pg-phone-more pg-phone-more-image-two"></span><span class="pg-cap pg-phone-more pg-phone-more-copy-two"><i class="pg-cap-title" style="--w:28.8%"></i><i style="--w:82.4%"></i><i style="--w:58.2%"></i></span>`);let s=[[`.pv-desktop .pg-row:first-child > .pv-image`,`.pv-desktop .pg-row:first-child > .pg-cap`,`.pv-desktop .pg-row:nth-child(2) > .pv-image`,`.pv-desktop .pg-row:nth-child(2) > .pg-cap`],[`.pg-phone-body > .pv-image:nth-child(1)`,`.pg-phone-body > .pg-cap:nth-child(2)`,`.pg-phone-body > .pv-image:nth-child(3)`,`.pg-phone-body > .pg-cap:nth-child(4)`,`.pv-tabbar`]],c=()=>{let e=Math.sqrt(120),t=20/(2*Math.sqrt(120)),n=e*Math.sqrt(1-t**2);return Array.from({length:73},(r,i)=>{let a=i/72,o=1050*a/1e3,s=i===72?0:Math.exp(-t*e*o)*(Math.cos(n*o)+t*e/n*Math.sin(n*o)),c=Math.max(0,Math.min(1,1-s));return{offset:a,opacity:Number(c.toFixed(4)),filter:`blur(${(4*(1-c)).toFixed(3)}px)`,transform:`translateY(${(40*s).toFixed(3)}px)`}})},l={imageFromLeft:[{opacity:.12,filter:`blur(9px)`,clipPath:`inset(0 100% 0 0)`,transform:`translateX(-72px) scale(1.025)`},{opacity:1,filter:`blur(0px)`,clipPath:`inset(0)`,transform:`translateX(0px) scale(1)`}],copyFromRight:[{opacity:0,filter:`blur(5px)`,clipPath:`inset(0 0 0 100%)`,transform:`translateX(44px)`},{opacity:1,filter:`blur(0px)`,clipPath:`inset(0)`,transform:`translateX(0px)`}],imageFromRight:[{opacity:.12,filter:`blur(9px)`,clipPath:`inset(0 0 0 100%)`,transform:`translateX(72px) scale(1.025)`},{opacity:1,filter:`blur(0px)`,clipPath:`inset(0)`,transform:`translateX(0px) scale(1)`}],copyFromLeft:[{opacity:0,filter:`blur(5px)`,clipPath:`inset(0 100% 0 0)`,transform:`translateX(-44px)`},{opacity:1,filter:`blur(0px)`,clipPath:`inset(0)`,transform:`translateX(0px)`}]},u=r.matchMedia(`(prefers-reduced-motion: reduce)`);if(i&&r.Element?.prototype.animate&&!u.matches){let e=[],n=c();for(let t of s)t.map(e=>i.querySelector(e)).filter(Boolean).forEach((t,r)=>{e.push(t.animate(n,{duration:1050,delay:r*100,easing:`linear`,fill:`both`}))});let d=7200,f=e=>e/d,p=(t,n,r)=>{if(!t||!n||!r)return;let i=r.offsetTop-n.offsetTop;i>0&&e.push(t.animate([{offset:0,transform:`translateY(0px)`},{offset:f(1750),transform:`translateY(0px)`,easing:`cubic-bezier(.65, 0, .35, 1)`},{offset:f(2850),transform:`translateY(${-i}px)`},{offset:f(5400),transform:`translateY(${-i}px)`,easing:`cubic-bezier(.65, 0, .35, 1)`},{offset:f(6500),transform:`translateY(0px)`},{offset:1,transform:`translateY(0px)`}],{duration:d,easing:`linear`,fill:`both`}))};p(a,a?.querySelector(`:scope > .pg-row:first-child`),a?.querySelector(`:scope > .pg-row--scroll-one`)),p(o,o?.querySelector(`:scope > .pv-image:first-child`),o?.querySelector(`:scope > .pg-phone-more-start`));for(let[t,n,r]of[[`.pv-desktop .pg-row--scroll-one > .pv-image`,`imageFromLeft`,2020],[`.pv-desktop .pg-row--scroll-one > .pg-cap`,`copyFromRight`,2160],[`.pv-desktop .pg-row--scroll-two > .pv-image`,`imageFromRight`,2400],[`.pv-desktop .pg-row--scroll-two > .pg-cap`,`copyFromLeft`,2540],[`.pv-phone .pg-phone-more-start`,`imageFromLeft`,2020],[`.pv-phone .pg-phone-more-copy-one`,`copyFromRight`,2160],[`.pv-phone .pg-phone-more-image-two`,`imageFromRight`,2400],[`.pv-phone .pg-phone-more-copy-two`,`copyFromLeft`,2540]]){let a=i.querySelector(t);a&&e.push(a.animate(l[n],{duration:n.startsWith(`image`)?720:620,delay:r,easing:`cubic-bezier(.16, 1, .3, 1)`,fill:`both`}))}let m=()=>{if(u.matches){e.forEach(e=>e.cancel());return}e.forEach(e=>{e.pause(),e.currentTime=0,e.play()})};t.__replayMotion=m,u.addEventListener(`change`,({matches:t})=>{t?e.forEach(e=>e.cancel()):m()}),r.addEventListener(`pagehide`,()=>{e.forEach(e=>e.cancel())})}}let a=()=>{for(let e of n.querySelectorAll(`.picker-preview-motion--index`)){let t=e.querySelector(`.pv-desktop`),n=e.querySelector(`.ps-cursor`);if(!t?.clientWidth||!t.clientHeight||!n)continue;let a=t.getBoundingClientRect(),o=r.getComputedStyle(t),s=parseFloat(o.borderLeftWidth)||0,c=parseFloat(o.borderRightWidth)||0,l=parseFloat(o.borderTopWidth)||0,u=parseFloat(o.borderBottomWidth)||0,d=a.width-s-c,f=a.height-l-u,p=r.getComputedStyle(n),m=parseFloat(p.width)||n.offsetWidth,h=parseFloat(p.height)||n.offsetHeight,g=Math.min(m/14,h/20),_=[`restrained`,`responsive`].includes(i.slice(i.indexOf(`-`)+1)),v=g*(_?1:2.2),y=g*(_?1:3.9),b=(n,r)=>{let i=t.querySelector(r);if(!i)return;let o=i.getBoundingClientRect(),c=(o.left+o.width/2-a.left-s-v)/d*100,u=(o.top+o.height/2-a.top-l-y)/f*100;e.style.setProperty(n,c.toFixed(2)+`cqw `+u.toFixed(2)+`cqh`)};b(`--mxi-nav1-tip`,`.pv-nav-bars i:nth-child(1)`),b(`--mxi-work1-tip`,`.pg-row:nth-of-type(1) > .pv-image`),b(`--mxi-work2-tip`,`.pg-row:nth-of-type(2) > .pv-image`),b(`--mxi-rail-tip`,`.pg-arrow--next`),b(`--mxr-modal-close-tip`,`.mxr-modal-close`),b(`--mxv-modal-close-tip`,`.mxv-modal-close`)}};r.requestAnimationFrame(()=>{a(),r.requestAnimationFrame(a)});let o=n.querySelector(`.pv-desktop`);if(o&&r.ResizeObserver){let e=new r.ResizeObserver(a);e.observe(o),t.__portfolioTipObserver=e}}})}let t=t=>{let n=e.map(({board:e})=>[e,e.getAttribute(`style`)]);for(let{board:n}of e)n.style.setProperty(`display`,n===t?`grid`:`none`,`important`);return()=>{for(let[e,t]of n)t===null?e.removeAttribute(`style`):e.setAttribute(`style`,t)}},n=(e,n)=>{let r=t(e.board);try{n()}finally{r()}};for(let t of e)t.cell===`persuade-restrained`&&n(t,t.installPerfectCursorLoop);for(let t of e)t.cell===`persuade-responsive`&&n(t,t.installResponsiveLandingCorrections);for(let t of e)t.cell===`persuade-choreographed`&&n(t,t.installChoreographedPremium);for(let t of e)t.cell.startsWith(`persuade-`)&&n(t,t.installEmailCapture);for(let t of e)t.cell.startsWith(`experience-`)&&n(t,t.installPortfolioFixes)}var $t=!1;function en(){if($t)return;let e=document.querySelector(`.picker-screen[data-screen="06"] .picker-board-stage`),t=e?[...e.querySelectorAll(`.picker-preview-motion[data-motion-cell]`)]:[];!t.length||!t.some(e=>e.getBoundingClientRect().width>0)||($t=!0,Qt())}var R=document.querySelector(`[data-font-modal]`),tn=R.querySelector(`[data-custom-status]`),nn=e=>R.querySelector(`[data-custom-file="${e}"]`),rn=e=>R.querySelector(`[data-custom-url="${e}"]`),an=R.querySelector(`[data-font-custom-save]`),on=R.querySelector(`[data-custom-hint]`),sn=`
`,cn=new Set([`.woff2`,`.woff`,`.ttf`,`.otf`]),z={heading:[],body:[]};function ln(e){let t=e.lastIndexOf(`.`);return t===-1?``:e.slice(t).toLowerCase()}function un(e){return cn.has(ln(e.name))}function dn(e,t){let n=new DataTransfer;for(let e of t)n.items.add(e);e.files=n.files}function fn(e,t){return e.name===t.name&&e.size===t.size&&e.lastModified===t.lastModified}function pn(e,t){let n=[...e];for(let e of t)n.some(t=>fn(t,e))||n.push(e);return n}function mn(e){let t=R.querySelector(`[data-custom-file-list="${e}"]`),n=z[e];t.replaceChildren(),t.hidden=n.length===0;for(let r of n){let n=document.createElement(`li`);n.className=`picker-modal-file-item`;let i=document.createElement(`span`);i.textContent=r.name;let a=document.createElement(`button`);a.type=`button`,a.className=`picker-modal-file-remove`,a.setAttribute(`aria-label`,`Remove ${r.name}`),a.textContent=`×`,a.onclick=()=>{z[e]=z[e].filter(e=>!fn(e,r)),dn(nn(e),z[e]),mn(e),gn(),tn.textContent=``},n.append(i,a),t.append(n)}}var hn=e=>z[e].length>0||rn(e).value.trim()!==``;function gn(){let e=[`heading`,`body`].filter(e=>!hn(e));an.disabled=e.length>0,on.textContent=e.length===2?`Heading and body each need a URL or a file.`:e.length===1?`${e[0]===`heading`?`Heading`:`Body`} still needs a URL or a file.`:``}function _n(e){return e?e.includes(sn)?e.split(sn).filter(Boolean):[e]:[]}document.querySelector(`[data-font-custom-open]`).onclick=()=>{tn.textContent=``;for(let e of[`heading`,`body`])z[e]=[],nn(e).value=``,dn(nn(e),[]),rn(e).value=``,mn(e);gn(),R.showModal()},document.querySelector(`[data-font-custom-close]`).onclick=()=>R.close();for(let e of[`heading`,`body`])nn(e).onchange=({target:t})=>{let n=[...t.files].filter(un);tn.textContent=n.length===t.files.length?``:`Only .woff2, .woff, .ttf, and .otf files are accepted.`,z[e]=pn(z[e],n),dn(t,z[e]),t.value=``,mn(e),gn()},rn(e).oninput=gn;async function vn(e){let t=await fetch(`/font-upload`,{method:`POST`,headers:{"X-Font-Filename":e.name,"Content-Type":`application/octet-stream`},body:e}),n=await t.json();if(!t.ok)throw Error(n.error||`Upload failed`);return n.path}async function yn(e){let t=z[e].filter(un);if(t.length){let e=await Promise.all(t.map(e=>vn(e)));return{family:t[0].name.replace(/\.[^.]+$/,``),source:e.join(sn)}}let n=rn(e).value.trim();return n?{family:n.split(`/`).pop().replace(/\.[^.]+$/,``)||`Custom`,source:n}:null}an.onclick=async()=>{tn.textContent=`Saving…`;let e,t;try{[e,t]=await Promise.all([yn(`heading`),yn(`body`)])}catch(e){tn.textContent=e.message;return}if(!e||!t){tn.textContent=`Add a URL or a file for both the heading and the body.`;return}let n={id:`custom`,name:`Custom`,heading:e,body:t,why:`Your own faces`};Oe.pairs=[n,...Oe.pairs.filter(({id:e})=>e!==`custom`)];for(let e of[...tt])e.querySelector(`input`).value===`custom`&&rt(e);nt(n,{checked:!0,first:!0}),bn(n),et(n),ut({force:!0}),R.close()};function bn({heading:e,body:t}){for(let n of[e,t])if(n?.source){if(/\.(css)(\?|$)/i.test(n.source)||!n.source.includes(sn)&&!/\.(woff2?|ttf|otf)(\?|$)/i.test(n.source)){let e=document.createElement(`link`);e.rel=`stylesheet`,e.href=n.source,document.head.append(e);continue}for(let e of _n(n.source)){let t=e.startsWith(`http`)?e:`/fonts/${e.split(`/`).pop()}`;document.fonts.add(new FontFace(n.family,`url(${t})`))}document.fonts.load(`16px "${n.family}"`)}}function xn(e){ge.textContent!==ge.dataset[e]&&(ge.classList.add(`is-changing`),setTimeout(()=>{ge.textContent=ge.dataset[e],ge.classList.remove(`is-changing`)},90))}var Sn=D(`[data-contrast-alert]`,A),Cn=D(`[data-contrast-tip]`,A);function wn(e,t,n){e.hidden=n.length===0,t.replaceChildren(...n.map(e=>{let t=document.createElement(`span`);return t.textContent=e,t}))}function Tn(){wn(Sn,Cn,N.length?b(I().colors):[])}function En(e,t,n=!0){let r=I();r.colors[e]=t.toUpperCase(),r.detached[e]=n,Ge(e),Ue(F()),xn(e)}function Dn(e,t,n,r,i){let a=M.get(t.id),o=He(n),s=e.dataset.role;r=Math.min(100,Math.max(0,r)),i=Math.min(100,Math.max(0,i));let c=o.getContext(`2d`).getImageData(Math.round(r/100*(o.width-1)),Math.round(i/100*(o.height-1)),1,1).data,l=`#${[c[0],c[1],c[2]].map(e=>e.toString(16).padStart(2,`0`)).join(``).toUpperCase()}`;a.rings[s]=[r,i],a.colors[s]=l,a.detached[s]=!1,Ue(t),t===F()&&Ge(s),xn(s),We(e,t,n)}function On(e,t,n){let r=r=>{let i=n.getBoundingClientRect();Dn(e,t,n,(r.clientX-i.left)/i.width*100,(r.clientY-i.top)/i.height*100)};e.onpointerdown=t=>{t.button===0&&(e.focus(),e.setPointerCapture(t.pointerId),e.dataset.dragging=``,r(t))},e.onpointermove=t=>{e.hasPointerCapture(t.pointerId)&&(Re(),r(t))},e.onpointerup=t=>{r(t),e.releasePointerCapture(t.pointerId),delete e.dataset.dragging,document.activeElement!==e&&delete ve.dataset.visible},e.onfocus=()=>n.complete&&We(e,t,n),e.onblur=()=>{`dragging`in e.dataset||delete ve.dataset.visible},e.onkeydown=r=>{let i={ArrowLeft:[-1,0],ArrowRight:[1,0],ArrowUp:[0,-1],ArrowDown:[0,1]};if(!i[r.key])return;r.preventDefault(),Re();let a=r.shiftKey?5:1,[o,s]=M.get(t.id).rings[e.dataset.role];Dn(e,t,n,o+i[r.key][0]*a,s+i[r.key][1]*a)}}function kn(e){let t=D(`[data-${e.type}-card]`).content.firstElementChild.cloneNode(!0);t.dataset.id=e.id;let n=D(`.picker-card-face`,t);if(e.type===`seed`)pe(`span`,n).forEach((t,n)=>{t.style.setProperty(`--seed-color`,M.get(e.id).colors[T[n]])});else{let t=D(`img`,n);t.alt=`Visual cue ${e.id}`,t.src=`/cues/${encodeURIComponent(e.id)}.png`,pe(`.picker-ring`,n).forEach(n=>{let r=n.dataset.role;n.setAttribute(`aria-valuetext`,M.get(e.id).colors[r]),On(n,e,t)}),t.addEventListener(`load`,()=>{e.defaultRings=Le(n=>{let[r,i]=e.palette[n].at;return[r/t.naturalWidth*100,i/t.naturalHeight*100]}),M.get(e.id).rings=structuredClone(e.defaultRings),Ue(e),e===F()&&He(t)})}return e.node=t,t}function An(){if(!De)return;let e=De,t=D(`[data-band-item="${e}"]`,A),n=D(`[data-tints]`,t),r=n.contains(document.activeElement);delete t.dataset.tintOpen,n.hidden=!0,De=null;let i=D(`[data-edit-tints="${e}"]`,A);i.setAttribute(`aria-expanded`,`false`),i.dataset.tip=`Edit tints`,r&&i.focus()}function jn(){let e=F();N.forEach(({node:e},t)=>{let n=t-P;e.dataset.pos=Math.max(-2,Math.min(2,n)),e.classList.toggle(`is-far`,Math.abs(n)>2),e.setAttribute(`aria-hidden`,n!==0)}),D(`[data-deck-prev]`).disabled=P===0,D(`[data-deck-next]`).disabled=P===N.length-1,he.textContent=`${P+1} / ${N.length}`;for(let e of T)Ge(e);if(Ue(e),e.type===`cue`){let t=D(`img`,e.node);t.complete&&t.naturalWidth&&He(t)}An()}function Mn(e){let t=Math.min(N.length-1,Math.max(0,e)),n=matchMedia(`(prefers-reduced-motion: reduce)`).matches?`auto`:`smooth`;k.children[t].scrollIntoView({behavior:n,block:`start`})}function Nn(e){if(e.key===`Escape`&&De){e.preventDefault(),An();return}let t={ArrowLeft:-1,ArrowRight:1}[e.key];t&&(e.target instanceof Element&&e.target.closest(`[role="slider"], input`)||B?.keyboard||(e.preventDefault(),Mn(P+t)))}var Pn=e=>document[e?`addEventListener`:`removeEventListener`](`keydown`,Nn,!0);function Fn(e){An(),De=e,xn(e);let t=D(`[data-band-item="${e}"]`,A),n=D(`[data-tints]`,t),r=I().colors[e],[i,a,o]=c(r);pe(`[data-tint]`,n).forEach((e,t)=>{let n=t-3,c=n<0?i+(.96-i)*(-n/3):i-(i-.16)*(n/3),l=n===0?r:s([c,a*(1-Math.abs(n)/3*.3),o]);e.dataset.tint=l,e.style.setProperty(`--tint-color`,l),e.setAttribute(`aria-label`,l),e.toggleAttribute(`data-current`,n===0)}),n.hidden=!1,t.dataset.tintOpen=``;let l=D(`[data-edit-tints="${e}"]`,A);l.setAttribute(`aria-expanded`,`true`),l.dataset.tip=`Close tints`,D(`button`,n)?.focus()}var In=220,Ln=1.02,Rn=getComputedStyle(document.documentElement).getPropertyValue(`--ks-ease`).trim()||`ease`,zn=new Set([` `,`Enter`,`ArrowLeft`,`ArrowRight`,`Home`,`End`,`Escape`]),Bn=new WeakMap,Vn=D(`.picker-bands`,A),Hn=document.querySelector(`[data-band-scope="strategy"]`),Un=document.querySelector(`.picker-screen[data-screen="03"] .picker-strategy-grid`),Wn=()=>matchMedia(`(prefers-reduced-motion: reduce)`).matches,Gn=e=>T.map(t=>D(`[data-band="${t}"]`,e)),Kn=e=>T.map(t=>D(`[data-grip="${t}"]`,e)),qn=(e,t)=>D(`[data-band-item="${T[e]}"] .picker-band-foot h2`,t).textContent,Jn=(e,t)=>{let n=D(`[data-reorder-status]`,e.closest(`.picker-screen`)??e);n&&(n.textContent=t)},B=null,Yn=null;function Xn(e,t){let n=T.map((e,t)=>t);return n.splice(t,0,...n.splice(e,1)),n}function Zn(e,t,n,r){e.style.transform=n?`translateX(${n}px)`:``,Bn.get(e)?.cancel(),r&&Bn.set(e,e.animate([{transform:`translateX(${t}px)`},{transform:`translateX(${n}px)`}],{duration:In,easing:Rn}))}function Qn(e,t){let n=B.nodes[B.from],r=B.offsets[B.from],i=e=>`translateX(${e}px) scale(${Ln})`;B.offsets[B.from]=e,n.style.transform=i(e),Bn.get(n)?.cancel(),t&&Bn.set(n,n.animate([{transform:i(r)},{transform:i(e)}],{duration:In,easing:Rn}))}function $n(e,t){Xn(B.from,e).forEach((e,n)=>{if(e===B.from)return;let r=B.homes[n].left-B.homes[e].left;r!==B.offsets[e]&&(Zn(B.nodes[e],B.offsets[e],r,t),B.offsets[e]=r)}),B.to=e}function er(e){let{homes:t,from:n}=B,r=t[n].left+t[n].width/2+e,i=e=>Math.abs(t[e].left+t[e].width/2-r);return t.reduce((e,t,n)=>i(n)<i(e)?n:e,0)}function tr(e,t,n){let r=I(),i={},a={},o={};Xn(e,t).forEach((e,t)=>{let n=T[t],s=T[e];i[n]=r.colors[s],a[n]=r.detached[s],o[n]=r.rings[s]}),Object.assign(r,{colors:i,detached:a,rings:o}),jn(),n!==Vn&&nr()}function nr(){if(D(`[name="palette-source"]`).value){for(let e of T)D(`[name="palette-${e}"]`).value=I().colors[e];ar(),Ar();for(let e of document.querySelectorAll(`.picker-screen[data-active] [data-artboard]`))qe(e)}}var rr=D(`[data-contrast-alert]`,Hn),ir=D(`[data-contrast-tip]`,Hn);function ar(){let e=Le(e=>D(`[name="palette-${e}"]`).value);if(!Object.values(e).some(e=>!e)){for(let t of T){let n=D(`[data-band="${t}"]`,Hn);n.style.setProperty(`--band-color`,e[t]),n.style.setProperty(`--band-ink`,p(e[t])),D(`output`,n).textContent=e[t]}wn(rr,ir,b(e))}}function or(){let e=Un?.parentElement;if(!e||!e.offsetParent)return;let t=`${Math.ceil(e.getBoundingClientRect().height-Un.getBoundingClientRect().height)}px`;e.style.getPropertyValue(`--pk-chrome`)!==t&&e.style.setProperty(`--pk-chrome`,t)}Un&&new ResizeObserver(or).observe(Un.parentElement);function sr(e,t){let{colors:n}=I();return Xn(e,t).map((e,t)=>`${T[t]} ${n[T[e]]}`).join(`, `)}function cr(e,t,n){B&&lr(!0),Yn?.(),An();let r=Gn(n);for(let e of r)Bn.get(e)?.cancel(),e.style.transform=``;B={from:e,to:e,keyboard:t,scope:n,nodes:r,grips:Kn(n),homes:r.map(e=>e.getBoundingClientRect()),offsets:T.map(()=>0),id:F().id,pointerId:null,startX:0},r[e].dataset.dragging=``,B.grips[e].dataset.dragging=``,Qn(0,!1)}function lr(e,t){let{nodes:n,grips:r,from:i,to:a,homes:o,id:s,scope:c}=B,l=e?0:o[a].left-o[i].left;if(e&&$n(i,!Wn()),B=null,delete n[i].dataset.dragging,delete r[i].dataset.dragging,Yn=()=>{Yn=null,!e&&a!==i&&F().id===s&&tr(i,a,c);for(let e of n)Bn.get(e)?.cancel(),e.style.transform=``;t?.()},Wn()){Yn();return}let u=n[i],d=u.style.transform,f=`translateX(${l}px) scale(1)`;u.style.transform=f;let p=u.animate([{transform:d},{transform:f}],{duration:In,easing:Rn});Bn.set(u,p),p.finished.then(()=>Yn?.(),()=>{})}function ur(e){let{from:t,to:n,scope:r}=B;if(n===t){lr(!0);return}let i=`Palette reordered. ${sr(t,n)}`;lr(!1,e?()=>Kn(r)[n].focus():null),Jn(r,i)}var dr=e=>e instanceof Element?e.closest(`[data-grip]`):null,fr=e=>e.closest(`.picker-bands`);function pr(e){e.addEventListener(`pointerdown`,e=>{let t=dr(e.target);!t||e.button!==0||!N.length||(e.preventDefault(),cr(T.indexOf(t.dataset.grip),!1,fr(t)),B.pointerId=e.pointerId,B.startX=e.clientX,t.setPointerCapture(e.pointerId))}),e.addEventListener(`pointermove`,e=>{if(!B||B.keyboard||e.pointerId!==B.pointerId)return;let{homes:t,from:n}=B,r=Math.min(t.at(-1).left-t[n].left,Math.max(t[0].left-t[n].left,e.clientX-B.startX));Qn(r,!1);let i=er(r);i!==B.to&&$n(i,!Wn())}),e.addEventListener(`pointerup`,e=>{!B||B.keyboard||e.pointerId!==B.pointerId||ur(!1)}),e.addEventListener(`pointercancel`,e=>{!B||B.keyboard||e.pointerId!==B.pointerId||lr(!0)}),e.addEventListener(`keydown`,e=>{let t=dr(e.target);if(!t||!zn.has(e.key)||!N.length)return;let n=fr(t),r=!!B?.keyboard,i=e.key===` `||e.key===`Enter`;if(!r&&(B||!i))return;if(e.preventDefault(),!r){cr(T.indexOf(t.dataset.grip),!0,n),Jn(n,`${qn(B.from,n)} color lifted, position ${B.from+1} of ${T.length}. Arrow keys move it, space drops it, escape puts it back.`);return}if(i){ur(!0);return}if(e.key===`Escape`){lr(!0),Jn(n,`Reorder cancelled.`);return}let a={ArrowLeft:-1,ArrowRight:1,Home:-T.length,End:T.length}[e.key],o=Math.min(T.length-1,Math.max(0,B.to+a));o!==B.to&&($n(o,!Wn()),Qn(B.homes[o].left-B.homes[B.from].left,!Wn()),Jn(n,`Position ${o+1} of ${T.length}.`))}),e.addEventListener(`focusout`,e=>{if(!B?.keyboard||e.target!==B.grips[B.from])return;let t=B.scope;lr(!0),Jn(t,`Reorder cancelled.`)})}pr(A),pr(Hn),A.onpointerover=A.onfocusin=({target:e})=>{let t=e.closest(`[data-band]`);t&&xn(t.dataset.band)},A.oninput=({target:e})=>{e.matches(`[data-color-input]`)&&En(e.dataset.colorInput,e.value)},A.onclick=async e=>{let t=e.target.closest(`button`)?.dataset;if(t){if(t.copyColor){let e=I().colors[t.copyColor];await navigator.clipboard.writeText(`${e}\n${l(e)}`);let n=t.tip;t.tip=`Copied`,setTimeout(()=>t.tip=n,1200)}else if(t.editTints)De===t.editTints?An():Fn(t.editTints);else if(t.customColor)D(`[data-color-input="${t.customColor}"]`,A).click();else if(t.tint)En(De,t.tint);else if(`closeTints`in t)An();else if(`reset`in t){let e=F(),t=Ve(e);e.type===`cue`&&e.defaultRings&&(t.rings=structuredClone(e.defaultRings)),M.set(e.id,t),jn()}else if(`selectPalette`in t){let e=F();D(`[name="palette-source"]`).value=e.id;for(let e of T)D(`[name="palette-${e}"]`).value=I().colors[e];ar(),Ar()}}},D(`[data-select-palette]`).addEventListener(`click`,A.onclick),D(`[data-deck-prev]`).onclick=()=>Mn(P-1),D(`[data-deck-next]`).onclick=()=>Mn(P+1);function mr(){let e=k.firstElementChild?.offsetHeight||0;if(!e)return!1;let t=P*e;return Math.abs(O.scrollTop-t)>1&&(O.scrollTop=t),!0}O.addEventListener(`scroll`,()=>{let e=k.firstElementChild?.offsetHeight||1,t=Math.min(N.length-1,Math.round(O.scrollTop/e));if(t!==P){let e=F().node;e.dataset.exit=t>P?`left`:`right`,setTimeout(()=>delete e.dataset.exit,280),P=t,delete F().node.dataset.exit,jn()}},{passive:!0}),document.addEventListener(`picker:screenchange`,e=>{Pn(e.detail.screen===`02`),e.detail.screen===`02`&&mr(),e.detail.screen===`04b`&&Gr();let t=document.querySelector(`.picker-screen[data-screen="${e.detail.screen}"]`);for(let e of t?.querySelectorAll(`[data-artboard]`)??[])qe(e);e.detail.screen===`03`&&(ar(),or());let n=Dr.find(t=>t.screen===e.detail.screen);if(n?.paint(),Or(n),e.detail.screen===`04`&&ut({force:!0}),e.detail.screen===`06`&&requestAnimationFrame(()=>{en(),Jt(),Gt=null,Kt(Wt())}),e.detail.screen===`05`){yt();let e=gt();requestAnimationFrame(()=>{e?.parentElement.scrollIntoView({block:`center`}),e?.focus({preventScroll:!0}),e&&bt(e),Ct()})}e.detail.screen===`11`&&(Lt(),requestAnimationFrame(()=>{Mt()?.parentElement.scrollIntoView({block:`center`})}))});var V=[...document.querySelectorAll(`input[name="surface-modes"]`)],hr=document.querySelector(`[data-modes-next]`),gr=()=>{hr&&(hr.disabled=!V.some(e=>e.checked))},_r=V.map(e=>e.closest(`.picker-mode-tile`)),vr=_r.map(e=>e?.querySelector(`.picker-preview`)),yr=ye.cloneNode(!0),br;function xr(){kr();let e=V.findIndex(e=>e.checked);_r.forEach((t,n)=>{t?.toggleAttribute(`data-lead`,n===e&&!!vr[n])});let t=(e===-1?null:vr[e])??yr;if(t===br)return;br=t;let n=t.cloneNode(!0);n.setAttribute(`aria-hidden`,`true`);for(let e of[n,...n.querySelectorAll(`[id]`)])e.removeAttribute(`id`);ye.replaceWith(n),ye=n,Ke()}var Sr=()=>V.filter(e=>e.checked),Cr=e=>V.find(t=>t.value===e),wr=document.querySelector(`input[name="_chosen"]`);function Tr(){if(!wr)return;let e=[...document.querySelectorAll(`input[type="hidden"][data-surface-field][data-chosen="yes"]`)].filter(e=>!e.disabled).map(e=>e.dataset.surfaceField);wr.value=JSON.stringify(e)}function Er(e){let t=e.dataset.surfaceTabs,n=e.parentElement,r=e.closest(`.picker-screen`)?.dataset.screen,i=`surfaceStage`in n.dataset,a=`surfaceFlat`in e.dataset,o=`surfaceProperName`in e.dataset,s=()=>[...document.querySelectorAll(`input[name="${t}"]`)],c=e=>s().find(t=>t.value===e)?.closest(`.picker-strategy-option`),l=e=>{let n=Cr(e)?.getAttribute(`data-allow-${t}`);return n==null?null:new Set(n.split(` `).filter(Boolean))},u=e=>Cr(e)?.getAttribute(`data-default-${t}`)||s()[0]?.value,d=e=>document.querySelector(`input[type="hidden"][data-surface-field="${t}-${e}"]`),f=e=>c(e)?.querySelector(`.picker-strategy-title`)?.textContent??e,p=e=>!!d(e),m=()=>Sr().filter(e=>p(e.value)),h=V.some(e=>!p(e.value)),g=e.closest(`.picker-screen`),_=null;function v(e){for(let e of n.querySelectorAll(`[data-surface]:not([data-artboard])`))e.remove();for(let t of e){if(n.querySelector(`[data-artboard][data-surface="${t.value}"]`))continue;let e=vr[V.indexOf(t)];if(!e)continue;let r=e.cloneNode(!0);r.setAttribute(`aria-hidden`,`true`);for(let e of[r,...r.querySelectorAll(`[id]`)])e.removeAttribute(`id`);r.dataset.surface=t.value,n.append(r)}y()}function y(){i&&qe(n,`pkc`)}function b(){let e=m();if(h){g?.toggleAttribute(`data-skip`,e.length===0);for(let t of s())t.disabled=e.length===0}i&&v(e);for(let e of V){let t=d(e.value);t&&(t.disabled=!e.checked,e.checked?t.value||=u(e.value)??``:(t.value=``,delete t.dataset.chosen))}ee(e),te(e.some(e=>e.value===_)?_:e[0]?.value)}function ee(t){e.hidden=t.length<2,e.replaceChildren(...t.map(e=>{let t=document.createElement(`button`);return t.type=`button`,t.className=`picker-surface-tab`,t.dataset.surfaceTab=e.value,t.innerHTML=`<span class="picker-surface-dot"></span>`,t.append(e.dataset.surfaceLabel??e.value),t.onclick=()=>ne(e.value),t})),x()}function x(){for(let t of e.children){let n=t.dataset.surfaceTab,r=d(n),i=!!r?.dataset.chosen,a=n===_,s=r.value?f(r.value):``,c=t.textContent;t.dataset.set=i?`yes`:`no`,t.setAttribute(`aria-pressed`,a?`true`:`false`),t.tabIndex=a?0:-1;let l=s&&e.dataset.surfaceAnswered.replace(`{}`,o?s:s.toLowerCase());t.setAttribute(`aria-label`,s?`${c}, ${l}${i?``:` by default`}`:`${c}, ${e.dataset.surfaceUnanswered}`)}}function te(e){if(!e)return;_=e;for(let t of n.querySelectorAll(`[data-surface]`))t.hidden=t.dataset.surface!==e;re();let t=d(e)?.value||u(e),r=s().find(e=>e.value===t);r&&(r.checked=!0),x()}function ne(e){te(e),Or(ae)}function re(){let e=l(_);for(let t of s()){let n=t.closest(`.picker-strategy-option`);if(!n)continue;let r=!e||e.has(t.value),i=n.querySelector(`.picker-strategy-desc`);i.dataset.copy??=i.textContent,i.textContent=r?i.dataset.copy:n.dataset.blockedReason??i.dataset.copy,n.classList.toggle(`is-blocked`,!r),t.disabled=!r}}document.addEventListener(`change`,({target:e})=>{e?.name!==t||!e.checked||ie(e.value)});function ie(e){let t=a?m().map(e=>e.value):[_];for(let n of t){let t=d(n),r=l(n);!t||r&&!r.has(e)||(t.value=e,t.dataset.chosen=`yes`)}x(),Tr()}e.addEventListener(`keydown`,t=>{let n={ArrowLeft:-1,ArrowRight:1}[t.key];if(!n)return;let r=[...e.children],i=r[(r.findIndex(e=>e.dataset.surfaceTab===_)+n+r.length)%r.length];t.preventDefault(),ne(i.dataset.surfaceTab),i.focus()});let ae={screen:r,sync:b,paint:y,park:e=>te(p(e)?e:m()[0]?.value),active:()=>_};return ae}var Dr=[...document.querySelectorAll(`[data-surface-tabs]`)].map(Er);function Or(e){for(let t of Dr)t!==e&&t.park(e?.active())}var kr=()=>{for(let e of Dr)e.sync();Tr()},Ar=()=>{for(let e of Dr)e.paint()},jr=document.querySelector(`.picker-screen[data-screen="04b"]`),Mr={"06":`motion-energy`,"08":`boundary-style`,"09":`corner-style`,10:`depth-style`,11:`icon-pack`},Nr=e=>V.find(t=>t.value===e)?.dataset.surfaceLabel??e;function Pr(e,t){let n=document.querySelector(`input[name="${e}"][value="${t}"]`);return n?n.dataset.scaleName?`${n.dataset.scaleName} · ${n.dataset.ratio}`:n.dataset.packName?n.dataset.packName:n.closest(`.picker-strategy-option`)?.querySelector(`.picker-strategy-title`)?.textContent.trim()??t:t}function Fr(e){return[...document.querySelectorAll(`input[type="hidden"][data-surface-field^="${e}-"]`)].filter(e=>!e.disabled&&e.value).map(t=>({mode:t.dataset.surfaceField.slice(e.length+1),value:t.value,chosen:t.dataset.chosen===`yes`}))}function Ir(e){let t=document.createElement(`span`);return t.className=`picker-hub-line`,t.append(e),t}function Lr(e,t){let n=document.querySelector(`input[name="${e}"][value="${t}"]`)?.closest(`.picker-strategy-option`)?.querySelector(`.picker-strategy-desc`);return n?(n.dataset.copy??n.textContent).trim():``}var Rr={strategy:`color-strategy`,boundary:`boundary-style`,corner:`corner-style`,depth:`depth-style`,layout:`layout-structure`};function zr(e){let t={surface:e};for(let[n,r]of Object.entries(Rr))t[n]=document.querySelector(`input[type="hidden"][data-surface-field="${r}-${e}"]`)?.value||document.querySelector(`input[name="${r}"]:checked`)?.value||``;return t}function Br(e,t=null){let n=document.createElement(`span`);if(n.className=`picker-hub-proof`,t){n.classList.add(`dcx-proof--board`);for(let[e,r]of Object.entries(t))r&&n.setAttribute(`data-dcx-${e}`,r);qe(n,`pkc`)}let r=e.cloneNode(!0);r.hidden=!1,r.removeAttribute(`data-surface`);for(let e of[r,...r.querySelectorAll(`[id]`)])e.removeAttribute(`id`);for(let e of[r,...r.querySelectorAll(`[data-icon-field], [data-icon-strip]`)])e.removeAttribute(`data-icon-sheet`),e.removeAttribute(`data-icon-field`),e.removeAttribute(`data-icon-strip`);return n.append(r),n}var Vr=(e,t)=>{let n=[...document.querySelectorAll(`.picker-screen[data-screen="${e}"] .picker-board-stage > :is(.picker-artboard, .picker-preview)[data-surface="${t}"]`)];if(n.length<2)return n[0]??null;let r=document.querySelector(`.picker-screen[data-screen="${e}"] [data-surface-tabs]`)?.dataset.surfaceTabs,i=r&&document.querySelector(`input[type="hidden"][data-surface-field="${r}-${t}"]`)?.value;return n.find(e=>e.dataset.motionCell===`${t}-${i}`)??n[0]};function Hr(e){let t=e.querySelector(`[data-hub-preview]`);if(!t||t.classList.contains(`picker-hub-preview--icons`))return;let n=t.firstElementChild,r=n?.querySelector(`.ps-desktop, .pv-desktop`)??n?.firstElementChild,i=t.clientWidth,a=t.clientHeight;if(!i||!a||!r?.offsetWidth||!r.offsetHeight)return;let o=Math.min(i/r.offsetWidth,a/r.offsetHeight);e.style.setProperty(`--pk-hub-scale`,o),e.style.setProperty(`--pk-hub-x`,`${(i-r.offsetWidth*o)/2}px`),e.style.setProperty(`--pk-hub-y`,`${(a-r.offsetHeight*o)/2}px`)}function Ur(e,t,n,r){let i=e.querySelector(`[data-hub-preview]`);if(i.classList.toggle(`picker-hub-preview--icons`,n===`icon-pack`),n===`icon-pack`){i.replaceChildren(Br(Dt)),!Et.querySelector(`.picker-icon-cell`)&&!(`empty`in Et.dataset)&&Lt().then(Gr);return}let a=r?Vr(t,r):null;if(!a){i.replaceChildren();return}if(n===`motion-energy`){Dr.find(e=>e.screen===t)?.park(r);let n=Br(a);qe(n.firstChild),i.replaceChildren(n),requestAnimationFrame(()=>{Jt(n.firstChild),Hr(e)})}else i.replaceChildren(Br(a,zr(r)));Hr(e)}function Wr(e){let t=e.querySelector(`[data-hub-target]`),n=t?.dataset.hubTarget,r=Mr[n];if(!r)return;let i=e.querySelector(`[data-hub-preview]`),a=e.querySelector(`[data-hub-note]`),o=e.querySelector(`[data-hub-slider]`),s=e.querySelector(`[data-hub-slider-label]`),c=!!document.querySelector(`.picker-screen[data-screen="${n}"]`)?.hasAttribute(`data-skip`);if(e.classList.toggle(`is-skipped`,c),t.disabled=c,t.setAttribute(`aria-disabled`,c?`true`:`false`),c){i.replaceChildren(),a.replaceChildren(Ir(`Not asked of these surfaces`)),a.hidden=!1,o.hidden=!0;return}let l=Fr(r),u=l.map(e=>e.mode),d=u.includes(e.dataset.hubSurface)?e.dataset.hubSurface:u[0];e.dataset.hubSurface=d??``;let f=d?l.find(e=>e.mode===d)?.value:document.querySelector(`input[name="${r}"]:checked`)?.value,p=f?Lr(r,f):``;a.textContent=p,a.hidden=!p;let m=document.createElement(`span`);m.className=`picker-hub-slider-value`,m.textContent=f?Pr(r,f):``,s.replaceChildren(...d?[`${Nr(d)} · `,m]:[m]),o.hidden=!1;for(let e of o.querySelectorAll(`[data-hub-step]`))e.hidden=u.length<2;Ur(e,n,r,d)}function Gr(){if(jr)for(let e of jr.querySelectorAll(`.picker-hub-card`))Wr(e)}function Kr(e,t){let n=Mr[(e?.querySelector(`[data-hub-target]`))?.dataset.hubTarget];if(!n)return;let r=Fr(n).map(e=>e.mode);if(r.length<2)return;let i=r.indexOf(e.dataset.hubSurface);e.dataset.hubSurface=r[(i+t+r.length)%r.length],Wr(e)}jr?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-hub-step]`);if(t){Kr(t.closest(`.picker-hub-card`),Number(t.dataset.hubStep));return}let n=e.target.closest(`[data-hub-target]`);!n||n.disabled||document.dispatchEvent(new CustomEvent(`picker:goto`,{detail:{screen:n.dataset.hubTarget}}))}),jr?.addEventListener(`keydown`,e=>{let t={ArrowLeft:-1,ArrowRight:1}[e.key];!t||!e.target.closest(`[data-hub-slider]`)||(e.preventDefault(),Kr(e.target.closest(`.picker-hub-card`),t))}),jr&&window.ResizeObserver&&new ResizeObserver(()=>{for(let e of jr.querySelectorAll(`.picker-hub-card`))Hr(e)}).observe(jr);for(let e of V)e.addEventListener(`change`,()=>{gr(),xr()});gr(),xr();try{let e=e=>fetch(e).then(e=>e.ok?e.json():Promise.reject()),[t,n,r]=await Promise.all([e(`/cues.json`),e(`/palettes.json`),fetch(`/context.json`).then(e=>e.ok?e.json():null).catch(()=>null)]),i=Array.isArray(r?.modes)?r.modes:t.modes;if(Array.isArray(i)){let e=new Set(i);if(V.some(t=>e.has(t.value))){for(let t of V)t.checked=e.has(t.value);gr(),xr()}}N=[...t.cues.map(e=>({id:e,type:`cue`,palette:t.palette[e]})),...n.seeds.map(e=>({...e,type:`seed`}))];for(let e of N)M.set(e.id,Ve(e));me.append(...N.map(kn)),k.innerHTML=`<div class="picker-snap-point"></div>`.repeat(N.length),D(`[data-select-palette]`).disabled=!1,jn(),Pn(E.hasAttribute(`data-active`))}catch{he.textContent=`Palette sources could not be loaded.`}var qr=Ie,Jr=!0;try{let e=await fetch(`/fonts.json`),t=e.ok?await e.json():null;Xe(t)&&(qr=Ye(t),Jr=!1)}catch{}it(qr,Jr);var Yr=await x();try{C(Yr.prior,{modeInputs:V,syncModes:()=>{gr(),xr()},states:M,cards:N,setCurrent:e=>{P=e},render:jn,syncDeckScroll:mr,fontManifest:()=>Oe,pairNodes:()=>[...tt],addPairCard:nt,removePairCard:rt,loadCustomFace:bn,syncFontPair:et,applyHoist:ut,syncChosenField:Tr})}catch{}re(Yr.prior?Yr.priorSource:null);var H=(e,t=document)=>t.querySelector(e),Xr=(e,t=document)=>[...t.querySelectorAll(e)],U=H(`#picker-form`),Zr=H(`[data-dcx-shell]`),Qr=null,$r=null,ei=null,ti=null,ni=e=>fetch(e).then(e=>e.ok?e.json():null).catch(()=>null),ri=ni(`/cues.json`).then(e=>(ei=e?.palette||null,ti=Array.isArray(e?.cues)?e.cues:null,e)),ii=Promise.all([ni(`/context.json`),ri]).then(([e,t])=>{Qr=e?.context??t?.context??null;let n=Array.isArray(e?.modes)?e.modes:t?.modes;$r=Array.isArray(n)?n:null}),ai=!1,oi=e=>X?`${X.base}/cue.png?token=${encodeURIComponent(X.token)}`:ai?`/cue.png`:`/cues/${encodeURIComponent(e)}.png`,si=(e,t)=>{let n=ei?.[e]?.[t];return n?String(n.snapped||n.hex||``).toUpperCase():``},ci=[`primary`,`secondary`,`tertiary`,`neutral`],li=[`persuade`,`operate`,`read`,`experience`],ui={persuade:`Landing page`,operate:`Tool`,read:`Docs`,experience:`Portfolio`},di=[`color-strategy`,`boundary-style`,`corner-style`,`depth-style`,`motion-energy`],W=e=>{let t=U.elements[e];return t&&typeof t.value==`string`?t.value:``};function fi(e,t){let n=U.querySelector(`input[name="${e}"][value="${t}"]`)?.closest(`label`);if(!n)return{title:t,desc:``};let r=n.querySelector(`.picker-strategy-title, .picker-icon-title`),i=n.querySelector(`.picker-strategy-desc, .picker-icon-meta`);return{title:(r?.textContent||t).replace(/^[\d.]+\s*/,``).trim(),desc:(i?.textContent||``).trim()}}function pi(){return Xr(`input[name="surface-modes"]:checked`,U).sort((e,t)=>li.indexOf(e.value)-li.indexOf(t.value)).map(e=>{let t=e.closest(`.picker-mode-tile`);return{mode:e.value,label:e.dataset.surfaceLabel||e.value,goal:t?.querySelector(`.picker-mode-goal`)?.textContent.trim()||``,examples:Xr(`.picker-mode-pills i`,t||U).map(e=>e.textContent.trim())}})}function mi(e,t){return t.flatMap(t=>{let n=U.querySelector(`input[data-surface-field="${e}-${t.mode}"]`);if(!n)return[];let r=n.value||W(e);return[{...t,value:r,chosen:n.dataset.chosen===`yes`,...fi(e,r)}]})}function hi(e,t){let[n]=mi(e,t);return n??{value:``,title:``,desc:``}}function gi(){let e=pi(),t=ci.map(e=>({role:e[0].toUpperCase()+e.slice(1),hex:W(`palette-${e}`).toUpperCase()})).filter(e=>e.hex),n=U.querySelector(`input[name="type-scale"]:checked`),r=U.querySelector(`input[name="font-pair"]:checked`)?.closest(`.picker-type-option`);return{context:Qr,suggestedModes:$r,cueSlugs:ti,surfaces:e,palette:t,paletteSource:W(`palette-source`),strategy:mi(`color-strategy`,e),boundaries:mi(`boundary-style`,e),corners:mi(`corner-style`,e),depth:mi(`depth-style`,e),motion:mi(`motion-energy`,e),layout:hi(`layout-structure`,e),fonts:{heading:W(`font-heading`),body:W(`font-body`),headingSource:W(`font-heading-source`),bodySource:W(`font-body-source`),why:r?.querySelector(`[data-pair-why]`)?.textContent.trim()||``},scale:{name:n?.dataset.scaleName||``,ratio:Number(W(`type-scale-ratio`)||n?.dataset.ratio||0),desc:n?fi(`type-scale`,n.value).desc:``},icons:{pack:W(`icon-pack-name`),license:W(`icon-pack-license`),url:W(`icon-pack-url`)}}}var _i=e=>{let t=String(e),n=t.split(/\s/)[0]||``;return!/^[a-z]/.test(t)||/[A-Z]/.test(n)?t:t[0].toUpperCase()+t.slice(1)},G=e=>String(e).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`),vi=(e,t,n,r)=>`
  <header>
  ...
  <ul class="dcx-list">${e.map(e=>`<li>${e}</li>`).join(``)}</ul>`,xi=e=>`
  <ol class="dcx-principles">${e.map(e=>e&&typeof e==`object`&&e.title?`<li><strong>${G(e.title)}</strong>${e.detail?` &mdash; ${G(e.detail)}`:``}</li>`:`<li>${G(e)}</li>`).join(``)}</ol>`,Si=e=>`
  <div class="dcx-chips">${e.map(e=>`<span class="dcx-chip dcx-chip--muted">${G(e)}</span>`).join(``)}</div>`,Ci=(e,t)=>`
  <div class="dcx-empty">
    <p class="dcx-empty-title">${G(e)}</p>
    <p>${t}</p>
  </div>`,J=e=>`<p class="dcx-fan-note">${e}</p>`,wi=(e,t)=>Ci(`Captured in chat`,`${e} in chat, before the browser questionnaire. ${t} is the durable copy.`),Ti=e=>X?`${X.base}/brand-assets/${encodeURIComponent(e)}?token=${encodeURIComponent(X.token)}`:`/brand-assets/${encodeURIComponent(e)}`;document.addEventListener(`load`,e=>{let t=e.target;if(!(t instanceof HTMLImageElement)||!(`dcxCueImg`in t.dataset))return;let n=t.closest(`.dcx-cue-frame`);n&&(n.style.setProperty(`--cue-w`,String(t.naturalWidth||1)),n.style.setProperty(`--cue-h`,String(t.naturalHeight||1)),n.dataset.loaded=`yes`)},!0),document.addEventListener(`error`,e=>{let t=e.target;if(!(t instanceof HTMLImageElement))return;if(t.dataset.dcxSwapSrc){let e=t.dataset.dcxSwapSrc;delete t.dataset.dcxSwapSrc,t.dataset.dcxSwapAlt&&(t.alt=t.dataset.dcxSwapAlt,delete t.dataset.dcxSwapAlt),t.src=e;return}let n=t.closest(`[data-dcx-hide-on-error]`);n&&(n.hidden=!0)},!0);function Ei(e){let[t,n,r]=[1,3,5].map(t=>parseInt(e.slice(t,t+2),16)/255);return .2126*t+.7152*n+.0722*r>.55?`oklch(20% 0.01 95)`:`oklch(95% 0.005 95)`}function Di(e){let t={};for(let e of ci)t[e]=W(`palette-${e}`);if(Object.values(t).some(e=>!e))return;let n=(t,n)=>e.style.setProperty(`--pkc-${t}`,n);for(let e of ci)n(e,t[e]);n(`n-ink`,p(t.neutral)),n(`p-ink`,p(t.primary)),n(`t-ink`,p(t.tertiary)),n(`s-on-n`,_(t.secondary,t.neutral)),n(`p-on-n`,_(t.primary,t.neutral)),n(`t-on-n`,_(t.tertiary,t.neutral)),n(`t-on-p`,_(t.tertiary,t.primary)),n(`p-on-p`,_(t.primary,t.primary)),n(`t-on-t`,_(t.tertiary,t.tertiary)),n(`p-on-i`,_(t.primary,m(t.primary)))}var Oi={sharp:{control:`0px`,surface:`0px`},"slightly-soft":{control:`4px`,surface:`6px`},friendly:{control:`10px`,surface:`14px`},pill:{control:`999px`,surface:`18px`}},ki={flat:{card:`none`,control:`none`,surface:`none`},"soft-lift":{card:`0 1px 1px rgb(0 0 0 / 0.15), 0 3px 7px rgb(0 0 0 / 0.14)`,control:`0 1px 2px rgb(0 0 0 / 0.24)`,surface:`0 2px 5px rgb(0 0 0 / 0.14)`},floating:{card:`0 2px 3px rgb(0 0 0 / 0.2), 0 9px 18px rgb(0 0 0 / 0.24)`,control:`0 3px 6px rgb(0 0 0 / 0.32)`,surface:`0 6px 14px rgb(0 0 0 / 0.22)`}},Ai=/serif|mincho|baskerville|bitter|marcellus|slab|antiqua|garamond|didot|bodoni/i,ji=e=>`"${e.replaceAll(`"`,`\\"`)}", ${Ai.test(e)?`serif`:`sans-serif`}`;function Mi(e,t){let n=Oi[t.corners[0]?.value],r=ki[t.depth[0]?.value];if(!t.fonts.heading||!t.fonts.body||!n||!r)return!1;let i=(t,n)=>e.style.setProperty(`--pkc-${t}`,n);return i(`font-heading`,ji(t.fonts.heading)),i(`font-body`,ji(t.fonts.body)),i(`font-heading-weight`,document.querySelector(`input[name="font-pair"]:checked`)?.closest(`.picker-type-option`)?.style.getPropertyValue(`--pair-heading-weight`)||`400`),i(`radius-control`,n.control),i(`radius-surface`,n.surface),i(`shadow-card`,r.card),i(`shadow-control`,r.control),i(`shadow-surface`,r.surface),t.scale.ratio&&i(`scale-ratio`,String(t.scale.ratio)),!0}function Y(e,{strategy:t=``,kind:n=`board`,marks:r=null}={}){if(!e)return``;let i=e.cloneNode(!0);i.hidden=!1;let a=e.getAttribute(`data-surface`)||``;i.removeAttribute(`data-surface`);for(let e of[i,...i.querySelectorAll(`[id]`)])e.removeAttribute(`id`);for(let e of Xr(`button, input`,i))e.setAttribute(`tabindex`,`-1`),e.setAttribute(`disabled`,``);let o=document.createElement(`div`);if(o.className=`dcx-proof dcx-proof--${n}`,o.setAttribute(`aria-hidden`,`true`),t&&(o.dataset.dcxStrategy=t),r)for(let[e,t]of Object.entries(r))t&&o.setAttribute(`data-dcx-${e}`,t);return a&&!o.hasAttribute(`data-dcx-surface`)&&o.setAttribute(`data-dcx-surface`,a),Di(o),o.appendChild(i),o.outerHTML}var Ni=e=>H(`[data-surface-stage] [data-surface="${e}"]`),Pi=e=>H(`input[name="surface-modes"][value="${e}"]`)?.closest(`.picker-mode-tile`)?.querySelector(`.picker-preview`),Fi=(e,t)=>H(`[data-question="${e}"] .picker-board-stage > :is(.picker-artboard, .picker-preview)[data-surface="${t}"]`),Ii=e=>Fi(`boundaries`,e),Li=(e,t)=>H(`[data-question="motion"] .picker-board-stage > :is(.picker-artboard, .picker-preview)[data-motion-cell="${e}-${t}"]`),Ri=(e,t)=>({surface:t,boundary:e.boundaries.find(e=>e.mode===t)?.value||``,corner:e.corners.find(e=>e.mode===t)?.value||``,depth:e.depth.find(e=>e.mode===t)?.value||``,layout:e.layout.value||``}),zi=e=>yi(e.map(e=>({dt:G(e.label),dd:`<strong>${G(e.title)}</strong> &middot; ${G(e.desc)}${e.chosen?``:` <em>(default for this surface)</em>`}`})));function Bi(e,t){let n=e.context?.audience||{},r=[vi(1,`Audience`,`Who it is for, emotional state, needs, trust triggers.`,t)],i=[n.primary&&{dt:`Primary`,dd:G(n.primary)},n.secondary&&{dt:`Secondary`,dd:G(n.secondary)}].filter(Boolean);if(r.push(K(`Who they are`,i.length?yi(i):wi(`The primary and secondary user read was confirmed`,`<code>PRODUCT.md &middot; Users</code>`))),n.emotion||n.leaving){let e=n.emotion?q(`On arrival`,G(n.emotion),!0):``,t=n.leaving?q(`Leaving with`,G(n.leaving),!0):``;e&&t?r.push(K(`Emotional journey`,`<div class="dcx-callout-pair">${e}${t}</div>`)):r.push(K(e?`Emotional state`:`Emotional journey`,e||t))}let a=Array.isArray(n.needs)&&n.needs.length?K(`Needs`,bi(n.needs.map(G))):``,o=Array.isArray(n.trust)&&n.trust.length?K(`Trust triggers`,bi(n.trust.map(G))):``;return a&&o?r.push(`<div class="dcx-cols">${a}${o}</div>`):(a||o)&&r.push(a||o),Array.isArray(n.inclusion)&&n.inclusion.length&&r.push(K(`Who must not be excluded`,bi(n.inclusion.map(G)))),r.join(``)}function Vi(e,t){return`<div class="dcx-surfaces" data-count="${e.surfaces.length}">${e.surfaces.map((e,n)=>`
    <article class="dcx-surface-card">
      ${Y(Ni(e.mode)||Pi(e.mode),{kind:`board`})}
      <div class="dcx-surface-copy">
        <h3 class="dcx-surface-name">${G(e.label)}${n===0?` <span class="dcx-default-mark">leading</span>`:``}</h3>
        ${t(e)}
      </div>
    </article>`).join(``)}</div>`}function Hi(e){if(!Array.isArray(e.suggestedModes)||!e.suggestedModes.length)return``;let t=e.surfaces.map(e=>e.mode),n=new Set(e.suggestedModes),r=new Set(t),i=t=>e.surfaces.find(e=>e.mode===t)?.label||ui[t]||t,a=t.filter(e=>!n.has(e)),o=e.suggestedModes.filter(e=>!r.has(e)),s=`you kept the suggested set`;return a.length&&o.length?s=`you added ${a.map(i).join(`, `)} and dropped ${o.map(i).join(`, `)}`:a.length?s=`you added ${a.map(i).join(`, `)}`:o.length&&(s=`you dropped ${o.map(i).join(`, `)}`),J(`Suggested from <code>PRODUCT.md</code>: ${e.suggestedModes.map(i).join(`, `)}; ${s}.`)}var Ui={web:`Web`,ios:`iOS`,android:`Android`,adaptive:`Adaptive`};function Wi(e,t){let n=e.context?.product||{},r=[vi(2,`Product`,`Purpose, surfaces, use cases, what must be clear first.`,t)],i=n.purpose?q(n.name||t||`This product`,G(n.purpose),!1,n.success?`\n    <p class="dcx-callout-success">${G(n.success)}</p>`:``):wi(`The purpose and success definition were confirmed`,`<code>PRODUCT.md &middot; Product Purpose</code>`),a=typeof n.platform==`string`&&n.platform.trim()?`<span class="dcx-chip dcx-platform-pill">${G(Ui[n.platform.trim()]||n.platform.trim())}</span>`:``;if(r.push(K(`Purpose`,a?`<div class="dcx-purpose"><div class="dcx-purpose-main">${i}</div>${a}</div>`:i)),n.positioning&&(n.positioning.not||n.positioning.this)){let e=[n.positioning.not&&q(`Not this`,G(n.positioning.not)),n.positioning.this&&q(`This`,G(n.positioning.this),!0)].filter(Boolean).join(``);r.push(K(`Positioning`,`<div class="dcx-callout-pair">${e}</div>`))}n.conversion&&r.push(K(`Primary conversion`,q(`The one action`,G(_i(n.conversion)),!0))),Array.isArray(n.clarities)&&n.clarities.length&&r.push(K(`What must be clear first`,bi(n.clarities.map(G)))),Array.isArray(n.principles)&&n.principles.length&&r.push(K(`Product principles`,xi(n.principles))),n.operatingContext&&r.push(K(`Operating context`,`<p class="dcx-prose">${G(n.operatingContext)}</p>`));let o=n.surfaces&&typeof n.surfaces==`object`?n.surfaces:{};return r.push(K(`Surfaces`,Vi(e,e=>`
      <p class="dcx-surface-goal">${G((typeof o[e.mode]==`string`?o[e.mode].trim():``)||e.goal||``)}</p>
      ${e.examples.length?Si(e.examples):``}`)+Hi(e)+J(`Chosen on the questionnaire&rsquo;s first screen, drawn in the committed palette; the leading surface owns every bare answer key in the sections that follow.`))),r.join(``)}function Gi(e,t){let n=e.context?.brand||{},r=e.context?.interview||{},i=[vi(3,`Brand`,`Identity, voice, references, taste boundaries.`,t)];i.push(K(`Personality`,n.personality?q(n.words?.join(` · `)||`Voice`,G(n.personality),!0):Array.isArray(n.words)&&n.words.length?q(n.words.join(` · `),`Three words, voice, and tone were confirmed in chat, before the browser questionnaire. <code>PRODUCT.md &middot; Brand Personality</code> is the durable copy.`,!0):wi(`Three words, voice, and tone were confirmed`,`<code>PRODUCT.md &middot; Brand Personality</code>`)));let a=(Array.isArray(n.voice)?n.voice:[]).filter(e=>e&&typeof e==`object`&&e.say&&e.not);if(a.length&&i.push(K(`Voice`,`<div class="dcx-voice">${a.map(e=>`
      ...
      <figure class="dcx-mark" data-dcx-hide-on-error>
        <div class="dcx-mark-pair">
          <span class="dcx-mark-chip"${p(`Primary`)?` style="--chip-ground:${p(`Primary`)};"`:``}><img src="${Ti(e.file)}" alt="${G(e.file)} on the primary color" /></span>
          <span class="dcx-mark-chip"${p(`Neutral`)?` style="--chip-ground:${p(`Neutral`)};"`:``}><img src="${Ti(e.file)}" alt="${G(e.file)} on the neutral color" /></span>
        </div>
        ${f(e)}
      ...
      <figure class="dcx-board" data-dcx-hide-on-error>
        <span class="dcx-board-frame"><img src="${Ti(e.file)}" alt="${G(e.file)}" loading="lazy" /></span>
        ${f(e)}
      </figure>`).join(``)}</div>`+J(`Boards and reference images provided in chat, staged in <code>.impeccable/design-context/assets/</code>.`))),l.length&&i.push(K(`Assets provided`,bi(l.map(e=>G(typeof e==`string`?e:e.note||e.file||``)))+J(`Gathered before the interview; the questions were grounded in what they showed.`))),i.join(``)}var Ki={Primary:`Your main brand color: buttons, links, the color people remember.`,Secondary:`Supports the primary: section accents, hovers, secondary buttons.`,Tertiary:`The rare accent: badges, highlights, one detail per screen.`,Neutral:`Backgrounds and large surfaces: most of every page.`};function qi(e,t){let n=e.context?.interview||{},r=[vi(4,`Color`,`Palette, roles, per-surface strategy, copyable values.`,t)],i=Array.isArray(e.cueSlugs)?e.cueSlugs:[],a=e.paletteSource&&(ai||i.includes(e.paletteSource))?e.paletteSource:``;if(a&&e.palette.length){let t=ei?.[a]||{},n=ci.map(e=>{let n=t[e];if(!n||!Array.isArray(n.at)||n.at.length!==2)return``;let r=String(n.snapped||n.hex||``);return`<span class="dcx-cue-dot" data-role="${e}" style="--at-x:${Number(n.at[0])||0}; --at-y:${Number(n.at[1])||0};${r?` --dot-fill:${G(r)};`:``}"></span>`}).join(``),o=e.palette.map(e=>`
      <div class="dcx-cue-role">
        ...
        <figure class="dcx-cue-frame">
          <img data-dcx-cue-img src="${oi(a)}" alt="The chosen visual cue, ${G(a)}" />
          ${n}
        </figure>
      ...
      <button class="dcx-fan-panel" type="button" data-copy-color="${e.hex}" data-color-name="${G(e.role)}"
        style="--panel-left:${n*t}%; --panel-z:${n+1}; --panel-swatch:${e.hex}; --panel-ink:${Ei(e.hex)};"
      ...
      <div class="dcx-swatch" data-role="${t.role.toLowerCase()}">
        <button class="dcx-swatch-chip" type="button" data-copy-color="${t.hex}" data-color-name="${G(t.role)}"
          style="--swatch:${t.hex}; --swatch-ink:${Ei(t.hex)};" aria-label="Copy ${G(t.role)} ${t.hex}">
      ...
      <article class="dcx-surface-card">
        ${Y(Ni(e.mode)||Pi(e.mode),{strategy:e.value,kind:`board`})}
        <div class="dcx-surface-copy">
      ...
      </article>`).join(``)}</div>`+J(`How much of each surface the palette is allowed to carry, drawn the way the strategy screen previewed it. Options a surface cannot take were withheld there.`)))}else r.push(K(`Palette`,Ci(`No palette committed`,`The palette screen was not completed on this run.`))),r.push(K(`Strategy per surface`,zi(e.strategy)));return(n.colorStrategy||n.hueAnchor)&&r.push(K(`Interview direction`,yi([n.colorStrategy&&{dt:`Strategy asked for`,dd:G(n.colorStrategy)},n.hueAnchor&&{dt:`Hue anchor`,dd:G(n.hueAnchor)}].filter(Boolean))+J(`Q1 of the seed interview. The cues were generated from this; the picks above are the decision.`))),r.join(``)}function Ji(e,t){let n=e.context?.interview||{},r=[vi(5,`Typography`,`Font families, type scale, hierarchy.`,t)];return e.fonts.heading?r.push(K(`The pair`,`<div class="dcx-pair">
      ...
      <p class="dcx-pair-why" style="font-family:'${G(e.fonts.body)}', sans-serif;">${G(e.fonts.why||`Chosen on the font pair screen against every surface this product ships.`)}</p>`)):r.push(K(`The pair`,Ci(`No pair selected`,`The font pair screen was not completed on this run.`))),e.scale.ratio&&(r.push(K(`Type scale`,`<p class="dcx-scale-head"><strong>${G(e.scale.name)}</strong> &middot; ratio <code>${e.scale.ratio.toFixed(3)}</code> on a 16px base. ${G(e.scale.desc)}</p>`+Y(H(`[data-scale-sheet]`),{kind:`scale`})+J(`The scale screen&rsquo;s sheet, kept at rendered size in the chosen faces. Values at a 16px base.`))),r.push(K(`In running text`,Y(H(`[data-scale-specimen]`),{kind:`specimen`})+J(`The same scale on the components a page is built from &mdash; headings, ledes, lists, quotes, code.`)))),n.typeDirection&&r.push(K(`Interview direction`,q(`Direction asked for`,G(n.typeDirection))+J(`Q2 of the seed interview. All six candidate pairs were composed inside this direction.`))),r.join(``)}function Yi(e,t){let n=[vi(6,`Iconography`,`Icon library, license, where it lives.`,t)];if(e.icons.pack){let t=H(`[data-icon-sheet]`),r=t?.querySelector(`.picker-icon-cell`)?Y(t,{kind:`icons`}):``;r&&n.push(K(`The hand`,r+J(`${G(e.icons.pack)}&rsquo;s canonical set, as the icons screen previewed it. One pack, one hand: no mixed sets.`)));let i=U.querySelector(`input[name="icon-pack"]:checked`)?.closest(`label`),a=i?.querySelector(`.picker-strategy-desc`)?.textContent.trim()||``,o=i?.querySelector(`.picker-icon-meta`)?.textContent.trim()||``;n.push(K(`Library`,yi([{dt:`Pack`,dd:`<strong>${G(e.icons.pack)}</strong>${o?` &middot; ${G(o)}`:``}`},a?{dt:`Why this hand`,dd:G(a)}:null,e.icons.license?{dt:`License`,dd:G(e.icons.license)}:null,e.icons.url?{dt:`Home`,dd:`<a href="${G(e.icons.url)}" target="_blank" rel="noopener">${G(e.icons.url)}</a>`}:null].filter(Boolean))+J(`Chosen on the icons screen. The pack names the hand; stroke weight and metaphor rules resolve during implementation.`)))}else n.push(K(`Library`,Ci(`No pack selected`,`The icons screen was not completed on this run.`)));return n.join(``)}var Xi=(e,t=null)=>`<div class="dcx-picks" data-count="${e.length}">${e.map(e=>`
  <article class="dcx-pick${t?` dcx-pick--proof`:``}">
  ...
  </article>`).join(``)}</div>`;function Zi(e,t){let n=e.context?.interview||{},r=[vi(7,`Material`,`Motion, layout structure, boundaries, corners, depth.`,t)],i=e.surfaces.map(t=>{let n=Ii(t.mode);return n?`
    <article class="dcx-surface-card">
      ${Y(n,{strategy:e.strategy.find(e=>e.mode===t.mode)?.value||``,kind:`board`,marks:Ri(e,t.mode)})}
      <div class="dcx-surface-copy">
        <h3 class="dcx-surface-name">${G(t.label)}</h3>
      </div>
    </article>`:``}).filter(Boolean);return i.length&&r.push(K(`The page, as chosen`,`<div class="dcx-surfaces" data-count="${i.length}">${i.join(``)}</div>`+J(`Each surface&rsquo;s page anatomy carrying every structural answer below at once, the way the question screens accumulated them: color strategy, layout, boundaries, corners, depth.`))),e.motion.length?r.push(K(`Motion per surface`,Xi(e.motion,t=>Y(Li(t.mode,t.value),{kind:`board`,marks:Ri(e,t.mode)}))+J(n.motionEnergy?`The seed interview asked for <strong>${G(n.motionEnergy)}</strong>; the motion screen answered it per surface above.`:`Asked of the landing page and the portfolio only. A tool and a document are moved through rather than watched, so their movement follows the interface rather than a house style.`))):r.push(K(`Motion`,Ci(`Not asked on this run`,`The motion screen is shown for a landing page and a portfolio. This run has neither, so no motion energy was chosen and none is recorded.`))),e.layout.value&&r.push(K(`Layout structure`,q(e.layout.title,G(e.layout.desc))+J(`Asked of the landing page and the portfolio, where the composition of the page is itself the decision. One answer is kept for the run, and every surface is drawn on it.`))),r.push(K(`Boundaries per surface`,Xi(e.boundaries,t=>Y(Fi(`boundaries`,t.mode),{kind:`board`,marks:Ri(e,t.mode)}))+J(`How sections separate on each surface.`))),r.push(K(`Corners per surface`,Xi(e.corners,t=>Y(Fi(`corners`,t.mode),{kind:`board`,marks:Ri(e,t.mode)}))+J(`How round shapes are on each surface.`))),r.push(K(`Depth per surface`,Xi(e.depth,t=>Y(Fi(`depth`,t.mode),{kind:`board`,marks:Ri(e,t.mode)}))+J(`How far off the page things sit on each surface.`))),r.join(``)}function Qi(e,t){let n=[vi(8,`Interface`,`Per-surface decisions at a glance, component status.`,t)];n.push(K(`Decisions per surface`,`<div class="dcx-surfaces" data-count="${e.surfaces.length}">${e.surfaces.map(t=>{let n=e.strategy.find(e=>e.mode===t.mode)?.value||``,r=Ii(t.mode),i=[[`Color strategy`,e.strategy.find(e=>e.mode===t.mode)],[`Boundaries`,e.boundaries.find(e=>e.mode===t.mode)],[`Corners`,e.corners.find(e=>e.mode===t.mode)],[`Depth`,e.depth.find(e=>e.mode===t.mode)],[`Motion`,e.motion.find(e=>e.mode===t.mode)],[`Layout`,e.layout.value?e.layout:void 0]];return`
    <article class="dcx-surface-card">
      ${r?Y(r,{strategy:n,kind:`board`,marks:Ri(e,t.mode)}):Y(Ni(t.mode)||Pi(t.mode),{strategy:n,kind:`board`})}
      <div class="dcx-surface-copy">
        <h3 class="dcx-surface-name">${G(t.label)}</h3>
    ...
    </article>`}).join(``)}</div>`+J(`Each surface&rsquo;s anatomy carrying its committed answers, with every per-surface decision beneath it.`)));let r=[e.fonts.heading?{dt:`Faces`,dd:`<strong>${G(e.fonts.heading)}</strong> for headings, <strong>${G(e.fonts.body)}</strong> for body`}:null,e.scale.ratio?{dt:`Type scale`,dd:`<strong>${G(e.scale.name)}</strong> &middot; ratio <code>${e.scale.ratio.toFixed(3)}</code> on a 16px base`}:null,e.icons.pack?{dt:`Icons`,dd:`<strong>${G(e.icons.pack)}</strong>${e.icons.license?` &middot; ${G(e.icons.license)}`:``}`}:null,e.palette.length?{dt:`Palette`,dd:e.palette.map(e=>`<code>${e.hex}</code>`).join(` &middot; `)}:null,e.layout.value?{dt:`Layout`,dd:`<strong>${G(e.layout.title)}</strong>, one answer for the run`}:null].filter(Boolean);return r.length&&n.push(K(`The kit`,yi(r)+J(`The tokens the seed DESIGN.md will carry in its frontmatter, gathered from their own pages in this document.`))),n.push(K(`Components`,Ci(`No component library seeded yet`,`Components are documented on the first scan pass, once there is code to capture actual tokens and states from. Re-run <code>/impeccable document</code> then.`))),n.join(``)}var $i={audience:Bi,product:Wi,brand:Gi,color:qi,typography:Ji,iconography:Yi,material:Zi,interface:Qi},ea={persuade:`A public-facing page that introduces the experience and guides visitors toward its primary action.`,operate:`A working surface for completing tasks, where familiar patterns and a predictable layout come first.`,read:`A reading surface for understanding, where type, structure, and pacing carry the page.`,experience:`A project-led page for presenting selected work, its context, and its outcomes.`};function ta(){let e=gi();window.dcxSurfaceDefs=e.surfaces.map(e=>({label:e.label,description:ea[e.mode]||e.goal||``}));let t=e.context?.product?.name||``,n=Array.isArray(e.cueSlugs)?e.cueSlugs:[],r=e.paletteSource&&(ai||n.includes(e.paletteSource))?e.paletteSource:``;window.dcxCueImageSrc=r?oi(r):``,window.dcxProductName=t;let i=ci.every(e=>W(`palette-${e}`));document.body.classList.toggle(`dcx-palette-live`,i),i&&Di(document.body),document.body.classList.toggle(`dcx-kit-live`,Mi(document.body,e));for(let[n,r]of Object.entries($i)){let i=document.getElementById(`dcx-detail-${n}`);i.innerHTML=`<article class="dcx-article">${r(e,t)}</article>`}t&&(document.title=`Design context — ${t}`)}var na=e=>new Promise(t=>setTimeout(t,e));function ra(){let e={};for(let[t,n]of new FormData(U))e[t]=t in e?Array.isArray(e[t])?[...e[t],n]:[e[t],n]:n;let t=[].concat(e[`surface-modes`]||[]),n=li.filter(e=>t.includes(e));for(let t of di){if(!(t in e))continue;let r=n.find(n=>e[`${t}-${n}`]);r&&(e[t]=e[`${t}-${r}`])}return e}async function ia(){let e=await fetch(`/submit`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(ra())});if(!e.ok&&e.status!==409)throw Error(`Submit failed: ${e.status}`);if(e.ok){let t=await e.json().catch(()=>null);t?.doc?.base&&t?.doc?.token&&ga(t.doc)}}async function aa(){let e=H(`[data-doc-error]`),t=H(`[data-doc-loader]`);e.hidden=!0,t.removeAttribute(`data-stalled`),ta();try{await Promise.all([ia(),na(2400)]),la()}catch{t.setAttribute(`data-stalled`,``),e.hidden=!1}}var oa=!1;document.addEventListener(`picker:screenchange`,({detail:e})=>{e.screen!==`12`||oa||(oa=!0,aa())}),x().then(async e=>{e.mode===`doc`&&(ai=!0,oa=!0,await Promise.all([ri,ii,ne,Lt().catch(()=>{})]),e.doc?.base&&e.doc?.token&&ga(e.doc),ta(),la())});var sa;document.addEventListener(`picker:screenchange`,()=>{oa||(clearTimeout(sa),sa=setTimeout(()=>{oa||fetch(`/autosave`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(ra())}).catch(()=>{})},500))}),H(`[data-doc-retry]`)?.addEventListener(`click`,aa);var ca=!1;function la(){ca=!0,document.body.classList.add(`dcx-open`),Zr.hidden=!1,window.scrollTo(0,0),requestAnimationFrame(()=>{requestAnimationFrame(()=>{Xr(`[data-reveal]`,Zr).forEach(e=>e.classList.add(`revealed`)),ua()})})}function ua(){Xr(`.dcx-viz-svg`).forEach(e=>{let t=Xr(`.anim-draw, .anim-draw-delay`,e);if(!t.length)return;let n=e.getBoundingClientRect();if(!n.width||!n.height)return;let r=Math.min(n.width,n.height)/40;t.forEach(e=>{let t=Math.max(100,e.getTotalLength()/.6);e.style.setProperty(`--pl`,`${(t*r).toFixed(1)}px`)})})}var da;window.addEventListener(`resize`,()=>{window.clearTimeout(da),da=window.setTimeout(()=>{ca&&ua()},150)});var X=null,fa=1,pa=!1,ma=[],ha=H(`[data-dcx-tray]`);function ga(e){X=e,window.dcxDocSession=e,document.body.classList.add(`dcx-live`),Ta(),va(1500)}var _a;function va(e){window.clearTimeout(_a),_a=window.setTimeout(ya,e)}async function ya(){if(X)try{let e=await fetch(`${X.base}/doc/state?token=${encodeURIComponent(X.token)}`);if(!e.ok)throw Error(`state`);let t=await e.json();ba(!0),ma=t.requests||[],Da(),t.version!==fa&&(fa=t.version,await wa(),Ta()),va(2e3)}catch{ba(!1),Da(),va(8e3)}}function ba(e){pa=e,document.body.classList.toggle(`dcx-live`,!!X&&e)}async function xa(){let e=await fetch(`${X.base}/doc/answers?token=${encodeURIComponent(X.token)}`);if(!e.ok)return;let{answers:t}=await e.json();for(let[e,n]of Object.entries(t||{})){if(Array.isArray(n)||typeof n!=`string`)continue;let t=U.elements[e];t&&(typeof RadioNodeList<`u`&&t instanceof RadioNodeList||`value`in t&&t.type!==`checkbox`)&&(t.value=n)}Sa(W(`font-heading`)),Sa(W(`font-body`))}function Sa(e){if(!e||document.fonts?.check?.(`16px '${e}'`))return;let t=`dcx-face-${e.replace(/\W+/g,`-`).toLowerCase()}`;if(document.getElementById(t))return;let n=document.createElement(`link`);n.id=t,n.rel=`stylesheet`,n.href=`https://fonts.googleapis.com/css2?family=${encodeURIComponent(e).replace(/%20/g,`+`)}:wght@300..800&display=swap`,document.head.appendChild(n)}async function Ca(){let e=await fetch(`${X.base}/doc/context?token=${encodeURIComponent(X.token)}`);if(!e.ok)return;let t=await e.json();t.context&&typeof t.context==`object`&&(Qr=t.context),Array.isArray(t.modes)&&($r=t.modes)}var wa=()=>Promise.all([xa(),Ca()]);function Ta(){ta(),window.dcxDocument?.remount()}var Ea={pending:`Queued for the agent`,working:`The agent is on it`,done:`Applied`,error:`Could not apply`};function Da(){if(!ha)return;let e=ma.slice(-4),t=X&&!pa;ha.hidden=!t&&e.length===0,ha.innerHTML=[t?`<div class="dcx-tray-item" data-status="offline"><span class="dcx-tray-dot"></span><div><p class="dcx-tray-prompt">Edit session offline</p><p class="dcx-tray-note">Changes stay in this tab; reconnecting&hellip;</p></div></div>`:``,...e.map(e=>`
      <div class="dcx-tray-item" data-status="${G(e.status)}">
        <span class="dcx-tray-dot"></span>
        <div>
          <p class="dcx-tray-prompt">${G(e.prompt)}</p>
          <p class="dcx-tray-note">${G(e.message||Ea[e.status]||e.status)}</p>
        </div>
      </div>`)].join(``)}var Z=(e,t=document)=>t.querySelector(e),Oa=Z(`#picker-form`),ka=Z(`[data-copy-url]`),Aa=Z(`[data-copy-status]`),Q=[...Oa.querySelectorAll(`.picker-screen`)],$=Q.findIndex(e=>e.hasAttribute(`data-active`)),ja=new URL(location.href);ja.hostname=`localhost`;var Ma=ja.href.replace(/\/$/,``);Z(`[data-copy-url-value]`).textContent=Ma;var Na=()=>[...Q[$].querySelectorAll(`button:not([disabled]), input:not([disabled]):not([type="hidden"]):not([tabindex="-1"]), select:not([disabled]), textarea:not([disabled]), a[href]`)],Pa=Z(`.picker-progress`),Fa=Z(`.picker-progress-track`),Ia=()=>Q.filter((e,t)=>t>0&&t<Q.length-1&&!e.hasAttribute(`data-skip`)),La=e=>{let t=Ia(),n=t.length,r=t.indexOf(e),i=r>=0?r+1:e===Q[0]?1:n;Pa.dataset.step=String(i),Pa.style.setProperty(`--pk-steps`,String(n)),[...Fa.children].forEach((e,t)=>e.toggleAttribute(`data-off`,t>=n)),Z(`[data-progress-index]`).textContent=String(i),Z(`[data-progress-total]`).textContent=String(n),Z(`[data-progress-name]`).textContent=e.dataset.step||``},Ra=new Set([`01b`,`02`,`03`]),za=(e,t)=>typeof document.startViewTransition==`function`&&!matchMedia(`(prefers-reduced-motion: reduce)`).matches&&Ra.has(e?.dataset.screen)&&Ra.has(t?.dataset.screen),Ba=(e,t=1)=>{let n=e;for(;Q[n]?.hasAttribute(`data-skip`);)n+=t;let r=Q[n];if(r){if(za(Q[$],r)){document.startViewTransition(()=>Va(n));return}Va(n)}},Va=e=>{let t=Q[e];Q.forEach((t,n)=>{let r=n===e;t.toggleAttribute(`data-active`,r),r?t.removeAttribute(`aria-hidden`):t.setAttribute(`aria-hidden`,`true`)}),$=e;let n=t.dataset.screen;Oa.dataset.current=n,La(t),document.dispatchEvent(new CustomEvent(`picker:screenchange`,{detail:{screen:n}})),Na()[0]?.focus()},Ha=`04b`,Ua=new Set([`06`,`08`,`09`,`10`,`11`]),Wa=e=>Q.findIndex(t=>t.dataset.screen===e);Oa.onclick=e=>{let t=e.target.closest(`[data-advance]`);if(!t)return;if(Ua.has(Q[$].dataset.screen)){Ba(Wa(Ha));return}let n=t.dataset.advance===`prev`?-1:1;Ba($+n,n)},document.addEventListener(`picker:goto`,e=>{let t=Wa(e.detail.screen);t!==-1&&Ba(t)}),document.addEventListener(`keydown`,e=>{if(e.defaultPrevented||e.target instanceof Element&&e.target.closest(`input, textarea, select, [role="slider"]`))return;if(e.key===`Enter`){if($===0&&matchMedia(`(max-width: 1199px)`).matches)return;let t=$===0?Z(`[data-advance="next"]`,Q[0]):document.activeElement;Na().includes(t)&&(e.preventDefault(),t.click());return}let t={ArrowUp:-1,ArrowLeft:-1,ArrowDown:1,ArrowRight:1};if(!(e.key in t))return;e.preventDefault();let n=Na(),r=n.indexOf(document.activeElement);n[r<0?0:(r+t[e.key]+n.length)%n.length]?.focus()}),Oa.onsubmit=e=>e.preventDefault(),ka.onclick=async()=>{try{await navigator.clipboard.writeText(Ma),ka.classList.add(`is-copied`),ka.setAttribute(`aria-label`,`Link copied`),Aa.textContent=`Copied. Paste it into your browser to continue.`,setTimeout(()=>{ka.classList.remove(`is-copied`),ka.setAttribute(`aria-label`,`Copy link`)},1200)}catch{Aa.textContent=`Copy failed. Select the link above and copy it instead.`}},Oa.dataset.current=Q[$].dataset.screen,La(Q[$]);