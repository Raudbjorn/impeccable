...
```bash
.omp/skills/impeccable/scripts/skill:impeccable detect --json --scope type [target files or dirs]
```
...
When the hierarchy holds, hand off to `/skill:impeccable polish`.
