...
```bash
.omp/skills/impeccable/scripts/skill:impeccable detect --json --scope layout [target files or dirs]
```
...
When the structure holds, hand off to `/skill:impeccable polish`.
