...
```text
node .pi/skills/impeccable/scripts/design-context-export.mjs [--out DIR] [--no-assets]
```
...
```text
node .pi/skills/impeccable/scripts/design-context-import.mjs <bundle.json> [--design skip|write] [--force]
```
