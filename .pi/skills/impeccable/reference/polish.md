...
```bash
.pi/skills/impeccable/scripts/impeccable critique-storage latest "<resolved target>" --json
```
...
```bash
.pi/skills/impeccable/scripts/impeccable critique-storage close "<resolved target>" "<snapshot_file returned by latest>"
```
