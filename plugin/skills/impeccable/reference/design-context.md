...
```text
node "<skill-base-dir>/scripts/design-context-export.mjs" [--out DIR] [--no-assets]
```
...
```text
node "<skill-base-dir>/scripts/design-context-import.mjs" <bundle.json> [--design skip|write] [--force]
```
