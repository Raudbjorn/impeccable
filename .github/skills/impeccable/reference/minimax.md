...
node ".github/skills/impeccable/scripts/image-analyze.mjs" --image "screenshot.png" --mode detailed --prompt "Read the annotations and explain the requested layout changes."
```
