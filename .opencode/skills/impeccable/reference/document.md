...
3. On the questionnaire path (were it reachable today, see Step 4), add one line: the interview is kept, and `/impeccable design-context export` writes the context out for another tool. See [design-context.md](design-context.md).
