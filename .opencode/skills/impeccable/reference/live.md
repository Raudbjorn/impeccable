...
```sh
node ".opencode/skills/impeccable/scripts/image-analyze.mjs" --image "<event.screenshotPath>" --mode detailed --prompt "<analysis task composed from this event's request, target, and annotations>"
```
