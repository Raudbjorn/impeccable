(()=>{if(window.__dcxSettingsInstalled)return;window.__dcxSettingsInstalled=!0;let e=window.matchMedia(`(prefers-reduced-motion: reduce)`),t=[{label:`Open`,description:`Pick up where you left off.`,command:`/impeccable design-context open`},{label:`Edit`,description:`Make a few changes to this design context.`,command:`/impeccable design-context edit`},{label:`Export`,description:`Save a copy to share or keep elsewhere.`,command:`/impeccable design-context export`},{label:`Import`,description:`Bring a saved design context into this project.`,command:`/impeccable design-context import`}],n=e=>{let t=e?.querySelector?.(`.dcx-topbar`),n=t?.querySelector(`.dcx-close`);if(!t||!n||t.querySelector(`[data-dcx-settings-open]`))return;let r=document.createElement(`div`);r.className=`dcx-topbar-actions`;let i=document.createElement(`button`);i.className=`dcx-settings-trigger`,i.type=`button`,i.dataset.dcxSettingsOpen=``,i.setAttribute(`aria-label`,`Design context settings`),i.setAttribute(`aria-haspopup`,`dialog`),i.setAttribute(`aria-controls`,`dcx-context-settings`),i.setAttribute(`aria-expanded`,`false`),i.innerHTML=`
          ...
          <div class="dcx-component-canvas dcx-component-canvas--fields">
            <div class="dcx-component-demo-grid dcx-component-demo-grid--three dcx-component-demo-grid--baseline">
              ...
              <div class="dcx-demo-field">
                ...
                <span class="dcx-demo-input">${ie()}</span>
              </div>
          ...
          <div class="dcx-component-canvas dcx-component-canvas--fields">
            <div class="dcx-component-demo-grid dcx-component-demo-grid--three">
              ...
              <div class="dcx-demo-field">
                ...
                <span class="dcx-demo-input dcx-demo-input--affix dcx-demo-input--suffix">${ae()}<span>.com</span></span>
              </div>
            </div>
          </div>
        </figure>
          ...
          <div class="dcx-component-canvas dcx-component-canvas--cards">
            <div class="dcx-component-demo-grid dcx-component-demo-grid--two">
              <article class="dcx-showcase-card dcx-showcase-card--media">
                <img ${oe(`Purple flowers arranged in a black ceramic vase`,`The visual cue this palette was picked from`)} width="800" height="1200" loading="lazy" decoding="async">
                <div class="dcx-showcase-card-body">
              ...
              <article class="dcx-showcase-card dcx-showcase-card--media dcx-showcase-card--media-close">
                <img ${oe(`Close crop of purple ikebana flowers`,`The chosen visual cue, cropped close`)} width="800" height="1200" loading="lazy" decoding="async">
                <div class="dcx-showcase-card-body">
        ...
        <figure class="dcx-component-example">
          ...
          <div class="dcx-component-canvas dcx-component-canvas--cards dcx-component-canvas--single-card">
            <article class="dcx-showcase-card dcx-showcase-card--horizontal">
              <img ${oe(`Purple ikebana in a dark ceramic vase`,`The chosen visual cue as a wide feature image`)} width="800" height="1200" loading="lazy" decoding="async">
              <div class="dcx-showcase-card-body">
    ...
    `);e.append(t,n,r)},S=e=>{let n=document.createDocumentFragment(),r=document.createElement(`h1`);r.className=`dcx-document-title`,r.textContent=`Design context`,n.appendChild(r),t.forEach(e=>{let t=document.querySelector(`#dcx-detail-${m(e)}`).content.cloneNode(!0).querySelector(`.dcx-article`);if(t){if(e===`components`){se(t);let e=t.querySelector(`:scope > header > .dcx-title`),n=t.querySelector(`:scope > header > .dcx-lede`);e&&(e.textContent=`Components`),n&&(n.textContent=`A compact visual inventory of reusable interface patterns.`)}if(e===`brand`&&ne(t),e===`material`){let e=b(`Accessibility`,`
          <dl class="dcx-defs">
            <div class="dcx-def">
...
.imp-paint-nudge-`+u+` { --imp-nudge: `+u+`; }`,u<3&&r.setTimeout(d,700*u))};r.requestAnimationFrame(()=>r.requestAnimationFrame(d))},installEmailCapture:()=>{if(!n?.head||t.hasAttribute(`data-premium-landing-email-capture`))return;t.setAttribute(`data-premium-landing-email-capture`,``);let e=n.createElement(`style`);e.id=`landing-email-capture`,e.textContent=`
        ...
        `,n.getElementById(e.id)||n.head.appendChild(e);let i=n.querySelector(`.picker-preview-motion--index`),a=i?.querySelector(`.pv-desktop .pg-body`),o=i?.querySelector(`.pv-phone .pg-phone-body`);a?.querySelectorAll(`:scope > .pg-rail`).forEach(e=>e.remove()),a&&!a.querySelector(`.pg-row--scroll-one`)&&a.insertAdjacentHTML(`beforeend`,`<span class="pg-row pg-row--more pg-row--scroll-one"><span class="pv-image"></span><span class="pg-cap"><i class="pg-cap-title" style="--w:31.4%"></i><i></i><i style="--w:61.8%"></i></span></span><span class="pg-row pg-row--flip pg-row--more pg-row--scroll-two"><span class="pg-cap"><i class="pg-cap-title" style="--w:38.2%"></i><i></i><i style="--w:59.4%"></i></span><span class="pv-image"></span></span>`),o&&!o.querySelector(`.pg-phone-more-start`)&&o.insertAdjacentHTML(`beforeend`,`<span class="pv-image pg-phone-more pg-phone-more-start"></span><span class="pg-cap pg-phone-more pg-phone-more-copy-one"><i class="pg-cap-title" style="--w:34.2%"></i><i style="--w:74.6%"></i><i style="--w:51.8%"></i></span><span class="pv-image pg-phone-more pg-phone-more-image-two"></span><span class="pg-cap pg-phone-more pg-phone-more-copy-two"><i class="pg-cap-title" style="--w:28.8%"></i><i style="--w:82.4%"></i><i style="--w:58.2%"></i></span>`);let s=[[`.pv-desktop .pg-row:first-child > .pv-image`,`.pv-desktop .pg-row:first-child > .pg-cap`,`.pv-desktop .pg-row:nth-child(2) > .pv-image`,`.pv-desktop .pg-row:nth-child(2) > .pg-cap`],[`.pg-phone-body > .pv-image:nth-child(1)`,`.pg-phone-body > .pg-cap:nth-child(2)`,`.pg-phone-body > .pv-image:nth-child(3)`,`.pg-phone-body > .pg-cap:nth-child(4)`,`.pv-tabbar`]],c=()=>{let e=Math.sqrt(120),t=20/(2*Math.sqrt(120)),n=e*Math.sqrt(1-t**2);return Array.from({length:73},(r,i)=>{let a=i/72,o=1050*a/1e3,s=i===72?0:Math.exp(-t*e*o)*(Math.cos(n*o)+t*e/n*Math.sin(n*o)),c=Math.max(0,Math.min(1,1-s));return{offset:a,opacity:Number(c.toFixed(4)),filter:`blur(${(4*(1-c)).toFixed(3)}px)`,transform:`translateY(${(40*s).toFixed(3)}px)`}})},l={imageFromLeft:[{opacity:.12,filter:`blur(9px)`,clipPath:`inset(0 100% 0 0)`,transform:`translateX(-72px) scale(1.025)`},{opacity:1,filter:`blur(0px)`,clipPath:`inset(0)`,transform:`translateX(0px) scale(1)`}],copyFromRight:[{opacity:0,filter:`blur(5px)`,clipPath:`inset(0 0 0 100%)`,transform:`translateX(44px)`},{opacity:1,filter:`blur(0px)`,clipPath:`inset(0)`,transform:`translateX(0px)`}],imageFromRight:[{opacity:.12,filter:`blur(9px)`,clipPath:`inset(0 0 0 100%)`,transform:`translateX(72px) scale(1.025)`},{opacity:1,filter:`blur(0px)`,clipPath:`inset(0)`,transform:`translateX(0px) scale(1)`}],copyFromLeft:[{opacity:0,filter:`blur(5px)`,clipPath:`inset(0 100% 0 0)`,transform:`translateX(-44px)`},{opacity:1,filter:`blur(0px)`,clipPath:`inset(0)`,transform:`translateX(0px)`}]},u=r.matchMedia(`(prefers-reduced-motion: reduce)`);if(i&&r.Element?.prototype.animate&&!u.matches){let e=[],n=c();for(let t of s)t.map(e=>i.querySelector(e)).filter(Boolean).forEach((t,r)=>{e.push(t.animate(n,{duration:1050,delay:r*100,easing:`linear`,fill:`both`}))});let d=7200,f=e=>e/d,p=(t,n,r)=>{if(!t||!n||!r)return;let i=r.offsetTop-n.offsetTop;i>0&&e.push(t.animate([{offset:0,transform:`translateY(0px)`},{offset:f(1750),transform:`translateY(0px)`,easing:`cubic-bezier(.65, 0, .35, 1)`},{offset:f(2850),transform:`translateY(${-i}px)`},{offset:f(5400),transform:`translateY(${-i}px)`,easing:`cubic-bezier(.65, 0, .35, 1)`},{offset:f(6500),transform:`translateY(0px)`},{offset:1,transform:`translateY(0px)`}],{duration:d,easing:`linear`,fill:`both`}))};p(a,a?.querySelector(`:scope > .pg-row:first-child`),a?.querySelector(`:scope > .pg-row--scroll-one`)),p(o,o?.querySelector(`:scope > .pv-image:first-child`),o?.querySelector(`:scope > .pg-phone-more-start`));for(let[t,n,r]of[[`.pv-desktop .pg-row--scroll-one > .pv-image`,`imageFromLeft`,2020],[`.pv-desktop .pg-row--scroll-one > .pg-cap`,`copyFromRight`,2160],[`.pv-desktop .pg-row--scroll-two > .pv-image`,`imageFromRight`,2400],[`.pv-desktop .pg-row--scroll-two > .pg-cap`,`copyFromLeft`,2540],[`.pv-phone .pg-phone-more-start`,`imageFromLeft`,2020],[`.pv-phone .pg-phone-more-copy-one`,`copyFromRight`,2160],[`.pv-phone .pg-phone-more-image-two`,`imageFromRight`,2400],[`.pv-phone .pg-phone-more-copy-two`,`copyFromLeft`,2540]]){let a=i.querySelector(t);a&&e.push(a.animate(l[n],{duration:n.startsWith(`image`)?720:620,delay:r,easing:`cubic-bezier(.16, 1, .3, 1)`,fill:`both`}))}let m=()=>{if(u.matches){e.forEach(e=>e.cancel());return}e.forEach(e=>{e.pause(),e.currentTime=0,e.play()})};t.__replayMotion=m,u.addEventListener(`change`,({matches:t})=>{t?e.forEach(e=>e.cancel()):m()}),r.addEventListener(`pagehide`,()=>{e.forEach(e=>e.cancel())})}}let a=()=>{for(let e of n.querySelectorAll(`.picker-preview-motion--index`)){let t=e.querySelector(`.pv-desktop`),n=e.querySelector(`.ps-cursor`);if(!t?.clientWidth||!t.clientHeight||!n)continue;let a=t.getBoundingClientRect(),o=r.getComputedStyle(t),s=parseFloat(o.borderLeftWidth)||0,c=parseFloat(o.borderRightWidth)||0,l=parseFloat(o.borderTopWidth)||0,u=parseFloat(o.borderBottomWidth)||0,d=a.width-s-c,f=a.height-l-u,p=r.getComputedStyle(n),m=parseFloat(p.width)||n.offsetWidth,h=parseFloat(p.height)||n.offsetHeight,g=Math.min(m/14,h/20),_=[`restrained`,`responsive`].includes(i.slice(i.indexOf(`-`)+1)),v=g*(_?1:2.2),y=g*(_?1:3.9),b=(n,r)=>{let i=t.querySelector(r);if(!i)return;let o=i.getBoundingClientRect(),c=(o.left+o.width/2-a.left-s-v)/d*100,u=(o.top+o.height/2-a.top-l-y)/f*100;e.style.setProperty(n,c.toFixed(2)+`cqw `+u.toFixed(2)+`cqh`)};b(`--mxi-nav1-tip`,`.pv-nav-bars i:nth-child(1)`),b(`--mxi-work1-tip`,`.pg-row:nth-of-type(1) > .pv-image`),b(`--mxi-work2-tip`,`.pg-row:nth-of-type(2) > .pv-image`),b(`--mxi-rail-tip`,`.pg-arrow--next`),b(`--mxr-modal-close-tip`,`.mxr-modal-close`),b(`--mxv-modal-close-tip`,`.mxv-modal-close`)}};r.requestAnimationFrame(()=>{a(),r.requestAnimationFrame(a)});let o=n.querySelector(`.pv-desktop`);if(o&&r.ResizeObserver){let e=new r.ResizeObserver(a);e.observe(o),t.__portfolioTipObserver=e}}})}let t=t=>{let n=e.map(({board:e})=>[e,e.getAttribute(`style`)]);for(let{board:n}of e)n.style.setProperty(`display`,n===t?`grid`:`none`,`important`);return()=>{for(let[e,t]of n)t===null?e.removeAttribute(`style`):e.setAttribute(`style`,t)}},n=(e,n)=>{let r=t(e.board);try{n()}finally{r()}};for(let t of e)t.cell===`persuade-restrained`&&n(t,t.installPerfectCursorLoop);for(let t of e)t.cell===`persuade-responsive`&&n(t,t.installResponsiveLandingCorrections);for(let t of e)t.cell===`persuade-choreographed`&&n(t,t.installChoreographedPremium);for(let t of e)t.cell.startsWith(`persuade-`)&&n(t,t.installEmailCapture);for(let t of e)t.cell.startsWith(`experience-`)&&n(t,t.installPortfolioFixes)}var tn=!1;function nn(){if(tn)return;let e=document.querySelector(`.picker-screen[data-screen="06"] .picker-board-stage`),t=e?[...e.querySelectorAll(`.picker-preview-motion[data-motion-cell]`)]:[];!t.length||!t.some(e=>e.getBoundingClientRect().width>0)||(tn=!0,en())}var z=document.querySelector(`[data-font-modal]`),rn=z.querySelector(`[data-custom-status]`),an=e=>z.querySelector(`[data-custom-file="${e}"]`),on=e=>z.querySelector(`[data-custom-url="${e}"]`),sn=z.querySelector(`[data-font-custom-save]`),cn=z.querySelector(`[data-custom-hint]`),ln=`
`,un=new Set([`.woff2`,`.woff`,`.ttf`,`.otf`]),B={heading:[],body:[]};function dn(e){let t=e.lastIndexOf(`.`);return t===-1?``:e.slice(t).toLowerCase()}function fn(e){return un.has(dn(e.name))}function pn(e,t){let n=new DataTransfer;for(let e of t)n.items.add(e);e.files=n.files}function mn(e,t){return e.name===t.name&&e.size===t.size&&e.lastModified===t.lastModified}function hn(e,t){let n=[...e];for(let e of t)n.some(t=>mn(t,e))||n.push(e);return n}function gn(e){let t=z.querySelector(`[data-custom-file-list="${e}"]`),n=B[e];t.replaceChildren(),t.hidden=n.length===0;for(let r of n){let n=document.createElement(`li`);n.className=`picker-modal-file-item`;let i=document.createElement(`span`);i.textContent=r.name;let a=document.createElement(`button`);a.type=`button`,a.className=`picker-modal-file-remove`,a.setAttribute(`aria-label`,`Remove ${r.name}`),a.textContent=`×`,a.onclick=()=>{B[e]=B[e].filter(e=>!mn(e,r)),pn(an(e),B[e]),gn(e),vn(),rn.textContent=``},n.append(i,a),t.append(n)}}var _n=e=>B[e].length>0||on(e).value.trim()!==``;function vn(){let e=[`heading`,`body`].filter(e=>!_n(e));sn.disabled=e.length>0,cn.textContent=e.length===2?`Heading and body each need a URL or a file.`:e.length===1?`${e[0]===`heading`?`Heading`:`Body`} still needs a URL or a file.`:``}function yn(e){return e?e.includes(ln)?e.split(ln).filter(Boolean):[e]:[]}document.querySelector(`[data-font-custom-open]`).onclick=()=>{rn.textContent=``;for(let e of[`heading`,`body`])B[e]=[],an(e).value=``,pn(an(e),[]),on(e).value=``,gn(e);vn(),z.showModal()},document.querySelector(`[data-font-custom-close]`).onclick=()=>z.close();for(let e of[`heading`,`body`])an(e).onchange=({target:t})=>{let n=[...t.files].filter(fn);rn.textContent=n.length===t.files.length?``:`Only .woff2, .woff, .ttf, and .otf files are accepted.`,B[e]=hn(B[e],n),pn(t,B[e]),t.value=``,gn(e),vn()},on(e).oninput=vn;async function bn(e){let t=await fetch(`/font-upload`,{method:`POST`,headers:{"X-Font-Filename":e.name,"Content-Type":`application/octet-stream`},body:e}),n=await t.json();if(!t.ok)throw Error(n.error||`Upload failed`);return n.path}async function xn(e){let t=B[e].filter(fn);if(t.length){let e=await Promise.all(t.map(e=>bn(e)));return{family:t[0].name.replace(/\.[^.]+$/,``),source:e.join(ln)}}let n=on(e).value.trim();return n?{family:n.split(`/`).pop().replace(/\.[^.]+$/,``)||`Custom`,source:n}:null}sn.onclick=async()=>{rn.textContent=`Saving…`;let e,t;try{[e,t]=await Promise.all([xn(`heading`),xn(`body`)])}catch(e){rn.textContent=e.message;return}if(!e||!t){rn.textContent=`Add a URL or a file for both the heading and the body.`;return}let n={id:`custom`,name:`Custom`,heading:e,body:t,why:`Your own faces`};ke.pairs=[n,...ke.pairs.filter(({id:e})=>e!==`custom`)];for(let e of[...rt])e.querySelector(`input`).value===`custom`&&at(e);it(n,{checked:!0,first:!0}),Sn(n),nt(n),ft({force:!0}),z.close()};function Sn({heading:e,body:t}){for(let n of[e,t])if(n?.source){if(/\.(css)(\?|$)/i.test(n.source)||!n.source.includes(ln)&&!/\.(woff2?|ttf|otf)(\?|$)/i.test(n.source)){let e=document.createElement(`link`);e.rel=`stylesheet`,e.href=n.source,document.head.append(e);continue}for(let e of yn(n.source)){let t=e.startsWith(`http`)?e:`/fonts/${e.split(`/`).pop()}`;document.fonts.add(new FontFace(n.family,`url(${t})`))}document.fonts.load(`16px "${n.family}"`)}}function Cn(e){ve.textContent!==ve.dataset[e]&&(ve.classList.add(`is-changing`),setTimeout(()=>{ve.textContent=ve.dataset[e],ve.classList.remove(`is-changing`)},90))}var wn=D(`[data-contrast-alert]`,A),Tn=D(`[data-contrast-tip]`,A);function En(e,t,n){e.hidden=n.length===0,t.replaceChildren(...n.map(e=>{let t=document.createElement(`span`);return t.textContent=e,t}))}function Dn(){En(wn,Tn,P.length?x(L().colors):[])}function On(e,t,n=!0){let r=L();r.colors[e]=t.toUpperCase(),r.detached[e]=n,qe(e),Ge(I()),Cn(e)}function kn(e,t,n,r,i){let a=N.get(t.id),o=Ue(n),s=e.dataset.role;r=Math.min(100,Math.max(0,r)),i=Math.min(100,Math.max(0,i));let c=o.getContext(`2d`).getImageData(Math.round(r/100*(o.width-1)),Math.round(i/100*(o.height-1)),1,1).data,l=`#${[c[0],c[1],c[2]].map(e=>e.toString(16).padStart(2,`0`)).join(``).toUpperCase()}`;a.rings[s]=[r,i],a.colors[s]=l,a.detached[s]=!1,Ge(t),t===I()&&qe(s),Cn(s),Ke(e,t,n)}function An(e,t,n){let r=r=>{let i=n.getBoundingClientRect();kn(e,t,n,(r.clientX-i.left)/i.width*100,(r.clientY-i.top)/i.height*100)};e.onpointerdown=t=>{t.button===0&&(e.focus(),e.setPointerCapture(t.pointerId),e.dataset.dragging=``,r(t))},e.onpointermove=t=>{e.hasPointerCapture(t.pointerId)&&(ze(),r(t))},e.onpointerup=t=>{r(t),e.releasePointerCapture(t.pointerId),delete e.dataset.dragging,document.activeElement!==e&&delete j.dataset.visible},e.onfocus=()=>n.complete&&Ke(e,t,n),e.onblur=()=>{`dragging`in e.dataset||delete j.dataset.visible},e.onkeydown=r=>{let i={ArrowLeft:[-1,0],ArrowRight:[1,0],ArrowUp:[0,-1],ArrowDown:[0,1]};if(!i[r.key])return;r.preventDefault(),ze();let a=r.shiftKey?5:1,[o,s]=N.get(t.id).rings[e.dataset.role];kn(e,t,n,o+i[r.key][0]*a,s+i[r.key][1]*a)};let i=(r,i)=>{let a=e.parentElement.querySelector(`.picker-ring-axis--${r}[data-role="${e.dataset.role}"]`);a&&(a.onfocus=()=>n.complete&&Ke(e,t,n),a.onblur=()=>delete j.dataset.visible,a.onkeydown=a=>{if(!(a.key in i))return;a.preventDefault(),ze();let o=a.shiftKey?5:1,[s,c]=N.get(t.id).rings[e.dataset.role],l=i[a.key]*o;kn(e,t,n,r===`x`?s+l:s,r===`y`?c+l:c)})};i(`x`,{ArrowLeft:-1,ArrowRight:1}),i(`y`,{ArrowUp:-1,ArrowDown:1})}function jn(e){let t=D(`[data-${e.type}-card]`).content.firstElementChild.cloneNode(!0);t.dataset.id=e.id;let n=D(`.picker-card-face`,t);if(e.type===`seed`)O(`span`,n).forEach((t,n)=>{t.style.setProperty(`--seed-color`,N.get(e.id).colors[E[n]])});else{let t=D(`img`,n);t.alt=`Visual cue ${e.id}`,t.src=`/cues/${encodeURIComponent(e.id)}.png`,O(`.picker-ring`,n).forEach(r=>{let i=r.dataset.role,[a,o]=N.get(e.id).rings[i];We(n,i,a,o,N.get(e.id).colors[i]),An(r,e,t)}),t.addEventListener(`load`,()=>{e.defaultRings=Re(n=>{let[r,i]=e.palette[n].at;return[r/t.naturalWidth*100,i/t.naturalHeight*100]}),N.get(e.id).rings=structuredClone(e.defaultRings),Ge(e),e===I()&&Ue(t)})}return e.node=t,t}function Mn(){if(!Oe)return;let e=Oe,t=D(`[data-band-item="${e}"]`,A),n=D(`[data-tints]`,t),r=n.contains(document.activeElement);delete t.dataset.tintOpen,n.hidden=!0,Oe=null;let i=D(`[data-edit-tints="${e}"]`,A);i.setAttribute(`aria-expanded`,`false`),i.dataset.tip=`Edit tints`,r&&i.focus()}function Nn(){let e=I();P.forEach(({node:e},t)=>{let n=t-F;e.dataset.pos=Math.max(-2,Math.min(2,n)),e.classList.toggle(`is-far`,Math.abs(n)>2),e.setAttribute(`aria-hidden`,n!==0)}),D(`[data-deck-prev]`).disabled=F===0,D(`[data-deck-next]`).disabled=F===P.length-1,_e.textContent=`${F+1} / ${P.length}`;for(let e of E)qe(e);if(Ge(e),e.type===`cue`){let t=D(`img`,e.node);t.complete&&t.naturalWidth&&Ue(t)}Mn()}function Pn(e){let t=Math.min(P.length-1,Math.max(0,e)),n=matchMedia(`(prefers-reduced-motion: reduce)`).matches?`auto`:`smooth`;ge.children[t].scrollIntoView({behavior:n,block:`start`})}function Fn(e){if(e.key===`Escape`&&Oe){e.preventDefault(),Mn();return}let t={ArrowLeft:-1,ArrowRight:1}[e.key];t&&(e.target instanceof Element&&e.target.closest(`.picker-ring, [role="slider"], input`)||V?.keyboard||(e.preventDefault(),Pn(F+t)))}var In=e=>document[e?`addEventListener`:`removeEventListener`](`keydown`,Fn,!0);function Ln(e){Mn(),Oe=e,Cn(e);let t=D(`[data-band-item="${e}"]`,A),n=D(`[data-tints]`,t),r=L().colors[e],[i,a,o]=c(r);O(`[data-tint]`,n).forEach((e,t)=>{let n=t-3,c=n<0?i+(.96-i)*(-n/3):i-(i-.16)*(n/3),l=n===0?r:s([c,a*(1-Math.abs(n)/3*.3),o]);e.dataset.tint=l,e.style.setProperty(`--tint-color`,l),e.setAttribute(`aria-label`,l),e.toggleAttribute(`data-current`,n===0)}),n.hidden=!1,t.dataset.tintOpen=``;let l=D(`[data-edit-tints="${e}"]`,A);l.setAttribute(`aria-expanded`,`true`),l.dataset.tip=`Close tints`,D(`button`,n)?.focus()}var Rn=220,zn=1.02,Bn=getComputedStyle(document.documentElement).getPropertyValue(`--ks-ease`).trim()||`ease`,Vn=new Set([` `,`Enter`,`ArrowLeft`,`ArrowRight`,`Home`,`End`,`Escape`]),Hn=new WeakMap,Un=D(`.picker-bands`,A),Wn=document.querySelector(`[data-band-scope="strategy"]`),Gn=document.querySelector(`.picker-screen[data-screen="03"] .picker-strategy-grid`),Kn=()=>matchMedia(`(prefers-reduced-motion: reduce)`).matches,qn=e=>E.map(t=>D(`[data-band="${t}"]`,e)),Jn=e=>E.map(t=>D(`[data-grip="${t}"]`,e)),Yn=(e,t)=>D(`[data-band-item="${E[e]}"] .picker-band-foot h2`,t).textContent,Xn=(e,t)=>{let n=D(`[data-reorder-status]`,e.closest(`.picker-screen`)??e);n&&(n.textContent=t)},V=null,Zn=null;function Qn(e,t){let n=E.map((e,t)=>t);return n.splice(t,0,...n.splice(e,1)),n}function $n(e,t,n,r){e.style.transform=n?`translateX(${n}px)`:``,Hn.get(e)?.cancel(),r&&Hn.set(e,e.animate([{transform:`translateX(${t}px)`},{transform:`translateX(${n}px)`}],{duration:Rn,easing:Bn}))}function er(e,t){let n=V.nodes[V.from],r=V.offsets[V.from],i=e=>`translateX(${e}px) scale(${zn})`;V.offsets[V.from]=e,n.style.transform=i(e),Hn.get(n)?.cancel(),t&&Hn.set(n,n.animate([{transform:i(r)},{transform:i(e)}],{duration:Rn,easing:Bn}))}function tr(e,t){Qn(V.from,e).forEach((e,n)=>{if(e===V.from)return;let r=V.homes[n].left-V.homes[e].left;r!==V.offsets[e]&&($n(V.nodes[e],V.offsets[e],r,t),V.offsets[e]=r)}),V.to=e}function nr(e){let{homes:t,from:n}=V,r=t[n].left+t[n].width/2+e,i=e=>Math.abs(t[e].left+t[e].width/2-r);return t.reduce((e,t,n)=>i(n)<i(e)?n:e,0)}function rr(e,t,n){let r=L(),i={},a={},o={};Qn(e,t).forEach((e,t)=>{let n=E[t],s=E[e];i[n]=r.colors[s],a[n]=r.detached[s],o[n]=r.rings[s]}),Object.assign(r,{colors:i,detached:a,rings:o}),Nn(),n!==Un&&ir()}function ir(){if(D(`[name="palette-source"]`).value){for(let e of E)D(`[name="palette-${e}"]`).value=L().colors[e];sr(),Mr();for(let e of document.querySelectorAll(`.picker-screen[data-active] [data-artboard]`))Ye(e)}}var ar=D(`[data-contrast-alert]`,Wn),or=D(`[data-contrast-tip]`,Wn);function sr(){let e=Re(e=>D(`[name="palette-${e}"]`).value);if(!Object.values(e).some(e=>!e)){for(let t of E){let n=D(`[data-band="${t}"]`,Wn);n.style.setProperty(`--band-color`,e[t]),n.style.setProperty(`--band-ink`,p(e[t])),D(`output`,n).textContent=e[t]}En(ar,or,x(e))}}function cr(){let e=Gn?.parentElement;if(!e||!e.offsetParent)return;let t=`${Math.ceil(e.getBoundingClientRect().height-Gn.getBoundingClientRect().height)}px`;e.style.getPropertyValue(`--pk-chrome`)!==t&&e.style.setProperty(`--pk-chrome`,t)}Gn&&new ResizeObserver(cr).observe(Gn.parentElement);function lr(e,t){let{colors:n}=L();return Qn(e,t).map((e,t)=>`${E[t]} ${n[E[e]]}`).join(`, `)}function ur(e,t,n){V&&dr(!0),Zn?.(),Mn();let r=qn(n);for(let e of r)Hn.get(e)?.cancel(),e.style.transform=``;V={from:e,to:e,keyboard:t,scope:n,nodes:r,grips:Jn(n),homes:r.map(e=>e.getBoundingClientRect()),offsets:E.map(()=>0),id:I().id,pointerId:null,startX:0},r[e].dataset.dragging=``,V.grips[e].dataset.dragging=``,er(0,!1)}function dr(e,t){let{nodes:n,grips:r,from:i,to:a,homes:o,id:s,scope:c}=V,l=e?0:o[a].left-o[i].left;if(e&&tr(i,!Kn()),V=null,delete n[i].dataset.dragging,delete r[i].dataset.dragging,Zn=()=>{Zn=null,!e&&a!==i&&I().id===s&&rr(i,a,c);for(let e of n)Hn.get(e)?.cancel(),e.style.transform=``;t?.()},Kn()){Zn();return}let u=n[i],d=u.style.transform,f=`translateX(${l}px) scale(1)`;u.style.transform=f;let p=u.animate([{transform:d},{transform:f}],{duration:Rn,easing:Bn});Hn.set(u,p),p.finished.then(()=>Zn?.(),()=>{})}function fr(e){let{from:t,to:n,scope:r}=V;if(n===t){dr(!0);return}let i=`Palette reordered. ${lr(t,n)}`;dr(!1,e?()=>Jn(r)[n].focus():null),Xn(r,i)}var pr=e=>e instanceof Element?e.closest(`[data-grip]`):null,mr=e=>e.closest(`.picker-bands`);function hr(e){e.addEventListener(`pointerdown`,e=>{let t=pr(e.target);!t||e.button!==0||!P.length||(e.preventDefault(),ur(E.indexOf(t.dataset.grip),!1,mr(t)),V.pointerId=e.pointerId,V.startX=e.clientX,t.setPointerCapture(e.pointerId))}),e.addEventListener(`pointermove`,e=>{if(!V||V.keyboard||e.pointerId!==V.pointerId)return;let{homes:t,from:n}=V,r=Math.min(t.at(-1).left-t[n].left,Math.max(t[0].left-t[n].left,e.clientX-V.startX));er(r,!1);let i=nr(r);i!==V.to&&tr(i,!Kn())}),e.addEventListener(`pointerup`,e=>{!V||V.keyboard||e.pointerId!==V.pointerId||fr(!1)}),e.addEventListener(`pointercancel`,e=>{!V||V.keyboard||e.pointerId!==V.pointerId||dr(!0)}),e.addEventListener(`keydown`,e=>{let t=pr(e.target);if(!t||!Vn.has(e.key)||!P.length)return;let n=mr(t),r=!!V?.keyboard,i=e.key===` `||e.key===`Enter`;if(!r&&(V||!i))return;if(e.preventDefault(),!r){ur(E.indexOf(t.dataset.grip),!0,n),Xn(n,`${Yn(V.from,n)} color lifted, position ${V.from+1} of ${E.length}. Arrow keys move it, space drops it, escape puts it back.`);return}if(i){fr(!0);return}if(e.key===`Escape`){dr(!0),Xn(n,`Reorder cancelled.`);return}let a={ArrowLeft:-1,ArrowRight:1,Home:-E.length,End:E.length}[e.key],o=Math.min(E.length-1,Math.max(0,V.to+a));o!==V.to&&(tr(o,!Kn()),er(V.homes[o].left-V.homes[V.from].left,!Kn()),Xn(n,`Position ${o+1} of ${E.length}.`))}),e.addEventListener(`focusout`,e=>{if(!V?.keyboard||e.target!==V.grips[V.from])return;let t=V.scope;dr(!0),Xn(t,`Reorder cancelled.`)})}hr(A),hr(Wn),A.onpointerover=A.onfocusin=({target:e})=>{let t=e.closest(`[data-band]`);t&&Cn(t.dataset.band)},A.oninput=({target:e})=>{e.matches(`[data-color-input]`)&&On(e.dataset.colorInput,e.value)},A.onclick=async e=>{let t=e.target.closest(`button`)?.dataset;if(t){if(t.copyColor){let e=L().colors[t.copyColor];await navigator.clipboard.writeText(`${e}\n${l(e)}`);let n=t.tip;t.tip=`Copied`,setTimeout(()=>t.tip=n,1200)}else if(t.editTints)Oe===t.editTints?Mn():Ln(t.editTints);else if(t.customColor)D(`[data-color-input="${t.customColor}"]`,A).click();else if(t.tint)On(Oe,t.tint);else if(`closeTints`in t)Mn();else if(`reset`in t){let e=I(),t=He(e);e.type===`cue`&&e.defaultRings&&(t.rings=structuredClone(e.defaultRings)),N.set(e.id,t),Nn()}else if(`selectPalette`in t){let e=I();D(`[name="palette-source"]`).value=e.id;for(let e of E)D(`[name="palette-${e}"]`).value=L().colors[e];sr(),Mr()}}},D(`[data-select-palette]`).addEventListener(`click`,A.onclick),D(`[data-deck-prev]`).onclick=()=>Pn(F-1),D(`[data-deck-next]`).onclick=()=>Pn(F+1);function gr(){let e=ge.firstElementChild?.offsetHeight||0;if(!e)return!1;let t=F*e;return Math.abs(he.scrollTop-t)>1&&(he.scrollTop=t),!0}he.addEventListener(`scroll`,()=>{let e=ge.firstElementChild?.offsetHeight||1,t=Math.min(P.length-1,Math.round(he.scrollTop/e));if(t!==F){let e=I().node;e.dataset.exit=t>F?`left`:`right`,setTimeout(()=>delete e.dataset.exit,280),F=t,delete I().node.dataset.exit,Nn()}},{passive:!0}),document.addEventListener(`picker:screenchange`,e=>{In(e.detail.screen===`02`),e.detail.screen===`02`&&gr(),e.detail.screen===`04b`&&qr();let t=document.querySelector(`.picker-screen[data-screen="${e.detail.screen}"]`);for(let e of t?.querySelectorAll(`[data-artboard]`)??[])Ye(e);e.detail.screen===`03`&&(sr(),cr());let n=kr.find(t=>t.screen===e.detail.screen);if(n?.paint(),Ar(n),e.detail.screen===`04`&&ft({force:!0}),e.detail.screen===`06`&&requestAnimationFrame(()=>{nn(),Xt(),qt=null,Jt(Kt())}),e.detail.screen===`05`){xt();let e=vt();requestAnimationFrame(()=>{e?.parentElement.scrollIntoView({block:`center`}),e?.focus({preventScroll:!0}),e&&St(e),Tt()})}e.detail.screen===`11`&&(zt(),requestAnimationFrame(()=>{Pt()?.parentElement.scrollIntoView({block:`center`})}))});var H=[...document.querySelectorAll(`input[name="surface-modes"]`)],_r=document.querySelector(`[data-modes-next]`),vr=()=>{_r&&(_r.disabled=!H.some(e=>e.checked))},yr=H.map(e=>e.closest(`.picker-mode-tile`)),br=yr.map(e=>e?.querySelector(`.picker-preview`)),xr=be.cloneNode(!0),Sr;function Cr(){jr();let e=H.findIndex(e=>e.checked);yr.forEach((t,n)=>{t?.toggleAttribute(`data-lead`,n===e&&!!br[n])});let t=(e===-1?null:br[e])??xr;if(t===Sr)return;Sr=t;let n=t.cloneNode(!0);n.setAttribute(`aria-hidden`,`true`);for(let e of[n,...n.querySelectorAll(`[id]`)])e.removeAttribute(`id`);be.replaceWith(n),be=n,Je()}var wr=()=>H.filter(e=>e.checked),Tr=e=>H.find(t=>t.value===e),Er=document.querySelector(`input[name="_chosen"]`);function Dr(){if(!Er)return;let e=[...document.querySelectorAll(`input[type="hidden"][data-surface-field][data-chosen="yes"]`)].filter(e=>!e.disabled).map(e=>e.dataset.surfaceField);Er.value=JSON.stringify(e)}function Or(e){let t=e.dataset.surfaceTabs,n=e.parentElement,r=e.closest(`.picker-screen`)?.dataset.screen,i=`surfaceStage`in n.dataset,a=`surfaceFlat`in e.dataset,o=`surfaceProperName`in e.dataset,s=()=>[...document.querySelectorAll(`input[name="${t}"]`)],c=e=>s().find(t=>t.value===e)?.closest(`.picker-strategy-option`),l=e=>{let n=Tr(e)?.getAttribute(`data-allow-${t}`);return n==null?null:new Set(n.split(` `).filter(Boolean))},u=e=>Tr(e)?.getAttribute(`data-default-${t}`)||s()[0]?.value,d=e=>document.querySelector(`input[type="hidden"][data-surface-field="${t}-${e}"]`),f=e=>c(e)?.querySelector(`.picker-strategy-title`)?.textContent??e,p=e=>!!d(e),m=()=>wr().filter(e=>p(e.value)),h=H.some(e=>!p(e.value)),g=e.closest(`.picker-screen`),_=null;function v(e){for(let e of n.querySelectorAll(`[data-surface]:not([data-artboard])`))e.remove();for(let t of e){if(n.querySelector(`[data-artboard][data-surface="${t.value}"]`))continue;let e=br[H.indexOf(t)];if(!e)continue;let r=e.cloneNode(!0);r.setAttribute(`aria-hidden`,`true`);for(let e of[r,...r.querySelectorAll(`[id]`)])e.removeAttribute(`id`);r.dataset.surface=t.value,n.append(r)}y()}function y(){i&&Ye(n,`pkc`)}function b(){let e=m();if(h){g?.toggleAttribute(`data-skip`,e.length===0);for(let t of s())t.disabled=e.length===0}i&&v(e);for(let e of H){let t=d(e.value);t&&(t.disabled=!e.checked,e.checked?t.value||=u(e.value)??``:(t.value=``,delete t.dataset.chosen))}ee(e),te(e.some(e=>e.value===_)?_:e[0]?.value)}function ee(t){e.hidden=t.length<2,e.replaceChildren(...t.map(e=>{let t=document.createElement(`button`);return t.type=`button`,t.className=`picker-surface-tab`,t.dataset.surfaceTab=e.value,t.innerHTML=`<span class="picker-surface-dot"></span>`,t.append(e.dataset.surfaceLabel??e.value),t.onclick=()=>ne(e.value),t})),x()}function x(){for(let t of e.children){let n=t.dataset.surfaceTab,r=d(n),i=!!r?.dataset.chosen,a=n===_,s=r.value?f(r.value):``,c=t.textContent;t.dataset.set=i?`yes`:`no`,t.setAttribute(`aria-pressed`,a?`true`:`false`),t.tabIndex=a?0:-1;let l=s&&e.dataset.surfaceAnswered.replace(`{}`,o?s:s.toLowerCase());t.setAttribute(`aria-label`,s?`${c}, ${l}${i?``:` by default`}`:`${c}, ${e.dataset.surfaceUnanswered}`)}}function te(e){if(!e)return;_=e;for(let t of n.querySelectorAll(`[data-surface]`))t.hidden=t.dataset.surface!==e;re();let t=d(e)?.value||u(e),r=s().find(e=>e.value===t);r&&(r.checked=!0),x()}function ne(e){te(e),Ar(ae)}function re(){let e=l(_);for(let t of s()){let n=t.closest(`.picker-strategy-option`);if(!n)continue;let r=!e||e.has(t.value),i=n.querySelector(`.picker-strategy-desc`);i.dataset.copy??=i.textContent,i.textContent=r?i.dataset.copy:n.dataset.blockedReason??i.dataset.copy,n.classList.toggle(`is-blocked`,!r),t.disabled=!r}}document.addEventListener(`change`,({target:e})=>{e?.name!==t||!e.checked||ie(e.value)});function ie(e){let t=a?m().map(e=>e.value):[_];for(let n of t){let t=d(n),r=l(n);!t||r&&!r.has(e)||(t.value=e,t.dataset.chosen=`yes`)}x(),Dr()}e.addEventListener(`keydown`,t=>{let n={ArrowLeft:-1,ArrowRight:1}[t.key];if(!n)return;let r=[...e.children],i=r[(r.findIndex(e=>e.dataset.surfaceTab===_)+n+r.length)%r.length];t.preventDefault(),ne(i.dataset.surfaceTab),i.focus()});let ae={screen:r,sync:b,paint:y,park:e=>te(p(e)?e:m()[0]?.value),active:()=>_};return ae}var kr=[...document.querySelectorAll(`[data-surface-tabs]`)].map(Or);function Ar(e){for(let t of kr)t!==e&&t.park(e?.active())}var jr=()=>{for(let e of kr)e.sync();Dr()},Mr=()=>{for(let e of kr)e.paint()},Nr=document.querySelector(`.picker-screen[data-screen="04b"]`),Pr={"06":`motion-energy`,"08":`boundary-style`,"09":`corner-style`,10:`depth-style`,11:`icon-pack`},Fr=e=>H.find(t=>t.value===e)?.dataset.surfaceLabel??e;function Ir(e,t){let n=document.querySelector(`input[name="${e}"][value="${t}"]`);return n?n.dataset.scaleName?`${n.dataset.scaleName} · ${n.dataset.ratio}`:n.dataset.packName?n.dataset.packName:n.closest(`.picker-strategy-option`)?.querySelector(`.picker-strategy-title`)?.textContent.trim()??t:t}function Lr(e){return[...document.querySelectorAll(`input[type="hidden"][data-surface-field^="${e}-"]`)].filter(e=>!e.disabled&&e.value).map(t=>({mode:t.dataset.surfaceField.slice(e.length+1),value:t.value,chosen:t.dataset.chosen===`yes`}))}function Rr(e){let t=document.createElement(`span`);return t.className=`picker-hub-line`,t.append(e),t}function zr(e,t){let n=document.querySelector(`input[name="${e}"][value="${t}"]`)?.closest(`.picker-strategy-option`)?.querySelector(`.picker-strategy-desc`);return n?(n.dataset.copy??n.textContent).trim():``}var Br={strategy:`color-strategy`,boundary:`boundary-style`,corner:`corner-style`,depth:`depth-style`,layout:`layout-structure`};function Vr(e){let t={surface:e};for(let[n,r]of Object.entries(Br))t[n]=document.querySelector(`input[type="hidden"][data-surface-field="${r}-${e}"]`)?.value||document.querySelector(`input[name="${r}"]:checked`)?.value||``;return t}function Hr(e,t=null){let n=document.createElement(`span`);if(n.className=`picker-hub-proof`,t){n.classList.add(`dcx-proof--board`);for(let[e,r]of Object.entries(t))r&&n.setAttribute(`data-dcx-${e}`,r);Ye(n,`pkc`)}let r=e.cloneNode(!0);r.hidden=!1,r.removeAttribute(`data-surface`);for(let e of[r,...r.querySelectorAll(`[id]`)])e.removeAttribute(`id`);for(let e of[r,...r.querySelectorAll(`[data-icon-field], [data-icon-strip]`)])e.removeAttribute(`data-icon-sheet`),e.removeAttribute(`data-icon-field`),e.removeAttribute(`data-icon-strip`);return n.append(r),n}var Ur=(e,t)=>{let n=[...document.querySelectorAll(`.picker-screen[data-screen="${e}"] .picker-board-stage > :is(.picker-artboard, .picker-preview)[data-surface="${t}"]`)];if(n.length<2)return n[0]??null;let r=document.querySelector(`.picker-screen[data-screen="${e}"] [data-surface-tabs]`)?.dataset.surfaceTabs,i=r&&document.querySelector(`input[type="hidden"][data-surface-field="${r}-${t}"]`)?.value;return n.find(e=>e.dataset.motionCell===`${t}-${i}`)??n[0]};function Wr(e){let t=e.querySelector(`[data-hub-preview]`);if(!t||t.classList.contains(`picker-hub-preview--icons`))return;let n=t.firstElementChild,r=n?.querySelector(`.ps-desktop, .pv-desktop`)??n?.firstElementChild,i=t.clientWidth,a=t.clientHeight;if(!i||!a||!r?.offsetWidth||!r.offsetHeight)return;let o=Math.min(i/r.offsetWidth,a/r.offsetHeight);e.style.setProperty(`--pk-hub-scale`,o),e.style.setProperty(`--pk-hub-x`,`${(i-r.offsetWidth*o)/2}px`),e.style.setProperty(`--pk-hub-y`,`${(a-r.offsetHeight*o)/2}px`)}function Gr(e,t,n,r){let i=e.querySelector(`[data-hub-preview]`);if(i.classList.toggle(`picker-hub-preview--icons`,n===`icon-pack`),n===`icon-pack`){i.replaceChildren(Hr(kt)),!Ot.querySelector(`.picker-icon-cell`)&&!(`empty`in Ot.dataset)&&zt().then(qr);return}let a=r?Ur(t,r):null;if(!a){i.replaceChildren();return}if(n===`motion-energy`){kr.find(e=>e.screen===t)?.park(r);let n=Hr(a);Ye(n.firstChild),i.replaceChildren(n),requestAnimationFrame(()=>{Xt(n.firstChild),Wr(e)})}else i.replaceChildren(Hr(a,Vr(r)));Wr(e)}function Kr(e){let t=e.querySelector(`[data-hub-target]`),n=t?.dataset.hubTarget,r=Pr[n];if(!r)return;let i=e.querySelector(`[data-hub-preview]`),a=e.querySelector(`[data-hub-note]`),o=e.querySelector(`[data-hub-slider]`),s=e.querySelector(`[data-hub-slider-label]`),c=!!document.querySelector(`.picker-screen[data-screen="${n}"]`)?.hasAttribute(`data-skip`);if(e.classList.toggle(`is-skipped`,c),t.disabled=c,t.setAttribute(`aria-disabled`,c?`true`:`false`),c){i.replaceChildren(),a.replaceChildren(Rr(`Not asked of these surfaces`)),a.hidden=!1,o.hidden=!0;return}let l=Lr(r),u=l.map(e=>e.mode),d=u.includes(e.dataset.hubSurface)?e.dataset.hubSurface:u[0];e.dataset.hubSurface=d??``;let f=d?l.find(e=>e.mode===d)?.value:document.querySelector(`input[name="${r}"]:checked`)?.value,p=f?zr(r,f):``;a.textContent=p,a.hidden=!p;let m=document.createElement(`span`);m.className=`picker-hub-slider-value`,m.textContent=f?Ir(r,f):``,s.replaceChildren(...d?[`${Fr(d)} · `,m]:[m]),o.hidden=!1;for(let e of o.querySelectorAll(`[data-hub-step]`))e.hidden=u.length<2;Gr(e,n,r,d)}function qr(){if(Nr)for(let e of Nr.querySelectorAll(`.picker-hub-card`))Kr(e)}function Jr(e,t){let n=Pr[(e?.querySelector(`[data-hub-target]`))?.dataset.hubTarget];if(!n)return;let r=Lr(n).map(e=>e.mode);if(r.length<2)return;let i=r.indexOf(e.dataset.hubSurface);e.dataset.hubSurface=r[(i+t+r.length)%r.length],Kr(e)}Nr?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-hub-step]`);if(t){Jr(t.closest(`.picker-hub-card`),Number(t.dataset.hubStep));return}let n=e.target.closest(`[data-hub-target]`);!n||n.disabled||document.dispatchEvent(new CustomEvent(`picker:goto`,{detail:{screen:n.dataset.hubTarget}}))}),Nr?.addEventListener(`keydown`,e=>{let t={ArrowLeft:-1,ArrowRight:1}[e.key];!t||!e.target.closest(`[data-hub-slider]`)||(e.preventDefault(),Jr(e.target.closest(`.picker-hub-card`),t))}),Nr&&window.ResizeObserver&&new ResizeObserver(()=>{for(let e of Nr.querySelectorAll(`.picker-hub-card`))Wr(e)}).observe(Nr);for(let e of H)e.addEventListener(`change`,()=>{vr(),Cr()});vr(),Cr();try{let e=e=>fetch(e).then(e=>e.ok?e.json():Promise.reject()),[t,n,r]=await Promise.all([e(`/cues.json`),e(`/palettes.json`),fetch(`/context.json`).then(e=>e.ok?e.json():null).catch(()=>null)]),i=Array.isArray(r?.modes)?r.modes:t.modes;if(Array.isArray(i)){let e=new Set(i);if(H.some(t=>e.has(t.value))){for(let t of H)t.checked=e.has(t.value);vr(),Cr()}}P=[...t.cues.map(e=>({id:e,type:`cue`,palette:t.palette[e]})),...n.seeds.map(e=>({...e,type:`seed`}))];for(let e of P)N.set(e.id,He(e));k.append(...P.map(jn)),ge.innerHTML=`<div class="picker-snap-point"></div>`.repeat(P.length),D(`[data-select-palette]`).disabled=!1,Nn(),In(me.hasAttribute(`data-active`))}catch{_e.textContent=`Palette sources could not be loaded.`}var Yr=Le,Xr=!0;try{let e=await fetch(`/fonts.json`),t=e.ok?await e.json():null;Qe(t)&&(Yr=Ze(t),Xr=!1)}catch{}ot(Yr,Xr);var Zr=await ne();try{w(Zr.prior,{modeInputs:H,syncModes:()=>{vr(),Cr()},states:N,cards:P,setCurrent:e=>{F=e},render:Nn,syncDeckScroll:gr,fontManifest:()=>ke,pairNodes:()=>[...rt],addPairCard:it,removePairCard:at,loadCustomFace:Sn,syncFontPair:nt,applyHoist:ft,syncChosenField:Dr})}catch{}ae(Zr.prior?Zr.priorSource:null);var U=(e,t=document)=>t.querySelector(e),Qr=(e,t=document)=>[...t.querySelectorAll(e)],W=U(`#picker-form`),$r=U(`[data-dcx-shell]`),ei=null,ti=null,ni=null,ri=null,ii=e=>fetch(e).then(e=>e.ok?e.json():null).catch(()=>null),ai=ii(`/cues.json`).then(e=>(ni=e?.palette||null,ri=Array.isArray(e?.cues)?e.cues:null,e)),oi=Promise.all([ii(`/context.json`),ai]).then(([e,t])=>{ei=e?.context??t?.context??null;let n=Array.isArray(e?.modes)?e.modes:t?.modes;ti=Array.isArray(n)?n:null}),si=!1,ci=e=>Z?`${Z.base}/cue.png?token=${encodeURIComponent(Z.token)}`:si?`/cue.png`:`/cues/${encodeURIComponent(e)}.png`,li=(e,t)=>{let n=ni?.[e]?.[t];return n?String(n.snapped||n.hex||``).toUpperCase():``},ui=[`primary`,`secondary`,`tertiary`,`neutral`],di=[`persuade`,`operate`,`read`,`experience`],fi={persuade:`Landing page`,operate:`Tool`,read:`Docs`,experience:`Portfolio`},pi=[`color-strategy`,`boundary-style`,`corner-style`,`depth-style`,`motion-energy`],G=e=>{let t=W.elements[e];return t&&typeof t.value==`string`?t.value:``};function mi(e,t){let n=W.querySelector(`input[name="${e}"][value="${t}"]`)?.closest(`label`);if(!n)return{title:t,desc:``};let r=n.querySelector(`.picker-strategy-title, .picker-icon-title`),i=n.querySelector(`.picker-strategy-desc, .picker-icon-meta`);return{title:(r?.textContent||t).replace(/^[\d.]+\s*/,``).trim(),desc:(i?.textContent||``).trim()}}function hi(){return Qr(`input[name="surface-modes"]:checked`,W).sort((e,t)=>di.indexOf(e.value)-di.indexOf(t.value)).map(e=>{let t=e.closest(`.picker-mode-tile`);return{mode:e.value,label:e.dataset.surfaceLabel||e.value,goal:t?.querySelector(`.picker-mode-goal`)?.textContent.trim()||``,examples:Qr(`.picker-mode-pills i`,t||W).map(e=>e.textContent.trim())}})}function gi(e,t){return t.flatMap(t=>{let n=W.querySelector(`input[data-surface-field="${e}-${t.mode}"]`);if(!n)return[];let r=n.value||G(e);return[{...t,value:r,chosen:n.dataset.chosen===`yes`,...mi(e,r)}]})}function _i(e,t){let[n]=gi(e,t);return n??{value:``,title:``,desc:``}}function vi(){let e=hi(),t=ui.map(e=>({role:e[0].toUpperCase()+e.slice(1),hex:G(`palette-${e}`).toUpperCase()})).filter(e=>h(e.hex)),n=W.querySelector(`input[name="type-scale"]:checked`),r=W.querySelector(`input[name="font-pair"]:checked`)?.closest(`.picker-type-option`);return{context:ei,suggestedModes:ti,cueSlugs:ri,surfaces:e,palette:t,paletteSource:G(`palette-source`),strategy:gi(`color-strategy`,e),boundaries:gi(`boundary-style`,e),corners:gi(`corner-style`,e),depth:gi(`depth-style`,e),motion:gi(`motion-energy`,e),layout:_i(`layout-structure`,e),fonts:{heading:G(`font-heading`),body:G(`font-body`),headingSource:G(`font-heading-source`),bodySource:G(`font-body-source`),why:r?.querySelector(`[data-pair-why]`)?.textContent.trim()||``},scale:{name:n?.dataset.scaleName||``,ratio:Number(G(`type-scale-ratio`)||n?.dataset.ratio||0),desc:n?mi(`type-scale`,n.value).desc:``},icons:{pack:G(`icon-pack-name`),license:G(`icon-pack-license`),url:g(G(`icon-pack-url`))}}}var yi=e=>{let t=String(e),n=t.split(/\s/)[0]||``;return!/^[a-z]/.test(t)||/[A-Z]/.test(n)?t:t[0].toUpperCase()+t.slice(1)},K=e=>String(e).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`),bi=(e,t,n,r)=>`
  <header>
    <span class="dcx-eyebrow">Design context &middot; 0${e} / 08${r?` &middot; ${K(r)}`:``}</span>
    <h2 class="dcx-title">${K(t)}</h2>
    <p class="dcx-lede">${K(n)}</p>
  </header>`,q=(e,t)=>`
  <div class="dcx-block" data-label="${K(e)}">
    <span class="dcx-block-label">${K(e)}</span>
    ${t}
  </div>`,xi=e=>`
  ...
  <div class="dcx-callout${n?` dcx-callout--accent`:``}">
    <p class="dcx-callout-name">${K(e)}</p>
    <p>${t}</p>${r}
  </div>`,Si=e=>`
  <ul class="dcx-list">${e.map(e=>`<li>${e}</li>`).join(``)}</ul>`,Ci=e=>`
  <ol class="dcx-principles">${e.map(e=>e&&typeof e==`object`&&e.title?`<li><strong>${K(e.title)}</strong>${e.detail?` &mdash; ${K(e.detail)}`:``}</li>`:`<li>${K(e)}</li>`).join(``)}</ol>`,wi=e=>`
  <div class="dcx-chips">${e.map(e=>`<span class="dcx-chip dcx-chip--muted">${K(e)}</span>`).join(``)}</div>`,Ti=(e,t)=>`
  <div class="dcx-empty">
    <p class="dcx-empty-title">${K(e)}</p>
    <p>${t}</p>
  </div>`,Y=e=>`<p class="dcx-fan-note">${e}</p>`,Ei=(e,t)=>Ti(`Captured in chat`,`${e} in chat, before the browser questionnaire. ${t} is the durable copy.`),Di=e=>Z?`${Z.base}/brand-assets/${encodeURIComponent(e)}?token=${encodeURIComponent(Z.token)}`:`/brand-assets/${encodeURIComponent(e)}`;document.addEventListener(`load`,e=>{let t=e.target;if(!(t instanceof HTMLImageElement)||!(`dcxCueImg`in t.dataset))return;let n=t.closest(`.dcx-cue-frame`);n&&(n.style.setProperty(`--cue-w`,String(t.naturalWidth||1)),n.style.setProperty(`--cue-h`,String(t.naturalHeight||1)),n.dataset.loaded=`yes`)},!0),document.addEventListener(`error`,e=>{let t=e.target;if(!(t instanceof HTMLImageElement))return;if(t.dataset.dcxSwapSrc){let e=t.dataset.dcxSwapSrc;delete t.dataset.dcxSwapSrc,t.dataset.dcxSwapAlt&&(t.alt=t.dataset.dcxSwapAlt,delete t.dataset.dcxSwapAlt),t.src=e;return}let n=t.closest(`[data-dcx-hide-on-error]`);n&&(n.hidden=!0)},!0);function Oi(e){let[t,n,r]=[1,3,5].map(t=>parseInt(e.slice(t,t+2),16)/255);return .2126*t+.7152*n+.0722*r>.55?`oklch(20% 0.01 95)`:`oklch(95% 0.005 95)`}function ki(e){let t={};for(let e of ui)t[e]=G(`palette-${e}`);if(Object.values(t).some(e=>!e))return;let n=(t,n)=>e.style.setProperty(`--pkc-${t}`,n);for(let e of ui)n(e,t[e]);n(`n-ink`,p(t.neutral)),n(`p-ink`,p(t.primary)),n(`t-ink`,p(t.tertiary)),n(`s-on-n`,y(t.secondary,t.neutral)),n(`p-on-n`,y(t.primary,t.neutral)),n(`t-on-n`,y(t.tertiary,t.neutral)),n(`t-on-p`,y(t.tertiary,t.primary)),n(`p-on-p`,y(t.primary,t.primary)),n(`t-on-t`,y(t.tertiary,t.tertiary)),n(`p-on-i`,y(t.primary,m(t.primary)))}var Ai={sharp:{control:`0px`,surface:`0px`},"slightly-soft":{control:`4px`,surface:`6px`},friendly:{control:`10px`,surface:`14px`},pill:{control:`999px`,surface:`18px`}},ji={flat:{card:`none`,control:`none`,surface:`none`},"soft-lift":{card:`0 1px 1px rgb(0 0 0 / 0.15), 0 3px 7px rgb(0 0 0 / 0.14)`,control:`0 1px 2px rgb(0 0 0 / 0.24)`,surface:`0 2px 5px rgb(0 0 0 / 0.14)`},floating:{card:`0 2px 3px rgb(0 0 0 / 0.2), 0 9px 18px rgb(0 0 0 / 0.24)`,control:`0 3px 6px rgb(0 0 0 / 0.32)`,surface:`0 6px 14px rgb(0 0 0 / 0.22)`}},Mi=/serif|mincho|baskerville|bitter|marcellus|slab|antiqua|garamond|didot|bodoni/i,Ni=e=>`"${e.replaceAll(`"`,`\\"`)}", ${Mi.test(e)?`serif`:`sans-serif`}`;function Pi(e,t){let n=Ai[t.corners[0]?.value],r=ji[t.depth[0]?.value];if(!t.fonts.heading||!t.fonts.body||!n||!r)return!1;let i=(t,n)=>e.style.setProperty(`--pkc-${t}`,n);return i(`font-heading`,Ni(t.fonts.heading)),i(`font-body`,Ni(t.fonts.body)),i(`font-heading-weight`,document.querySelector(`input[name="font-pair"]:checked`)?.closest(`.picker-type-option`)?.style.getPropertyValue(`--pair-heading-weight`)||`400`),i(`radius-control`,n.control),i(`radius-surface`,n.surface),i(`shadow-card`,r.card),i(`shadow-control`,r.control),i(`shadow-surface`,r.surface),t.scale.ratio&&i(`scale-ratio`,String(t.scale.ratio)),!0}function X(e,{strategy:t=``,kind:n=`board`,marks:r=null}={}){if(!e)return``;let i=e.cloneNode(!0);i.hidden=!1;let a=e.getAttribute(`data-surface`)||``;i.removeAttribute(`data-surface`);for(let e of[i,...i.querySelectorAll(`[id]`)])e.removeAttribute(`id`);for(let e of Qr(`button, input`,i))e.setAttribute(`tabindex`,`-1`),e.setAttribute(`disabled`,``);let o=document.createElement(`div`);if(o.className=`dcx-proof dcx-proof--${n}`,o.setAttribute(`aria-hidden`,`true`),t&&(o.dataset.dcxStrategy=t),r)for(let[e,t]of Object.entries(r))t&&o.setAttribute(`data-dcx-${e}`,t);return a&&!o.hasAttribute(`data-dcx-surface`)&&o.setAttribute(`data-dcx-surface`,a),ki(o),o.appendChild(i),o.outerHTML}var Fi=e=>U(`[data-surface-stage] [data-surface="${e}"]`),Ii=e=>U(`input[name="surface-modes"][value="${e}"]`)?.closest(`.picker-mode-tile`)?.querySelector(`.picker-preview`),Li=(e,t)=>U(`[data-question="${e}"] .picker-board-stage > :is(.picker-artboard, .picker-preview)[data-surface="${t}"]`),Ri=e=>Li(`boundaries`,e),zi=(e,t)=>U(`[data-question="motion"] .picker-board-stage > :is(.picker-artboard, .picker-preview)[data-motion-cell="${e}-${t}"]`),Bi=(e,t)=>({surface:t,boundary:e.boundaries.find(e=>e.mode===t)?.value||``,corner:e.corners.find(e=>e.mode===t)?.value||``,depth:e.depth.find(e=>e.mode===t)?.value||``,layout:e.layout.value||``}),Vi=e=>xi(e.map(e=>({dt:K(e.label),dd:`<strong>${K(e.title)}</strong> &middot; ${K(e.desc)}${e.chosen?``:` <em>(default for this surface)</em>`}`})));function Hi(e,t){let n=e.context?.audience||{},r=[bi(1,`Audience`,`Who it is for, emotional state, needs, trust triggers.`,t)],i=[n.primary&&{dt:`Primary`,dd:K(n.primary)},n.secondary&&{dt:`Secondary`,dd:K(n.secondary)}].filter(Boolean);if(r.push(q(`Who they are`,i.length?xi(i):Ei(`The primary and secondary user read was confirmed`,`<code>PRODUCT.md &middot; Users</code>`))),n.emotion||n.leaving){let e=n.emotion?J(`On arrival`,K(n.emotion),!0):``,t=n.leaving?J(`Leaving with`,K(n.leaving),!0):``;e&&t?r.push(q(`Emotional journey`,`<div class="dcx-callout-pair">${e}${t}</div>`)):r.push(q(e?`Emotional state`:`Emotional journey`,e||t))}let a=Array.isArray(n.needs)&&n.needs.length?q(`Needs`,Si(n.needs.map(K))):``,o=Array.isArray(n.trust)&&n.trust.length?q(`Trust triggers`,Si(n.trust.map(K))):``;return a&&o?r.push(`<div class="dcx-cols">${a}${o}</div>`):(a||o)&&r.push(a||o),Array.isArray(n.inclusion)&&n.inclusion.length&&r.push(q(`Who must not be excluded`,Si(n.inclusion.map(K)))),r.join(``)}function Ui(e,t){return`<div class="dcx-surfaces" data-count="${e.surfaces.length}">${e.surfaces.map((e,n)=>`
    <article class="dcx-surface-card">
      ${X(Fi(e.mode)||Ii(e.mode),{kind:`board`})}
      <div class="dcx-surface-copy">
        <h3 class="dcx-surface-name">${K(e.label)}${n===0?` <span class="dcx-default-mark">leading</span>`:``}</h3>
        ${t(e)}
      </div>
    </article>`).join(``)}</div>`}function Wi(e){if(!Array.isArray(e.suggestedModes)||!e.suggestedModes.length)return``;let t=e.surfaces.map(e=>e.mode),n=new Set(e.suggestedModes),r=new Set(t),i=t=>e.surfaces.find(e=>e.mode===t)?.label||fi[t]||t,a=t.filter(e=>!n.has(e)),o=e.suggestedModes.filter(e=>!r.has(e)),s=`you kept the suggested set`;return a.length&&o.length?s=`you added ${a.map(i).join(`, `)} and dropped ${o.map(i).join(`, `)}`:a.length?s=`you added ${a.map(i).join(`, `)}`:o.length&&(s=`you dropped ${o.map(i).join(`, `)}`),Y(`Suggested from <code>PRODUCT.md</code>: ${e.suggestedModes.map(i).join(`, `)}; ${s}.`)}var Gi={web:`Web`,ios:`iOS`,android:`Android`,adaptive:`Adaptive`};function Ki(e,t){let n=e.context?.product||{},r=[bi(2,`Product`,`Purpose, surfaces, use cases, what must be clear first.`,t)],i=n.purpose?J(n.name||t||`This product`,K(n.purpose),!1,n.success?`\n    <p class="dcx-callout-success">${K(n.success)}</p>`:``):Ei(`The purpose and success definition were confirmed`,`<code>PRODUCT.md &middot; Product Purpose</code>`),a=typeof n.platform==`string`&&n.platform.trim()?`<span class="dcx-chip dcx-platform-pill">${K(Gi[n.platform.trim()]||n.platform.trim())}</span>`:``;if(r.push(q(`Purpose`,a?`<div class="dcx-purpose"><div class="dcx-purpose-main">${i}</div>${a}</div>`:i)),n.positioning&&(n.positioning.not||n.positioning.this)){let e=[n.positioning.not&&J(`Not this`,K(n.positioning.not)),n.positioning.this&&J(`This`,K(n.positioning.this),!0)].filter(Boolean).join(``);r.push(q(`Positioning`,`<div class="dcx-callout-pair">${e}</div>`))}n.conversion&&r.push(q(`Primary conversion`,J(`The one action`,K(yi(n.conversion)),!0))),Array.isArray(n.clarities)&&n.clarities.length&&r.push(q(`What must be clear first`,Si(n.clarities.map(K)))),Array.isArray(n.principles)&&n.principles.length&&r.push(q(`Product principles`,Ci(n.principles))),n.operatingContext&&r.push(q(`Operating context`,`<p class="dcx-prose">${K(n.operatingContext)}</p>`));let o=n.surfaces&&typeof n.surfaces==`object`?n.surfaces:{};return r.push(q(`Surfaces`,Ui(e,e=>`
      <p class="dcx-surface-goal">${K((typeof o[e.mode]==`string`?o[e.mode].trim():``)||e.goal||``)}</p>
      ${e.examples.length?wi(e.examples):``}`)+Wi(e)+Y(`Chosen on the questionnaire&rsquo;s first screen, drawn in the committed palette; the leading surface owns every bare answer key in the sections that follow.`))),r.join(``)}function qi(e,t){let n=e.context?.brand||{},r=e.context?.interview||{},i=[bi(3,`Brand`,`Identity, voice, references, taste boundaries.`,t)];i.push(q(`Personality`,n.personality?J(n.words?.join(` · `)||`Voice`,K(n.personality),!0):Array.isArray(n.words)&&n.words.length?J(n.words.join(` · `),`Three words, voice, and tone were confirmed in chat, before the browser questionnaire. <code>PRODUCT.md &middot; Brand Personality</code> is the durable copy.`,!0):Ei(`Three words, voice, and tone were confirmed`,`<code>PRODUCT.md &middot; Brand Personality</code>`)));let a=(Array.isArray(n.voice)?n.voice:[]).filter(e=>e&&typeof e==`object`&&e.say&&e.not);if(a.length&&i.push(q(`Voice`,`<div class="dcx-voice">${a.map(e=>`
      <div class="dcx-voice-pair">
        <div class="dcx-voice-cell dcx-voice-cell--say"><span class="dcx-voice-tag">Say</span><p>${K(e.say)}</p></div>
        <div class="dcx-voice-cell dcx-voice-cell--not"><span class="dcx-voice-tag">Not</span><p>${K(e.not)}</p></div>
      </div>`).join(``)}</div>`+Y(`Derived from Brand Personality and Brand Commitments in <code>PRODUCT.md</code>: wording to write with beside wording to refuse.`))),Array.isArray(n.principles)&&n.principles.length&&i.push(q(`Principles`,`<ol class="dcx-principles dcx-principles--cols">${n.principles.map(e=>`<li>${K(e)}</li>`).join(``)}</ol>`+Y(`From <code>PRODUCT.md</code>&rsquo;s principles section; the durable copy lives there.`))),Array.isArray(n.commitments)&&n.commitments.length&&i.push(q(`Commitments`,Si(n.commitments.map(K)))),Array.isArray(r.references)&&r.references.length){let e=r.references.filter(e=>e&&typeof e==`object`&&e.name),t=r.references.filter(e=>typeof e==`string`),n=(e.length?`<div class="dcx-ref-cards">${e.map(e=>`
      <article class="dcx-ref-card">
        <h3 class="dcx-ref-name">${K(e.name)}</h3>${e.takeaway?`
        <p class="dcx-ref-takeaway">${K(e.takeaway)}</p>`:``}
      </article>`).join(``)}</div>`:``)+(t.length?wi(t):``);i.push(q(`Named references`,n+Y(`Q4 of the seed interview: brands, products, printed objects &mdash; not adjectives.`)))}if(r.antiReference){let e=typeof r.antiReference==`object`?J(`Not this`,`<strong>${K(r.antiReference.name||``)}</strong>${r.antiReference.why?` &middot; ${K(r.antiReference.why)}`:``}`):J(`Not this`,K(r.antiReference));i.push(q(`Anti-reference`,e+Y(`Q5 of the seed interview. A hard constraint on every palette and pair that followed.`)))}let o=Array.isArray(e.context?.assets)?e.context.assets:[],s=e=>!!e&&typeof e==`object`&&typeof e.file==`string`&&e.file,c=o.filter(s),l=o.filter(e=>!s(e)),u=c.filter(e=>e.kind===`logo`),d=c.filter(e=>e.kind!==`logo`),f=e=>`
      <figcaption class="dcx-asset-caption">
        <code>${K(e.file)}</code>${e.note?`
        <p>${K(e.note)}</p>`:``}
      </figcaption>`,p=t=>e.palette.find(e=>e.role===t)?.hex||``;return u.length&&i.push(q(`Marks`,`<div class="dcx-marks">${u.map(e=>`
      <figure class="dcx-mark" data-dcx-hide-on-error>
        <div class="dcx-mark-pair">
          <span class="dcx-mark-chip"${p(`Primary`)?` style="--chip-ground:${p(`Primary`)};"`:``}><img src="${Di(e.file)}" alt="${K(e.file)} on the primary color" /></span>
          <span class="dcx-mark-chip"${p(`Neutral`)?` style="--chip-ground:${p(`Neutral`)};"`:``}><img src="${Di(e.file)}" alt="${K(e.file)} on the neutral color" /></span>
        </div>
        ${f(e)}
      </figure>`).join(``)}</div>`+Y(`Provided marks proofed on the committed primary and neutral grounds. The files are staged in <code>.impeccable/design-context/assets/</code>.`))),d.length&&i.push(q(`Boards and references`,`<div class="dcx-boards">${d.map(e=>`
      <figure class="dcx-board" data-dcx-hide-on-error>
        <span class="dcx-board-frame"><img src="${Di(e.file)}" alt="${K(e.file)}" loading="lazy" /></span>
        ${f(e)}
      </figure>`).join(``)}</div>`+Y(`Boards and reference images provided in chat, staged in <code>.impeccable/design-context/assets/</code>.`))),l.length&&i.push(q(`Assets provided`,Si(l.map(e=>K(typeof e==`string`?e:e.note||e.file||``)))+Y(`Gathered before the interview; the questions were grounded in what they showed.`))),i.join(``)}var Ji={Primary:`Your main brand color: buttons, links, the color people remember.`,Secondary:`Supports the primary: section accents, hovers, secondary buttons.`,Tertiary:`The rare accent: badges, highlights, one detail per screen.`,Neutral:`Backgrounds and large surfaces: most of every page.`};function Yi(e,t){let n=e.context?.interview||{},r=[bi(4,`Color`,`Palette, roles, per-surface strategy, copyable values.`,t)],i=Array.isArray(e.cueSlugs)?e.cueSlugs:[],a=e.paletteSource&&(si||i.includes(e.paletteSource))?e.paletteSource:``;if(a&&e.palette.length){let t=ni?.[a]||{},n=ui.map(e=>{let n=t[e];if(!n||!Array.isArray(n.at)||n.at.length!==2)return``;let r=String(n.snapped||n.hex||``);return`<span class="dcx-cue-dot" data-role="${e}" style="--at-x:${Number(n.at[0])||0}; --at-y:${Number(n.at[1])||0};${r?` --dot-fill:${K(r)};`:``}"></span>`}).join(``),o=e.palette.map(e=>`
      <div class="dcx-cue-role">
        <span class="dcx-cue-role-dot" style="--dot-fill:${e.hex};"></span>
        <span class="dcx-cue-role-name">${K(e.role)}</span>
        <code>${e.hex}</code>
        <code>${K(l(e.hex))}</code>
      </div>`).join(``);r.push(q(`The cue`,`<div class="dcx-cue" data-dcx-hide-on-error>
        <figure class="dcx-cue-frame">
          <img data-dcx-cue-img src="${ci(a)}" alt="The chosen visual cue, ${K(a)}" />
          ${n}
        </figure>
        <div class="dcx-cue-card">
          <span class="dcx-cue-tag">Chosen cue</span>
          <h3 class="dcx-cue-name">${K(a)}</h3>
          ${o}
        </div>
      </div>`+Y(`The image the palette was sampled from, each role&rsquo;s sample point marked in its dealt color. The values beside it are the committed ones, which move when a role is edited after sampling.`)));let s=i.filter(e=>e!==a);s.length&&r.push(q(`Also generated`,`<div class="dcx-cue-strip">${s.map(e=>`
        <figure class="dcx-cue-thumb" data-dcx-hide-on-error>
          <img src="/cues/${encodeURIComponent(e)}.png" alt="" loading="lazy" />
          <figcaption>${K(e)}</figcaption>
        </figure>`).join(``)}</div>`+Y(`The directions not taken, kept on disk in <code>.impeccable/visual-cues/</code>.`)))}if(e.palette.length){let t=100/(e.palette.length+1),n=e.palette.map((e,n)=>`
      <button class="dcx-fan-panel" type="button" data-copy-color="${e.hex}" data-color-name="${K(e.role)}"
        style="--panel-left:${n*t}%; --panel-z:${n+1}; --panel-swatch:${e.hex}; --panel-ink:${Oi(e.hex)};"
        aria-label="Copy ${K(e.role)} ${e.hex}">
        <span class="dcx-fan-info"><span class="dcx-fan-name">${K(e.role)}</span><span class="dcx-fan-value">${e.hex}</span></span>
      </button>`).join(``);r.push(q(`Palette`,`<div class="dcx-fan" role="group" aria-label="Chosen palette, click a panel to copy its value">${n}</div>`+Y(`Committed on the palette screen${e.paletteSource?` from the <code>${K(e.paletteSource)}</code> cue`:``}, roles in the order you arranged them. Hover to fan; click to copy the hex.`)));let i=e.context?.color||{};r.push(q(`Roles and values`,`<div class="dcx-swatches">${e.palette.map(t=>{let n=m(t.hex),r=li(e.paletteSource,t.role.toLowerCase()),i=r?r===t.hex?`as dealt`:`edited`:``;return`
      <div class="dcx-swatch" data-role="${t.role.toLowerCase()}">
        <button class="dcx-swatch-chip" type="button" data-copy-color="${t.hex}" data-color-name="${K(t.role)}"
          style="--swatch:${t.hex}; --swatch-ink:${Oi(t.hex)};" aria-label="Copy ${K(t.role)} ${t.hex}">
      ...
      </div>`}).join(``)}</div>`+(Array.isArray(i.assetLocks)&&i.assetLocks.length?Y(`From the assets: ${i.assetLocks.map(K).join(` &middot; `)}.`):``))),r.push(q(`Strategy per surface`,`<div class="dcx-surfaces" data-count="${e.strategy.length}">${e.strategy.map(e=>`
      <article class="dcx-surface-card">
        ${X(Fi(e.mode)||Ii(e.mode),{strategy:e.value,kind:`board`})}
        <div class="dcx-surface-copy">
          <h3 class="dcx-surface-name">${K(e.label)} &middot; <em>${K(e.title)}</em>${e.chosen?``:` <span class="dcx-default-mark">default</span>`}</h3>
          <p class="dcx-surface-goal">${K(e.desc)}</p>
        </div>
      </article>`).join(``)}</div>`+Y(`How much of each surface the palette is allowed to carry, drawn the way the strategy screen previewed it. Options a surface cannot take were withheld there.`)))}else r.push(q(`Palette`,Ti(`No palette committed`,`The palette screen was not completed on this run.`))),r.push(q(`Strategy per surface`,Vi(e.strategy)));return(n.colorStrategy||n.hueAnchor)&&r.push(q(`Interview direction`,xi([n.colorStrategy&&{dt:`Strategy asked for`,dd:K(n.colorStrategy)},n.hueAnchor&&{dt:`Hue anchor`,dd:K(n.hueAnchor)}].filter(Boolean))+Y(`Q1 of the seed interview. The cues were generated from this; the picks above are the decision.`))),r.join(``)}function Xi(e,t){let n=e.context?.interview||{},r=[bi(5,`Typography`,`Font families, type scale, hierarchy.`,t)];return e.fonts.heading?r.push(q(`The pair`,`<div class="dcx-pair">
        <article class="dcx-pair-card">
          <span class="dcx-pair-role">Headings</span>
          <p class="dcx-pair-name" style="font-family:'${K(e.fonts.heading)}', serif;">${K(e.fonts.heading)}</p>
          ${e.fonts.headingSource?`<code class="dcx-pair-source">${K(e.fonts.headingSource)}</code>`:``}
        </article>
        <article class="dcx-pair-card">
          <span class="dcx-pair-role">Body</span>
          <p class="dcx-pair-name" style="font-family:'${K(e.fonts.body)}', sans-serif;">${K(e.fonts.body)}</p>
          ${e.fonts.bodySource?`<code class="dcx-pair-source">${K(e.fonts.bodySource)}</code>`:``}
        </article>
      </div>
      <p class="dcx-pair-why" style="font-family:'${K(e.fonts.body)}', sans-serif;">${K(e.fonts.why||`Chosen on the font pair screen against every surface this product ships.`)}</p>`)):r.push(q(`The pair`,Ti(`No pair selected`,`The font pair screen was not completed on this run.`))),e.scale.ratio&&(r.push(q(`Type scale`,`<p class="dcx-scale-head"><strong>${K(e.scale.name)}</strong> &middot; ratio <code>${e.scale.ratio.toFixed(3)}</code> on a 16px base. ${K(e.scale.desc)}</p>`+X(U(`[data-scale-sheet]`),{kind:`scale`})+Y(`The scale screen&rsquo;s sheet, kept at rendered size in the chosen faces. Values at a 16px base.`))),r.push(q(`In running text`,X(U(`[data-scale-specimen]`),{kind:`specimen`})+Y(`The same scale on the components a page is built from &mdash; headings, ledes, lists, quotes, code.`)))),n.typeDirection&&r.push(q(`Interview direction`,J(`Direction asked for`,K(n.typeDirection))+Y(`Q2 of the seed interview. All six candidate pairs were composed inside this direction.`))),r.join(``)}function Zi(e,t){let n=[bi(6,`Iconography`,`Icon library, license, where it lives.`,t)];if(e.icons.pack){let t=U(`[data-icon-sheet]`),r=t?.querySelector(`.picker-icon-cell`)?X(t,{kind:`icons`}):``;r&&n.push(q(`The hand`,r+Y(`${K(e.icons.pack)}&rsquo;s canonical set, as the icons screen previewed it. One pack, one hand: no mixed sets.`)));let i=W.querySelector(`input[name="icon-pack"]:checked`)?.closest(`label`),a=i?.querySelector(`.picker-strategy-desc`)?.textContent.trim()||``,o=i?.querySelector(`.picker-icon-meta`)?.textContent.trim()||``;n.push(q(`Library`,xi([{dt:`Pack`,dd:`<strong>${K(e.icons.pack)}</strong>${o?` &middot; ${K(o)}`:``}`},a?{dt:`Why this hand`,dd:K(a)}:null,e.icons.license?{dt:`License`,dd:K(e.icons.license)}:null,e.icons.url?{dt:`Home`,dd:`<a href="${K(e.icons.url)}" target="_blank" rel="noopener">${K(e.icons.url)}</a>`}:null].filter(Boolean))+Y(`Chosen on the icons screen. The pack names the hand; stroke weight and metaphor rules resolve during implementation.`)))}else n.push(q(`Library`,Ti(`No pack selected`,`The icons screen was not completed on this run.`)));return n.join(``)}var Qi=(e,t=null)=>`<div class="dcx-picks" data-count="${e.length}">${e.map(e=>`
  <article class="dcx-pick${t?` dcx-pick--proof`:``}">
    <span class="dcx-pick-surface">${K(e.label)}${e.chosen?``:` <span class="dcx-default-mark">default</span>`}</span>
    <h3 class="dcx-pick-title">${K(e.title)}</h3>
    <p class="dcx-pick-desc">${K(e.desc)}</p>${t?t(e):``}
  </article>`).join(``)}</div>`;function $i(e,t){let n=e.context?.interview||{},r=[bi(7,`Material`,`Motion, layout structure, boundaries, corners, depth.`,t)],i=e.surfaces.map(t=>{let n=Ri(t.mode);return n?`
    <article class="dcx-surface-card">
      ${X(n,{strategy:e.strategy.find(e=>e.mode===t.mode)?.value||``,kind:`board`,marks:Bi(e,t.mode)})}
      <div class="dcx-surface-copy">
        <h3 class="dcx-surface-name">${K(t.label)}</h3>
      </div>
    </article>`:``}).filter(Boolean);return i.length&&r.push(q(`The page, as chosen`,`<div class="dcx-surfaces" data-count="${i.length}">${i.join(``)}</div>`+Y(`Each surface&rsquo;s page anatomy carrying every structural answer below at once, the way the question screens accumulated them: color strategy, layout, boundaries, corners, depth.`))),e.motion.length?r.push(q(`Motion per surface`,Qi(e.motion,t=>X(zi(t.mode,t.value),{kind:`board`,marks:Bi(e,t.mode)}))+Y(n.motionEnergy?`The seed interview asked for <strong>${K(n.motionEnergy)}</strong>; the motion screen answered it per surface above.`:`Asked of the landing page and the portfolio only. A tool and a document are moved through rather than watched, so their movement follows the interface rather than a house style.`))):r.push(q(`Motion`,Ti(`Not asked on this run`,`The motion screen is shown for a landing page and a portfolio. This run has neither, so no motion energy was chosen and none is recorded.`))),e.layout.value&&r.push(q(`Layout structure`,J(e.layout.title,K(e.layout.desc))+Y(`Asked of the landing page and the portfolio, where the composition of the page is itself the decision. One answer is kept for the run, and every surface is drawn on it.`))),r.push(q(`Boundaries per surface`,Qi(e.boundaries,t=>X(Li(`boundaries`,t.mode),{kind:`board`,marks:Bi(e,t.mode)}))+Y(`How sections separate on each surface.`))),r.push(q(`Corners per surface`,Qi(e.corners,t=>X(Li(`corners`,t.mode),{kind:`board`,marks:Bi(e,t.mode)}))+Y(`How round shapes are on each surface.`))),r.push(q(`Depth per surface`,Qi(e.depth,t=>X(Li(`depth`,t.mode),{kind:`board`,marks:Bi(e,t.mode)}))+Y(`How far off the page things sit on each surface.`))),r.join(``)}function ea(e,t){let n=[bi(8,`Interface`,`Per-surface decisions at a glance, component status.`,t)];n.push(q(`Decisions per surface`,`<div class="dcx-surfaces" data-count="${e.surfaces.length}">${e.surfaces.map(t=>{let n=e.strategy.find(e=>e.mode===t.mode)?.value||``,r=Ri(t.mode),i=[[`Color strategy`,e.strategy.find(e=>e.mode===t.mode)],[`Boundaries`,e.boundaries.find(e=>e.mode===t.mode)],[`Corners`,e.corners.find(e=>e.mode===t.mode)],[`Depth`,e.depth.find(e=>e.mode===t.mode)],[`Motion`,e.motion.find(e=>e.mode===t.mode)],[`Layout`,e.layout.value?e.layout:void 0]];return`
    <article class="dcx-surface-card">
      ${r?X(r,{strategy:n,kind:`board`,marks:Bi(e,t.mode)}):X(Fi(t.mode)||Ii(t.mode),{strategy:n,kind:`board`})}
      <div class="dcx-surface-copy">
        <h3 class="dcx-surface-name">${K(t.label)}</h3>
        <dl class="dcx-matrix">${i.map(([e,t])=>`
          <div class="dcx-matrix-row"><dt>${K(e)}</dt><dd>${t?K(t.title):`Not asked`}${t&&!t.chosen?` <span class="dcx-default-mark">default</span>`:``}</dd></div>`).join(``)}</dl>
      </div>
    </article>`}).join(``)}</div>`+Y(`Each surface&rsquo;s anatomy carrying its committed answers, with every per-surface decision beneath it.`)));let r=[e.fonts.heading?{dt:`Faces`,dd:`<strong>${K(e.fonts.heading)}</strong> for headings, <strong>${K(e.fonts.body)}</strong> for body`}:null,e.scale.ratio?{dt:`Type scale`,dd:`<strong>${K(e.scale.name)}</strong> &middot; ratio <code>${e.scale.ratio.toFixed(3)}</code> on a 16px base`}:null,e.icons.pack?{dt:`Icons`,dd:`<strong>${K(e.icons.pack)}</strong>${e.icons.license?` &middot; ${K(e.icons.license)}`:``}`}:null,e.palette.length?{dt:`Palette`,dd:e.palette.map(e=>`<code>${e.hex}</code>`).join(` &middot; `)}:null,e.layout.value?{dt:`Layout`,dd:`<strong>${K(e.layout.title)}</strong>, one answer for the run`}:null].filter(Boolean);return r.length&&n.push(q(`The kit`,xi(r)+Y(`The tokens the seed DESIGN.md will carry in its frontmatter, gathered from their own pages in this document.`))),n.push(q(`Components`,Ti(`No component library seeded yet`,`Components are documented on the first scan pass, once there is code to capture actual tokens and states from. Re-run <code>/impeccable document</code> then.`))),n.join(``)}var ta={audience:Hi,product:Ki,brand:qi,color:Yi,typography:Xi,iconography:Zi,material:$i,interface:ea},na={persuade:`A public-facing page that introduces the experience and guides visitors toward its primary action.`,operate:`A working surface for completing tasks, where familiar patterns and a predictable layout come first.`,read:`A reading surface for understanding, where type, structure, and pacing carry the page.`,experience:`A project-led page for presenting selected work, its context, and its outcomes.`};function ra(){let e=vi();window.dcxSurfaceDefs=e.surfaces.map(e=>({label:e.label,description:na[e.mode]||e.goal||``}));let t=e.context?.product?.name||``,n=Array.isArray(e.cueSlugs)?e.cueSlugs:[],r=e.paletteSource&&(si||n.includes(e.paletteSource))?e.paletteSource:``;window.dcxCueImageSrc=r?ci(r):``,window.dcxProductName=t;let i=ui.every(e=>G(`palette-${e}`));document.body.classList.toggle(`dcx-palette-live`,i),i&&ki(document.body),document.body.classList.toggle(`dcx-kit-live`,Pi(document.body,e));for(let[n,r]of Object.entries(ta)){let i=document.getElementById(`dcx-detail-${n}`);i.innerHTML=`<article class="dcx-article">${r(e,t)}</article>`}t&&(document.title=`Design context — ${t}`)}var ia=e=>new Promise(t=>setTimeout(t,e));function aa(){let e={};for(let[t,n]of new FormData(W))e[t]=t in e?Array.isArray(e[t])?[...e[t],n]:[e[t],n]:n;let t=[].concat(e[`surface-modes`]||[]),n=di.filter(e=>t.includes(e));for(let t of pi){if(!(t in e))continue;let r=n.find(n=>e[`${t}-${n}`]);r&&(e[t]=e[`${t}-${r}`])}return e}async function oa(){let e=await fetch(`/submit`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(aa())});if(!e.ok&&e.status!==409)throw Error(`Submit failed: ${e.status}`);if(e.ok){let t=await e.json().catch(()=>null);t?.doc?.base&&t?.doc?.token&&va(t.doc)}}async function sa(){let e=U(`[data-doc-error]`),t=U(`[data-doc-loader]`);e.hidden=!0,t.removeAttribute(`data-stalled`),ra();try{await Promise.all([oa(),ia(2400)]),da()}catch{t.setAttribute(`data-stalled`,``),e.hidden=!1}}var ca=!1;document.addEventListener(`picker:screenchange`,({detail:e})=>{e.screen!==`12`||ca||(ca=!0,sa())}),ne().then(async e=>{e.mode===`doc`&&(si=!0,ca=!0,await Promise.all([ai,oi,ie,zt().catch(()=>{})]),e.doc?.base&&e.doc?.token&&va(e.doc),ra(),da())});var la;document.addEventListener(`picker:screenchange`,()=>{ca||(clearTimeout(la),la=setTimeout(()=>{ca||fetch(`/autosave`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(aa())}).catch(()=>{})},500))}),U(`[data-doc-retry]`)?.addEventListener(`click`,sa);var ua=!1;function da(){ua=!0,document.body.classList.add(`dcx-open`),$r.hidden=!1,window.scrollTo(0,0),requestAnimationFrame(()=>{requestAnimationFrame(()=>{Qr(`[data-reveal]`,$r).forEach(e=>e.classList.add(`revealed`)),fa()})})}function fa(){Qr(`.dcx-viz-svg`).forEach(e=>{let t=Qr(`.anim-draw, .anim-draw-delay`,e);if(!t.length)return;let n=e.getBoundingClientRect();if(!n.width||!n.height)return;let r=Math.min(n.width,n.height)/40;t.forEach(e=>{let t=Math.max(100,e.getTotalLength()/.6);e.style.setProperty(`--pl`,`${(t*r).toFixed(1)}px`)})})}var pa;window.addEventListener(`resize`,()=>{window.clearTimeout(pa),pa=window.setTimeout(()=>{ua&&fa()},150)});var Z=null,ma=1,ha=!1,ga=[],_a=U(`[data-dcx-tray]`);function va(e){Z=e,window.dcxDocSession=e,document.body.classList.add(`dcx-live`),Da(),ba(1500)}var ya;function ba(e){window.clearTimeout(ya),ya=window.setTimeout(xa,e)}async function xa(){if(Z)try{let e=await fetch(`${Z.base}/doc/state?token=${encodeURIComponent(Z.token)}`);if(!e.ok)throw Error(`state`);let t=await e.json();Sa(!0),ga=t.requests||[],ka(),t.version!==ma&&(ma=t.version,await Ea(),Da()),ba(2e3)}catch{Sa(!1),ka(),ba(8e3)}}function Sa(e){ha=e,document.body.classList.toggle(`dcx-live`,!!Z&&e)}async function Ca(){let e=await fetch(`${Z.base}/doc/answers?token=${encodeURIComponent(Z.token)}`);if(!e.ok)return;let{answers:t}=await e.json();for(let[e,n]of Object.entries(t||{})){if(Array.isArray(n)||typeof n!=`string`)continue;let t=W.elements[e];t&&(typeof RadioNodeList<`u`&&t instanceof RadioNodeList||`value`in t&&t.type!==`checkbox`)&&(t.value=n)}wa(G(`font-heading`)),wa(G(`font-body`))}function wa(e){if(!e||document.fonts?.check?.(`16px '${e}'`))return;let t=`dcx-face-${e.replace(/\W+/g,`-`).toLowerCase()}`;if(document.getElementById(t))return;let n=document.createElement(`link`);n.id=t,n.rel=`stylesheet`,n.href=`https://fonts.googleapis.com/css2?family=${encodeURIComponent(e).replace(/%20/g,`+`)}:wght@300..800&display=swap`,document.head.appendChild(n)}async function Ta(){let e=await fetch(`${Z.base}/doc/context?token=${encodeURIComponent(Z.token)}`);if(!e.ok)return;let t=await e.json();t.context&&typeof t.context==`object`&&(ei=t.context),Array.isArray(t.modes)&&(ti=t.modes)}var Ea=()=>Promise.all([Ca(),Ta()]);function Da(){ra(),window.dcxDocument?.remount()}var Oa={pending:`Queued for the agent`,working:`The agent is on it`,done:`Applied`,error:`Could not apply`};function ka(){if(!_a)return;let e=ga.slice(-4),t=Z&&!ha;_a.hidden=!t&&e.length===0,_a.innerHTML=[t?`<div class="dcx-tray-item" data-status="offline"><span class="dcx-tray-dot"></span><div><p class="dcx-tray-prompt">Edit session offline</p><p class="dcx-tray-note">Changes stay in this tab; reconnecting&hellip;</p></div></div>`:``,...e.map(e=>`
      <div class="dcx-tray-item" data-status="${K(e.status)}">
        <span class="dcx-tray-dot"></span>
        <div>
          <p class="dcx-tray-prompt">${K(e.prompt)}</p>
          <p class="dcx-tray-note">${K(e.message||Oa[e.status]||e.status)}</p>
        </div>
      </div>`)].join(``)}var Q=(e,t=document)=>t.querySelector(e),Aa=Q(`#picker-form`),ja=Q(`[data-copy-url]`),Ma=Q(`[data-copy-status]`),$=[...Aa.querySelectorAll(`.picker-screen`)],Na=$.findIndex(e=>e.hasAttribute(`data-active`)),Pa=new URL(location.href);Pa.hostname=`localhost`;var Fa=Pa.href.replace(/\/$/,``);Q(`[data-copy-url-value]`).textContent=Fa;var Ia=()=>[...$[Na].querySelectorAll(`button:not([disabled]), input:not([disabled]):not([type="hidden"]):not([tabindex="-1"]), select:not([disabled]), textarea:not([disabled]), a[href]`)],La=Q(`.picker-progress`),Ra=Q(`.picker-progress-track`),za=()=>$.filter((e,t)=>t>0&&t<$.length-1&&!e.hasAttribute(`data-skip`)),Ba=e=>{let t=za(),n=t.length,r=t.indexOf(e),i=r>=0?r+1:e===$[0]?1:n;La.dataset.step=String(i),La.style.setProperty(`--pk-steps`,String(n)),[...Ra.children].forEach((e,t)=>e.toggleAttribute(`data-off`,t>=n)),Q(`[data-progress-index]`).textContent=String(i),Q(`[data-progress-total]`).textContent=String(n),Q(`[data-progress-name]`).textContent=e.dataset.step||``},Va=new Set([`01b`,`02`,`03`]),Ha=(e,t)=>typeof document.startViewTransition==`function`&&!matchMedia(`(prefers-reduced-motion: reduce)`).matches&&Va.has(e?.dataset.screen)&&Va.has(t?.dataset.screen),Ua=(e,t=1)=>{let n=e;for(;$[n]?.hasAttribute(`data-skip`);)n+=t;let r=$[n];if(r){if(Ha($[Na],r)){document.startViewTransition(()=>Wa(n));return}Wa(n)}},Wa=e=>{let t=$[e];$.forEach((t,n)=>{let r=n===e;t.toggleAttribute(`data-active`,r),r?t.removeAttribute(`aria-hidden`):t.setAttribute(`aria-hidden`,`true`)}),Na=e;let n=t.dataset.screen;Aa.dataset.current=n,Ba(t),document.dispatchEvent(new CustomEvent(`picker:screenchange`,{detail:{screen:n}})),Ia()[0]?.focus()},Ga=`04b`,Ka=new Set([`06`,`08`,`09`,`10`,`11`]),qa=e=>$.findIndex(t=>t.dataset.screen===e);Aa.onclick=e=>{let t=e.target.closest(`[data-advance]`);if(!t)return;if(Ka.has($[Na].dataset.screen)){Ua(qa(Ga));return}let n=t.dataset.advance===`prev`?-1:1;Ua(Na+n,n)},document.addEventListener(`picker:goto`,e=>{let t=qa(e.detail.screen);t!==-1&&Ua(t)}),document.addEventListener(`keydown`,e=>{if(e.defaultPrevented||e.target instanceof Element&&e.target.closest(`input, textarea, select, [role="slider"]`))return;if(e.key===`Enter`){if(Na===0&&matchMedia(`(max-width: 1199px)`).matches)return;let t=Na===0?Q(`[data-advance="next"]`,$[0]):document.activeElement;Ia().includes(t)&&(e.preventDefault(),t.click());return}let t={ArrowUp:-1,ArrowLeft:-1,ArrowDown:1,ArrowRight:1};if(!(e.key in t))return;e.preventDefault();let n=Ia(),r=n.indexOf(document.activeElement);n[r<0?0:(r+t[e.key]+n.length)%n.length]?.focus()}),Aa.onsubmit=e=>e.preventDefault(),ja.onclick=async()=>{try{await navigator.clipboard.writeText(Fa),ja.classList.add(`is-copied`),ja.setAttribute(`aria-label`,`Link copied`),Ma.textContent=`Copied. Paste it into your browser to continue.`,setTimeout(()=>{ja.classList.remove(`is-copied`),ja.setAttribute(`aria-label`,`Copy link`)},1200)}catch{Ma.textContent=`Copy failed. Select the link above and copy it instead.`}},Aa.dataset.current=$[Na].dataset.screen,Ba($[Na]);