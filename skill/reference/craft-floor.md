...
- A cultural-symbol palette reached for as the obvious pull for a domain that carries one (a nation's flag colors, a cuisine's stock hues, a holiday's palette) when the brief and the established brand have left the palette open. Reach past it; let the cultural reading come from typography, imagery, and copy, not the palette. A palette the brief or the brand pins is honored as written, cultural or not. <!-- rule:skill-reflex-cultural-palette -->
