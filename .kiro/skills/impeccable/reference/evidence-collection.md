...
2. The 10 evidence catalogs (one per Nielsen heuristic, `.kiro/skills/impeccable/scripts/data/critique-evidence/heuristic-*.json`) plus the page-context description (what the interface is trying to accomplish).
